...
// WithExternalCloudtowerID adds the externalCloudtowerID to the suspend snapshot plan params
func (o *SuspendSnapshotPlanParams) WithExternalCloudtowerID(externalCloudtowerID *string) *SuspendSnapshotPlanParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the suspend snapshot plan params
func (o *SuspendSnapshotPlanParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
