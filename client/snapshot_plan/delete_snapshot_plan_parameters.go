...
// WithExternalCloudtowerID adds the externalCloudtowerID to the delete snapshot plan params
func (o *DeleteSnapshotPlanParams) WithExternalCloudtowerID(externalCloudtowerID *string) *DeleteSnapshotPlanParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the delete snapshot plan params
func (o *DeleteSnapshotPlanParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
