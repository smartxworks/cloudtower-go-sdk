...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get backup plan executions connection params
func (o *GetBackupPlanExecutionsConnectionParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetBackupPlanExecutionsConnectionParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get backup plan executions connection params
func (o *GetBackupPlanExecutionsConnectionParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
