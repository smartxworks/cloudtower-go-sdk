...
// WithExternalCloudtowerID adds the externalCloudtowerID to the add clusters to datacenter params
func (o *AddClustersToDatacenterParams) WithExternalCloudtowerID(externalCloudtowerID *string) *AddClustersToDatacenterParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the add clusters to datacenter params
func (o *AddClustersToDatacenterParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
