...
func (o *RemoveClustersFromDatacenterReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewRemoveClustersFromDatacenterOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 400:
		result := NewRemoveClustersFromDatacenterBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 404:
		result := NewRemoveClustersFromDatacenterNotFound()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 500:
		result := NewRemoveClustersFromDatacenterInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewRemoveClustersFromDatacenterOK() *RemoveClustersFromDatacenterOK {
	return &RemoveClustersFromDatacenterOK{}
}
...
func (o *RemoveClustersFromDatacenterOK) Error() string {
	return fmt.Sprintf("[POST /remove-clusters-from-datacenter][%d] removeClustersFromDatacenterOK  %+v", 200, o.Payload)
}
func (o *RemoveClustersFromDatacenterOK) GetPayload() []*models.WithTaskDatacenter {
	return o.Payload
}

func (o *RemoveClustersFromDatacenterOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewRemoveClustersFromDatacenterBadRequest() *RemoveClustersFromDatacenterBadRequest {
	return &RemoveClustersFromDatacenterBadRequest{}
}
...
func (o *RemoveClustersFromDatacenterBadRequest) Error() string {
	return fmt.Sprintf("[POST /remove-clusters-from-datacenter][%d] removeClustersFromDatacenterBadRequest  %+v", 400, o.Payload)
}
func (o *RemoveClustersFromDatacenterBadRequest) GetPayload() *models.ErrorBody {
	return o.Payload
}

func (o *RemoveClustersFromDatacenterBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewRemoveClustersFromDatacenterNotFound() *RemoveClustersFromDatacenterNotFound {
	return &RemoveClustersFromDatacenterNotFound{}
}
...
func (o *RemoveClustersFromDatacenterNotFound) Error() string {
	return fmt.Sprintf("[POST /remove-clusters-from-datacenter][%d] removeClustersFromDatacenterNotFound  %+v", 404, o.Payload)
}
func (o *RemoveClustersFromDatacenterNotFound) GetPayload() *models.ErrorBody {
	return o.Payload
}

func (o *RemoveClustersFromDatacenterNotFound) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewRemoveClustersFromDatacenterInternalServerError() *RemoveClustersFromDatacenterInternalServerError {
	return &RemoveClustersFromDatacenterInternalServerError{}
}
...
func (o *RemoveClustersFromDatacenterInternalServerError) Error() string {
	return fmt.Sprintf("[POST /remove-clusters-from-datacenter][%d] removeClustersFromDatacenterInternalServerError  %+v", 500, o.Payload)
}
func (o *RemoveClustersFromDatacenterInternalServerError) GetPayload() *models.ErrorBody {
	return o.Payload
}

func (o *RemoveClustersFromDatacenterInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
