...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get snapshot plan tasks params
func (o *GetSnapshotPlanTasksParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetSnapshotPlanTasksParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get snapshot plan tasks params
func (o *GetSnapshotPlanTasksParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
