...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get snmp trap receivers connection params
func (o *GetSnmpTrapReceiversConnectionParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetSnmpTrapReceiversConnectionParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get snmp trap receivers connection params
func (o *GetSnmpTrapReceiversConnectionParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
