...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get snmp trap receivers params
func (o *GetSnmpTrapReceiversParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetSnmpTrapReceiversParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get snmp trap receivers params
func (o *GetSnmpTrapReceiversParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
