...
// NewCreateVdsWithAccessVlanParams creates a new CreateVdsWithAccessVlanParams object,
...
func NewCreateVdsWithAccessVlanParams() *CreateVdsWithAccessVlanParams {
	return &CreateVdsWithAccessVlanParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewCreateVdsWithAccessVlanParamsWithTimeout creates a new CreateVdsWithAccessVlanParams object
...
// NewCreateVdsWithAccessVlanParamsWithContext creates a new CreateVdsWithAccessVlanParams object
...
// NewCreateVdsWithAccessVlanParamsWithHTTPClient creates a new CreateVdsWithAccessVlanParams object
...
func (o *CreateVdsWithAccessVlanParams) WithDefaults() *CreateVdsWithAccessVlanParams {
	o.SetDefaults()
	return o
}
...
func (o *CreateVdsWithAccessVlanParams) SetDefaults() {
	...
	val := CreateVdsWithAccessVlanParams{
...
func (o *CreateVdsWithAccessVlanParams) WithTimeout(timeout time.Duration) *CreateVdsWithAccessVlanParams {
...
func (o *CreateVdsWithAccessVlanParams) WithContext(ctx context.Context) *CreateVdsWithAccessVlanParams {
	o.SetContext(ctx)
	return o
}
...
func (o *CreateVdsWithAccessVlanParams) WithHTTPClient(client *http.Client) *CreateVdsWithAccessVlanParams {
...
// WithExternalCloudtowerID adds the externalCloudtowerID to the create vds with access vlan params
func (o *CreateVdsWithAccessVlanParams) WithExternalCloudtowerID(externalCloudtowerID *string) *CreateVdsWithAccessVlanParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the create vds with access vlan params
func (o *CreateVdsWithAccessVlanParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
	o.ExternalCloudtowerID = externalCloudtowerID
}

// WithRequestBody adds the requestBody to the create vds with access vlan params
func (o *CreateVdsWithAccessVlanParams) WithRequestBody(requestBody []*models.VdsCreationWithMAccessVlanParams) *CreateVdsWithAccessVlanParams {
...
func (o *CreateVdsWithAccessVlanParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
