...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get nics connection params
func (o *GetNicsConnectionParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetNicsConnectionParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get nics connection params
func (o *GetNicsConnectionParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
