...
// WithExternalCloudtowerID adds the externalCloudtowerID to the update nic params
func (o *UpdateNicParams) WithExternalCloudtowerID(externalCloudtowerID *string) *UpdateNicParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the update nic params
func (o *UpdateNicParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
