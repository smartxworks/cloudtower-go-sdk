...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get snmp transports connection params
func (o *GetSnmpTransportsConnectionParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetSnmpTransportsConnectionParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get snmp transports connection params
func (o *GetSnmpTransportsConnectionParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
