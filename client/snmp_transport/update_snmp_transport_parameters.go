...
// WithExternalCloudtowerID adds the externalCloudtowerID to the update snmp transport params
func (o *UpdateSnmpTransportParams) WithExternalCloudtowerID(externalCloudtowerID *string) *UpdateSnmpTransportParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the update snmp transport params
func (o *UpdateSnmpTransportParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
