...
func (o *GetWitnessMetricsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetWitnessMetricsOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, models.NewUnexpectedError(response, err)
		}
		return result, nil
	case 400:
		result := NewGetWitnessMetricsBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, models.NewUnexpectedError(response, err)
		}
		return nil, result
	case 404:
		result := NewGetWitnessMetricsNotFound()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, models.NewUnexpectedError(response, err)
		}
		return nil, result
	case 500:
		result := NewGetWitnessMetricsInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, models.NewUnexpectedError(response, err)
		}
		return nil, result
...
func (o *GetWitnessMetricsOK) Error() string {
	return fmt.Sprintf("[POST /get-witness-metrics][%d] getWitnessMetricsOK  %+v", 200, o.Payload)
}
func (o *GetWitnessMetricsOK) GetPayload() []*models.WithTaskMetric {
	return o.Payload
}

func (o *GetWitnessMetricsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetWitnessMetricsBadRequest() *GetWitnessMetricsBadRequest {
	return &GetWitnessMetricsBadRequest{}
}
...
func (o *GetWitnessMetricsBadRequest) Error() string {
	return fmt.Sprintf("[POST /get-witness-metrics][%d] getWitnessMetricsBadRequest  %+v", 400, o.Payload)
}
func (o *GetWitnessMetricsBadRequest) GetPayload() *models.ErrorBody {
	return o.Payload
}

func (o *GetWitnessMetricsBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetWitnessMetricsNotFound() *GetWitnessMetricsNotFound {
	return &GetWitnessMetricsNotFound{}
}
...
func (o *GetWitnessMetricsNotFound) Error() string {
	return fmt.Sprintf("[POST /get-witness-metrics][%d] getWitnessMetricsNotFound  %+v", 404, o.Payload)
}
func (o *GetWitnessMetricsNotFound) GetPayload() *models.ErrorBody {
	return o.Payload
}

func (o *GetWitnessMetricsNotFound) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetWitnessMetricsInternalServerError() *GetWitnessMetricsInternalServerError {
	return &GetWitnessMetricsInternalServerError{}
}
...
func (o *GetWitnessMetricsInternalServerError) Error() string {
	return fmt.Sprintf("[POST /get-witness-metrics][%d] getWitnessMetricsInternalServerError  %+v", 500, o.Payload)
}
func (o *GetWitnessMetricsInternalServerError) GetPayload() *models.ErrorBody {
	return o.Payload
}

func (o *GetWitnessMetricsInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
