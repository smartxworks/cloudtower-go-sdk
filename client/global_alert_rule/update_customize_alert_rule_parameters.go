...
// WithExternalCloudtowerID adds the externalCloudtowerID to the update customize alert rule params
func (o *UpdateCustomizeAlertRuleParams) WithExternalCloudtowerID(externalCloudtowerID *string) *UpdateCustomizeAlertRuleParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the update customize alert rule params
func (o *UpdateCustomizeAlertRuleParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
