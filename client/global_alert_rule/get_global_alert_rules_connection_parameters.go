...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get global alert rules connection params
func (o *GetGlobalAlertRulesConnectionParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetGlobalAlertRulesConnectionParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get global alert rules connection params
func (o *GetGlobalAlertRulesConnectionParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
