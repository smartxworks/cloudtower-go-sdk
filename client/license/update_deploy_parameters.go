...
// WithExternalCloudtowerID adds the externalCloudtowerID to the update deploy params
func (o *UpdateDeployParams) WithExternalCloudtowerID(externalCloudtowerID *string) *UpdateDeployParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the update deploy params
func (o *UpdateDeployParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
