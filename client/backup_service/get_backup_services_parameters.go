...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get backup services params
func (o *GetBackupServicesParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetBackupServicesParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get backup services params
func (o *GetBackupServicesParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
