...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get zone topoes connection params
func (o *GetZoneTopoesConnectionParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetZoneTopoesConnectionParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get zone topoes connection params
func (o *GetZoneTopoesConnectionParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
