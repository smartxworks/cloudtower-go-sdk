...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get virtual private cloud router gateways connection params
func (o *GetVirtualPrivateCloudRouterGatewaysConnectionParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetVirtualPrivateCloudRouterGatewaysConnectionParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get virtual private cloud router gateways connection params
func (o *GetVirtualPrivateCloudRouterGatewaysConnectionParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
