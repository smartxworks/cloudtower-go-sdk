...
// WithExternalCloudtowerID adds the externalCloudtowerID to the delete namespace group params
func (o *DeleteNamespaceGroupParams) WithExternalCloudtowerID(externalCloudtowerID *string) *DeleteNamespaceGroupParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the delete namespace group params
func (o *DeleteNamespaceGroupParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
