...
// WithExternalCloudtowerID adds the externalCloudtowerID to the suspend backup plan params
func (o *SuspendBackupPlanParams) WithExternalCloudtowerID(externalCloudtowerID *string) *SuspendBackupPlanParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the suspend backup plan params
func (o *SuspendBackupPlanParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
