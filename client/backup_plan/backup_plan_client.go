...
type ClientService interface {
	...
	GetBackupPlanWithoutExecutions(params *GetBackupPlanWithoutExecutionsParams, opts ...ClientOption) (*GetBackupPlanWithoutExecutionsOK, error)
...
/*
  GetBackupPlanWithoutExecutions get backup plan without executions API
*/
func (a *Client) GetBackupPlanWithoutExecutions(params *GetBackupPlanWithoutExecutionsParams, opts ...ClientOption) (*GetBackupPlanWithoutExecutionsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetBackupPlanWithoutExecutionsParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetBackupPlanWithoutExecutions",
		Method:             "POST",
		PathPattern:        "/get-backup-plans-without-executions",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &GetBackupPlanWithoutExecutionsReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*GetBackupPlanWithoutExecutionsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetBackupPlanWithoutExecutions: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
