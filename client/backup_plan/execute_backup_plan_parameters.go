...
// NewExecuteBackupPlanParams creates a new ExecuteBackupPlanParams object,
...
func NewExecuteBackupPlanParams() *ExecuteBackupPlanParams {
	return &ExecuteBackupPlanParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewExecuteBackupPlanParamsWithTimeout creates a new ExecuteBackupPlanParams object
...
// NewExecuteBackupPlanParamsWithContext creates a new ExecuteBackupPlanParams object
...
// NewExecuteBackupPlanParamsWithHTTPClient creates a new ExecuteBackupPlanParams object
...
/* ExecuteBackupPlanParams contains all the parameters to send to the API endpoint
   for the execute backup plan operation.
...
type ExecuteBackupPlanParams struct {
	...
	// RequestBody.
	RequestBody *models.BackupPlanExecuteParams
...
// WithExternalCloudtowerID adds the externalCloudtowerID to the execute backup plan params
func (o *ExecuteBackupPlanParams) WithExternalCloudtowerID(externalCloudtowerID *string) *ExecuteBackupPlanParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the execute backup plan params
func (o *ExecuteBackupPlanParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
