...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get nvmf subsystems connection params
func (o *GetNvmfSubsystemsConnectionParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetNvmfSubsystemsConnectionParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get nvmf subsystems connection params
func (o *GetNvmfSubsystemsConnectionParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
