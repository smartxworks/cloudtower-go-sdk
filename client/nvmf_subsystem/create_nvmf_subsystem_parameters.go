...
// NewCreateNvmfSubsystemParams creates a new CreateNvmfSubsystemParams object,
...
func NewCreateNvmfSubsystemParams() *CreateNvmfSubsystemParams {
	return &CreateNvmfSubsystemParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewCreateNvmfSubsystemParamsWithTimeout creates a new CreateNvmfSubsystemParams object
...
// NewCreateNvmfSubsystemParamsWithContext creates a new CreateNvmfSubsystemParams object
...
// NewCreateNvmfSubsystemParamsWithHTTPClient creates a new CreateNvmfSubsystemParams object
...
// WithExternalCloudtowerID adds the externalCloudtowerID to the create nvmf subsystem params
func (o *CreateNvmfSubsystemParams) WithExternalCloudtowerID(externalCloudtowerID *string) *CreateNvmfSubsystemParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the create nvmf subsystem params
func (o *CreateNvmfSubsystemParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
