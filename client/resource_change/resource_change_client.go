...
func (a *Client) GetResourceChanges(params *GetResourceChangesParams, opts ...ClientOption) (*GetResourceChangesOK, error) {
	...
	if params == nil {
		params = NewGetResourceChangesParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetResourceChanges",
		Method:             "GET",
		PathPattern:        "/resource-changes",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &GetResourceChangesReader{formats: a.formats},
	...
	success, ok := result.(*GetResourceChangesOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetResourceChanges: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
