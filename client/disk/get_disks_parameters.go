...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get disks params
func (o *GetDisksParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetDisksParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get disks params
func (o *GetDisksParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
