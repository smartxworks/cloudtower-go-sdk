...
// WithExternalCloudtowerID adds the externalCloudtowerID to the create Vm snapshot params
func (o *CreateVMSnapshotParams) WithExternalCloudtowerID(externalCloudtowerID *string) *CreateVMSnapshotParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the create Vm snapshot params
func (o *CreateVMSnapshotParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
