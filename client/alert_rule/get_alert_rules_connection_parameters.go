...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get alert rules connection params
func (o *GetAlertRulesConnectionParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetAlertRulesConnectionParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get alert rules connection params
func (o *GetAlertRulesConnectionParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
