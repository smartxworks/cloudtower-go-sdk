...
func (a *Client) CancelUploadTask(params *CancelUploadTaskParams, opts ...ClientOption) (*CancelUploadTaskOK, error) {
	...
	if params == nil {
		params = NewCancelUploadTaskParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "CancelUploadTask",
		Method:             "POST",
		PathPattern:        "/cancel-upload-task",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &CancelUploadTaskReader{formats: a.formats},
	...
	success, ok := result.(*CancelUploadTaskOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for CancelUploadTask: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
