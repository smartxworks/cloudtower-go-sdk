...
type ClientService interface {
	...
	GetClusterPinInPerformanceInfo(params *GetClusterPinInPerformanceInfoParams, opts ...ClientOption) (*GetClusterPinInPerformanceInfoOK, error)
	...
	UpdateClusterDisablePinInPerformance(params *UpdateClusterDisablePinInPerformanceParams, opts ...ClientOption) (*UpdateClusterDisablePinInPerformanceOK, error)
	...
	UpdateClusterEnablePinInPerformance(params *UpdateClusterEnablePinInPerformanceParams, opts ...ClientOption) (*UpdateClusterEnablePinInPerformanceOK, error)
...
/*
  GetClusterPinInPerformanceInfo get cluster pin in performance info API
*/
func (a *Client) GetClusterPinInPerformanceInfo(params *GetClusterPinInPerformanceInfoParams, opts ...ClientOption) (*GetClusterPinInPerformanceInfoOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetClusterPinInPerformanceInfoParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetClusterPinInPerformanceInfo",
		Method:             "POST",
		PathPattern:        "/get-cluster-pin-in-performance-info",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &GetClusterPinInPerformanceInfoReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*GetClusterPinInPerformanceInfoOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetClusterPinInPerformanceInfo: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
/*
  UpdateClusterDisablePinInPerformance update cluster disable pin in performance API
*/
func (a *Client) UpdateClusterDisablePinInPerformance(params *UpdateClusterDisablePinInPerformanceParams, opts ...ClientOption) (*UpdateClusterDisablePinInPerformanceOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewUpdateClusterDisablePinInPerformanceParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "UpdateClusterDisablePinInPerformance",
		Method:             "POST",
		PathPattern:        "/disable-cluster-pin-in-performance",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &UpdateClusterDisablePinInPerformanceReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*UpdateClusterDisablePinInPerformanceOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for UpdateClusterDisablePinInPerformance: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
/*
  UpdateClusterEnablePinInPerformance update cluster enable pin in performance API
*/
func (a *Client) UpdateClusterEnablePinInPerformance(params *UpdateClusterEnablePinInPerformanceParams, opts ...ClientOption) (*UpdateClusterEnablePinInPerformanceOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewUpdateClusterEnablePinInPerformanceParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "UpdateClusterEnablePinInPerformance",
		Method:             "POST",
		PathPattern:        "/enable-cluster-pin-in-performance",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &UpdateClusterEnablePinInPerformanceReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*UpdateClusterEnablePinInPerformanceOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for UpdateClusterEnablePinInPerformance: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
