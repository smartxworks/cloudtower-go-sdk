...
// WithExternalCloudtowerID adds the externalCloudtowerID to the create user params
func (o *CreateUserParams) WithExternalCloudtowerID(externalCloudtowerID *string) *CreateUserParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the create user params
func (o *CreateUserParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
