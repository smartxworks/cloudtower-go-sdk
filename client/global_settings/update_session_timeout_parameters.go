...
// WithExternalCloudtowerID adds the externalCloudtowerID to the update session timeout params
func (o *UpdateSessionTimeoutParams) WithExternalCloudtowerID(externalCloudtowerID *string) *UpdateSessionTimeoutParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the update session timeout params
func (o *UpdateSessionTimeoutParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
