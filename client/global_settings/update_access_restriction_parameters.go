...
// WithExternalCloudtowerID adds the externalCloudtowerID to the update access restriction params
func (o *UpdateAccessRestrictionParams) WithExternalCloudtowerID(externalCloudtowerID *string) *UpdateAccessRestrictionParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the update access restriction params
func (o *UpdateAccessRestrictionParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
