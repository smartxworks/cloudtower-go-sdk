...
// WithExternalCloudtowerID adds the externalCloudtowerID to the delete cluster recycle bin setting params
func (o *DeleteClusterRecycleBinSettingParams) WithExternalCloudtowerID(externalCloudtowerID *string) *DeleteClusterRecycleBinSettingParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the delete cluster recycle bin setting params
func (o *DeleteClusterRecycleBinSettingParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
