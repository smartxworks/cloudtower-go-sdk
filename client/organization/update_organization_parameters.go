...
// WithExternalCloudtowerID adds the externalCloudtowerID to the update organization params
func (o *UpdateOrganizationParams) WithExternalCloudtowerID(externalCloudtowerID *string) *UpdateOrganizationParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the update organization params
func (o *UpdateOrganizationParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
