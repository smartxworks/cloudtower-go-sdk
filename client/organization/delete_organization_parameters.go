...
// WithExternalCloudtowerID adds the externalCloudtowerID to the delete organization params
func (o *DeleteOrganizationParams) WithExternalCloudtowerID(externalCloudtowerID *string) *DeleteOrganizationParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the delete organization params
func (o *DeleteOrganizationParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
