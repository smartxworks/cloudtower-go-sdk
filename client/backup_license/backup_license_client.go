...
func (a *Client) GetBackupLicenses(params *GetBackupLicensesParams, opts ...ClientOption) (*GetBackupLicensesOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "GetBackupLicenses",
		Method:             "POST",
		PathPattern:        "/get-backup-licenses",
	...
	success, ok := result.(*GetBackupLicensesOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetBackupLicenses: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) GetBackupLicensesConnection(params *GetBackupLicensesConnectionParams, opts ...ClientOption) (*GetBackupLicensesConnectionOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "GetBackupLicensesConnection",
		Method:             "POST",
		PathPattern:        "/get-backup-licenses-connection",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
	...
	success, ok := result.(*GetBackupLicensesConnectionOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetBackupLicensesConnection: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
