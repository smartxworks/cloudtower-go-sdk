...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get cloud tower applications params
func (o *GetCloudTowerApplicationsParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetCloudTowerApplicationsParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get cloud tower applications params
func (o *GetCloudTowerApplicationsParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
