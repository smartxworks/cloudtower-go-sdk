...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get cloud tower applications connection params
func (o *GetCloudTowerApplicationsConnectionParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetCloudTowerApplicationsConnectionParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get cloud tower applications connection params
func (o *GetCloudTowerApplicationsConnectionParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
