...
// WithExternalCloudtowerID adds the externalCloudtowerID to the create vcenter account params
func (o *CreateVcenterAccountParams) WithExternalCloudtowerID(externalCloudtowerID *string) *CreateVcenterAccountParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the create vcenter account params
func (o *CreateVcenterAccountParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
