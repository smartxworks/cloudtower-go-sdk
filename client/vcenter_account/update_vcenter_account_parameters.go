...
// NewUpdateVcenterAccountParams creates a new UpdateVcenterAccountParams object,
...
// NewUpdateVcenterAccountParamsWithTimeout creates a new UpdateVcenterAccountParams object
...
// NewUpdateVcenterAccountParamsWithContext creates a new UpdateVcenterAccountParams object
...
// NewUpdateVcenterAccountParamsWithHTTPClient creates a new UpdateVcenterAccountParams object
...
func (o *UpdateVcenterAccountParams) WithDefaults() *UpdateVcenterAccountParams {
	o.SetDefaults()
	return o
}
...
func (o *UpdateVcenterAccountParams) SetDefaults() {
	...
	val := UpdateVcenterAccountParams{
...
func (o *UpdateVcenterAccountParams) WithTimeout(timeout time.Duration) *UpdateVcenterAccountParams {
...
func (o *UpdateVcenterAccountParams) WithContext(ctx context.Context) *UpdateVcenterAccountParams {
	o.SetContext(ctx)
	return o
}
...
func (o *UpdateVcenterAccountParams) WithHTTPClient(client *http.Client) *UpdateVcenterAccountParams {
...
// WithExternalCloudtowerID adds the externalCloudtowerID to the update vcenter account params
func (o *UpdateVcenterAccountParams) WithExternalCloudtowerID(externalCloudtowerID *string) *UpdateVcenterAccountParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the update vcenter account params
func (o *UpdateVcenterAccountParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
	o.ExternalCloudtowerID = externalCloudtowerID
}

// WithRequestBody adds the requestBody to the update vcenter account params
func (o *UpdateVcenterAccountParams) WithRequestBody(requestBody *models.UpdateVcenterAccountParams) *UpdateVcenterAccountParams {
...
func (o *UpdateVcenterAccountParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
