...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get vcenter accounts connection params
func (o *GetVcenterAccountsConnectionParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetVcenterAccountsConnectionParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get vcenter accounts connection params
func (o *GetVcenterAccountsConnectionParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
