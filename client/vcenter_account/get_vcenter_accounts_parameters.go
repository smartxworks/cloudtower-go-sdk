...
// NewGetVcenterAccountsParams creates a new GetVcenterAccountsParams object,
...
func NewGetVcenterAccountsParams() *GetVcenterAccountsParams {
	return &GetVcenterAccountsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetVcenterAccountsParamsWithTimeout creates a new GetVcenterAccountsParams object
...
// NewGetVcenterAccountsParamsWithContext creates a new GetVcenterAccountsParams object
...
// NewGetVcenterAccountsParamsWithHTTPClient creates a new GetVcenterAccountsParams object
...
func (o *GetVcenterAccountsParams) WithDefaults() *GetVcenterAccountsParams {
	o.SetDefaults()
	return o
}
...
func (o *GetVcenterAccountsParams) WithTimeout(timeout time.Duration) *GetVcenterAccountsParams {
...
func (o *GetVcenterAccountsParams) WithContext(ctx context.Context) *GetVcenterAccountsParams {
	o.SetContext(ctx)
	return o
}
...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get vcenter accounts params
func (o *GetVcenterAccountsParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetVcenterAccountsParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get vcenter accounts params
func (o *GetVcenterAccountsParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
	o.ExternalCloudtowerID = externalCloudtowerID
}

// WithRequestBody adds the requestBody to the get vcenter accounts params
func (o *GetVcenterAccountsParams) WithRequestBody(requestBody *models.GetVcenterAccountsRequestBody) *GetVcenterAccountsParams {
...
func (o *GetVcenterAccountsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
