...
// WithExternalCloudtowerID adds the externalCloudtowerID to the delete security group params
func (o *DeleteSecurityGroupParams) WithExternalCloudtowerID(externalCloudtowerID *string) *DeleteSecurityGroupParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the delete security group params
func (o *DeleteSecurityGroupParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
