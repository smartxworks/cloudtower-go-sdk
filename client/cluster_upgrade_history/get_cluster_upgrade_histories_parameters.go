...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get cluster upgrade histories params
func (o *GetClusterUpgradeHistoriesParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetClusterUpgradeHistoriesParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get cluster upgrade histories params
func (o *GetClusterUpgradeHistoriesParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
