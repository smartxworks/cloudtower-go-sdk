...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get report templates connection params
func (o *GetReportTemplatesConnectionParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetReportTemplatesConnectionParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get report templates connection params
func (o *GetReportTemplatesConnectionParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
