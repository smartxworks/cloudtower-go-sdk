...
// WithExternalCloudtowerID adds the externalCloudtowerID to the update report template params
func (o *UpdateReportTemplateParams) WithExternalCloudtowerID(externalCloudtowerID *string) *UpdateReportTemplateParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the update report template params
func (o *UpdateReportTemplateParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
