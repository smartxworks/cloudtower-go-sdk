...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get applications connection params
func (o *GetApplicationsConnectionParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetApplicationsConnectionParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get applications connection params
func (o *GetApplicationsConnectionParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
