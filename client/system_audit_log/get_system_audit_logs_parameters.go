...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get system audit logs params
func (o *GetSystemAuditLogsParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetSystemAuditLogsParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get system audit logs params
func (o *GetSystemAuditLogsParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
