...
// WithExternalCloudtowerID adds the externalCloudtowerID to the update gpu device usage params
func (o *UpdateGpuDeviceUsageParams) WithExternalCloudtowerID(externalCloudtowerID *string) *UpdateGpuDeviceUsageParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the update gpu device usage params
func (o *UpdateGpuDeviceUsageParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
