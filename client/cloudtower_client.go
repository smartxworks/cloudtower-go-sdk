...
import (
	...
	"github.com/Sczlog/cloudtower-go-sdk/client/alert_notifier"
	"github.com/Sczlog/cloudtower-go-sdk/client/alert_rule"
	"github.com/Sczlog/cloudtower-go-sdk/client/application"
	"github.com/Sczlog/cloudtower-go-sdk/client/backup_license"
	"github.com/Sczlog/cloudtower-go-sdk/client/backup_package"
	"github.com/Sczlog/cloudtower-go-sdk/client/backup_plan"
	"github.com/Sczlog/cloudtower-go-sdk/client/backup_plan_execution"
	"github.com/Sczlog/cloudtower-go-sdk/client/backup_restore_execution"
	"github.com/Sczlog/cloudtower-go-sdk/client/backup_restore_point"
	"github.com/Sczlog/cloudtower-go-sdk/client/backup_service"
	"github.com/Sczlog/cloudtower-go-sdk/client/backup_store_repository"
	"github.com/Sczlog/cloudtower-go-sdk/client/backup_target_execution"
	"github.com/Sczlog/cloudtower-go-sdk/client/brick_topo"
	"github.com/Sczlog/cloudtower-go-sdk/client/cluster"
	"github.com/Sczlog/cloudtower-go-sdk/client/cluster_image"
	"github.com/Sczlog/cloudtower-go-sdk/client/cluster_settings"
	"github.com/Sczlog/cloudtower-go-sdk/client/cluster_topo"
	"github.com/Sczlog/cloudtower-go-sdk/client/cluster_upgrade_history"
	"github.com/Sczlog/cloudtower-go-sdk/client/consistency_group"
	"github.com/Sczlog/cloudtower-go-sdk/client/consistency_group_snapshot"
	"github.com/Sczlog/cloudtower-go-sdk/client/content_library_image"
	"github.com/Sczlog/cloudtower-go-sdk/client/content_library_vm_template"
	"github.com/Sczlog/cloudtower-go-sdk/client/datacenter"
	"github.com/Sczlog/cloudtower-go-sdk/client/deploy"
	"github.com/Sczlog/cloudtower-go-sdk/client/discovered_host"
	"github.com/Sczlog/cloudtower-go-sdk/client/disk"
	"github.com/Sczlog/cloudtower-go-sdk/client/elf_data_store"
	"github.com/Sczlog/cloudtower-go-sdk/client/elf_image"
	"github.com/Sczlog/cloudtower-go-sdk/client/elf_storage_policy"
	"github.com/Sczlog/cloudtower-go-sdk/client/entity_filter"
	"github.com/Sczlog/cloudtower-go-sdk/client/everoute_cluster"
	"github.com/Sczlog/cloudtower-go-sdk/client/everoute_license"
	"github.com/Sczlog/cloudtower-go-sdk/client/everoute_package"
	"github.com/Sczlog/cloudtower-go-sdk/client/global_alert_rule"
	"github.com/Sczlog/cloudtower-go-sdk/client/global_settings"
	"github.com/Sczlog/cloudtower-go-sdk/client/graph"
	"github.com/Sczlog/cloudtower-go-sdk/client/host"
	"github.com/Sczlog/cloudtower-go-sdk/client/ipmi"
	"github.com/Sczlog/cloudtower-go-sdk/client/iscsi"
	...
	"github.com/Sczlog/cloudtower-go-sdk/client/isolation_policy"
	"github.com/Sczlog/cloudtower-go-sdk/client/label"
	"github.com/Sczlog/cloudtower-go-sdk/client/license"
	"github.com/Sczlog/cloudtower-go-sdk/client/log_collection"
	"github.com/Sczlog/cloudtower-go-sdk/client/log_service_config"
	"github.com/Sczlog/cloudtower-go-sdk/client/migrate_transmitter"
	"github.com/Sczlog/cloudtower-go-sdk/client/namespace_group"
	"github.com/Sczlog/cloudtower-go-sdk/client/nfs_export"
	"github.com/Sczlog/cloudtower-go-sdk/client/nfs_inode"
	"github.com/Sczlog/cloudtower-go-sdk/client/nic"
	"github.com/Sczlog/cloudtower-go-sdk/client/node_topo"
	"github.com/Sczlog/cloudtower-go-sdk/client/nvmf_namespace"
	"github.com/Sczlog/cloudtower-go-sdk/client/nvmf_namespace_snapshot"
	"github.com/Sczlog/cloudtower-go-sdk/client/nvmf_subsystem"
	"github.com/Sczlog/cloudtower-go-sdk/client/organization"
	"github.com/Sczlog/cloudtower-go-sdk/client/pmem_dimm"
	"github.com/Sczlog/cloudtower-go-sdk/client/rack_topo"
	"github.com/Sczlog/cloudtower-go-sdk/client/report_task"
	"github.com/Sczlog/cloudtower-go-sdk/client/report_template"
	"github.com/Sczlog/cloudtower-go-sdk/client/security_policy"
	"github.com/Sczlog/cloudtower-go-sdk/client/snapshot_group"
	"github.com/Sczlog/cloudtower-go-sdk/client/snapshot_plan"
	"github.com/Sczlog/cloudtower-go-sdk/client/snapshot_plan_task"
	"github.com/Sczlog/cloudtower-go-sdk/client/snmp_transport"
	"github.com/Sczlog/cloudtower-go-sdk/client/snmp_trap_receiver"
	"github.com/Sczlog/cloudtower-go-sdk/client/svt_image"
	"github.com/Sczlog/cloudtower-go-sdk/client/system_audit_log"
	"github.com/Sczlog/cloudtower-go-sdk/client/task"
	"github.com/Sczlog/cloudtower-go-sdk/client/upload_task"
	"github.com/Sczlog/cloudtower-go-sdk/client/usb_device"
	"github.com/Sczlog/cloudtower-go-sdk/client/user"
	"github.com/Sczlog/cloudtower-go-sdk/client/user_audit_log"
	"github.com/Sczlog/cloudtower-go-sdk/client/user_role_next"
	"github.com/Sczlog/cloudtower-go-sdk/client/vcenter_account"
	"github.com/Sczlog/cloudtower-go-sdk/client/vds"
	"github.com/Sczlog/cloudtower-go-sdk/client/view"
	...
	"github.com/Sczlog/cloudtower-go-sdk/client/vsphere_esxi_account"
	"github.com/Sczlog/cloudtower-go-sdk/client/witness"
	"github.com/Sczlog/cloudtower-go-sdk/client/witness_service"
	"github.com/Sczlog/cloudtower-go-sdk/client/zone"
	"github.com/Sczlog/cloudtower-go-sdk/client/zone_topo"
	"github.com/Sczlog/cloudtower-go-sdk/client/operations"
)
