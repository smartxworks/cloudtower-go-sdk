...
// WithExternalCloudtowerID adds the externalCloudtowerID to the create nvmf namespace snapshot params
func (o *CreateNvmfNamespaceSnapshotParams) WithExternalCloudtowerID(externalCloudtowerID *string) *CreateNvmfNamespaceSnapshotParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the create nvmf namespace snapshot params
func (o *CreateNvmfNamespaceSnapshotParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
