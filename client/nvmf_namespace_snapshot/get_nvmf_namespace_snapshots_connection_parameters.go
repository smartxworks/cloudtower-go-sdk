...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get nvmf namespace snapshots connection params
func (o *GetNvmfNamespaceSnapshotsConnectionParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetNvmfNamespaceSnapshotsConnectionParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get nvmf namespace snapshots connection params
func (o *GetNvmfNamespaceSnapshotsConnectionParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
