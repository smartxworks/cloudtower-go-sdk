...
// NewMoveVMToRecycleBinParams creates a new MoveVMToRecycleBinParams object,
...
func NewMoveVMToRecycleBinParams() *MoveVMToRecycleBinParams {
	return &MoveVMToRecycleBinParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewMoveVMToRecycleBinParamsWithTimeout creates a new MoveVMToRecycleBinParams object
...
// NewMoveVMToRecycleBinParamsWithContext creates a new MoveVMToRecycleBinParams object
...
// NewMoveVMToRecycleBinParamsWithHTTPClient creates a new MoveVMToRecycleBinParams object
...
func (o *MoveVMToRecycleBinParams) WithDefaults() *MoveVMToRecycleBinParams {
	o.SetDefaults()
	return o
}
...
func (o *MoveVMToRecycleBinParams) WithTimeout(timeout time.Duration) *MoveVMToRecycleBinParams {
...
func (o *MoveVMToRecycleBinParams) WithContext(ctx context.Context) *MoveVMToRecycleBinParams {
	o.SetContext(ctx)
	return o
}
...
// WithExternalCloudtowerID adds the externalCloudtowerID to the move Vm to recycle bin params
func (o *MoveVMToRecycleBinParams) WithExternalCloudtowerID(externalCloudtowerID *string) *MoveVMToRecycleBinParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the move Vm to recycle bin params
func (o *MoveVMToRecycleBinParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
...
func (o *MoveVMToRecycleBinParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
