...
// NewRemoveVMGpuDeviceParams creates a new RemoveVMGpuDeviceParams object,
...
func NewRemoveVMGpuDeviceParams() *RemoveVMGpuDeviceParams {
	return &RemoveVMGpuDeviceParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewRemoveVMGpuDeviceParamsWithTimeout creates a new RemoveVMGpuDeviceParams object
...
// NewRemoveVMGpuDeviceParamsWithContext creates a new RemoveVMGpuDeviceParams object
...
// NewRemoveVMGpuDeviceParamsWithHTTPClient creates a new RemoveVMGpuDeviceParams object
...
func (o *RemoveVMGpuDeviceParams) WithDefaults() *RemoveVMGpuDeviceParams {
	o.SetDefaults()
	return o
}
...
func (o *RemoveVMGpuDeviceParams) WithTimeout(timeout time.Duration) *RemoveVMGpuDeviceParams {
...
func (o *RemoveVMGpuDeviceParams) WithContext(ctx context.Context) *RemoveVMGpuDeviceParams {
	o.SetContext(ctx)
	return o
}
...
// WithExternalCloudtowerID adds the externalCloudtowerID to the remove Vm gpu device params
func (o *RemoveVMGpuDeviceParams) WithExternalCloudtowerID(externalCloudtowerID *string) *RemoveVMGpuDeviceParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the remove Vm gpu device params
func (o *RemoveVMGpuDeviceParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
	o.ExternalCloudtowerID = externalCloudtowerID
}

// WithRequestBody adds the requestBody to the remove Vm gpu device params
func (o *RemoveVMGpuDeviceParams) WithRequestBody(requestBody *models.VMRemoveGpuDeviceParams) *RemoveVMGpuDeviceParams {
...
func (o *RemoveVMGpuDeviceParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
