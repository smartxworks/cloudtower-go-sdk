...
// WithExternalCloudtowerID adds the externalCloudtowerID to the start Vm params
func (o *StartVMParams) WithExternalCloudtowerID(externalCloudtowerID *string) *StartVMParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the start Vm params
func (o *StartVMParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
