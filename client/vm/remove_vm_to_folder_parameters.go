...
// NewRemoveVMToFolderParams creates a new RemoveVMToFolderParams object,
...
func NewRemoveVMToFolderParams() *RemoveVMToFolderParams {
	return &RemoveVMToFolderParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewRemoveVMToFolderParamsWithTimeout creates a new RemoveVMToFolderParams object
...
// NewRemoveVMToFolderParamsWithContext creates a new RemoveVMToFolderParams object
...
// NewRemoveVMToFolderParamsWithHTTPClient creates a new RemoveVMToFolderParams object
...
func (o *RemoveVMToFolderParams) WithDefaults() *RemoveVMToFolderParams {
	o.SetDefaults()
	return o
}
...
func (o *RemoveVMToFolderParams) WithTimeout(timeout time.Duration) *RemoveVMToFolderParams {
...
func (o *RemoveVMToFolderParams) WithContext(ctx context.Context) *RemoveVMToFolderParams {
	o.SetContext(ctx)
	return o
}
...
// WithExternalCloudtowerID adds the externalCloudtowerID to the remove Vm to folder params
func (o *RemoveVMToFolderParams) WithExternalCloudtowerID(externalCloudtowerID *string) *RemoveVMToFolderParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the remove Vm to folder params
func (o *RemoveVMToFolderParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
...
func (o *RemoveVMToFolderParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
