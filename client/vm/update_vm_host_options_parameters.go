...
// WithExternalCloudtowerID adds the externalCloudtowerID to the update Vm host options params
func (o *UpdateVMHostOptionsParams) WithExternalCloudtowerID(externalCloudtowerID *string) *UpdateVMHostOptionsParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the update Vm host options params
func (o *UpdateVMHostOptionsParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
