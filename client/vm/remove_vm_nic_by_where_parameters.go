...
// NewRemoveVMNicByWhereParams creates a new RemoveVMNicByWhereParams object,
...
func NewRemoveVMNicByWhereParams() *RemoveVMNicByWhereParams {
	return &RemoveVMNicByWhereParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewRemoveVMNicByWhereParamsWithTimeout creates a new RemoveVMNicByWhereParams object
...
// NewRemoveVMNicByWhereParamsWithContext creates a new RemoveVMNicByWhereParams object
...
// NewRemoveVMNicByWhereParamsWithHTTPClient creates a new RemoveVMNicByWhereParams object
...
func (o *RemoveVMNicByWhereParams) WithDefaults() *RemoveVMNicByWhereParams {
	o.SetDefaults()
	return o
}
...
func (o *RemoveVMNicByWhereParams) WithTimeout(timeout time.Duration) *RemoveVMNicByWhereParams {
...
func (o *RemoveVMNicByWhereParams) WithContext(ctx context.Context) *RemoveVMNicByWhereParams {
	o.SetContext(ctx)
	return o
}
...
// WithExternalCloudtowerID adds the externalCloudtowerID to the remove Vm nic by where params
func (o *RemoveVMNicByWhereParams) WithExternalCloudtowerID(externalCloudtowerID *string) *RemoveVMNicByWhereParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the remove Vm nic by where params
func (o *RemoveVMNicByWhereParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
	o.ExternalCloudtowerID = externalCloudtowerID
}

// WithRequestBody adds the requestBody to the remove Vm nic by where params
func (o *RemoveVMNicByWhereParams) WithRequestBody(requestBody *models.VMRemoveNicByWhereParams) *RemoveVMNicByWhereParams {
...
func (o *RemoveVMNicByWhereParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
