...
// WithExternalCloudtowerID adds the externalCloudtowerID to the update Vm nic vpc info params
func (o *UpdateVMNicVpcInfoParams) WithExternalCloudtowerID(externalCloudtowerID *string) *UpdateVMNicVpcInfoParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the update Vm nic vpc info params
func (o *UpdateVMNicVpcInfoParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
