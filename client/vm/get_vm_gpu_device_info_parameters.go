...
// NewGetVMGpuDeviceInfoParams creates a new GetVMGpuDeviceInfoParams object,
...
func NewGetVMGpuDeviceInfoParams() *GetVMGpuDeviceInfoParams {
	return &GetVMGpuDeviceInfoParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetVMGpuDeviceInfoParamsWithTimeout creates a new GetVMGpuDeviceInfoParams object
...
// NewGetVMGpuDeviceInfoParamsWithContext creates a new GetVMGpuDeviceInfoParams object
...
// NewGetVMGpuDeviceInfoParamsWithHTTPClient creates a new GetVMGpuDeviceInfoParams object
...
func (o *GetVMGpuDeviceInfoParams) WithDefaults() *GetVMGpuDeviceInfoParams {
	o.SetDefaults()
	return o
}
...
func (o *GetVMGpuDeviceInfoParams) WithTimeout(timeout time.Duration) *GetVMGpuDeviceInfoParams {
...
func (o *GetVMGpuDeviceInfoParams) WithContext(ctx context.Context) *GetVMGpuDeviceInfoParams {
	o.SetContext(ctx)
	return o
}
...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get Vm gpu device info params
func (o *GetVMGpuDeviceInfoParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetVMGpuDeviceInfoParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get Vm gpu device info params
func (o *GetVMGpuDeviceInfoParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
	o.ExternalCloudtowerID = externalCloudtowerID
}

// WithRequestBody adds the requestBody to the get Vm gpu device info params
func (o *GetVMGpuDeviceInfoParams) WithRequestBody(requestBody *models.GetVmsRequestBody) *GetVMGpuDeviceInfoParams {
...
func (o *GetVMGpuDeviceInfoParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
