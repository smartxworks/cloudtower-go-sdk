...
// NewUpdateVMAdvancedOptionsParams creates a new UpdateVMAdvancedOptionsParams object,
...
func NewUpdateVMAdvancedOptionsParams() *UpdateVMAdvancedOptionsParams {
	return &UpdateVMAdvancedOptionsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewUpdateVMAdvancedOptionsParamsWithTimeout creates a new UpdateVMAdvancedOptionsParams object
...
// NewUpdateVMAdvancedOptionsParamsWithContext creates a new UpdateVMAdvancedOptionsParams object
...
// NewUpdateVMAdvancedOptionsParamsWithHTTPClient creates a new UpdateVMAdvancedOptionsParams object
...
func (o *UpdateVMAdvancedOptionsParams) WithDefaults() *UpdateVMAdvancedOptionsParams {
	o.SetDefaults()
	return o
}
...
func (o *UpdateVMAdvancedOptionsParams) SetDefaults() {
	...
	val := UpdateVMAdvancedOptionsParams{
...
func (o *UpdateVMAdvancedOptionsParams) WithTimeout(timeout time.Duration) *UpdateVMAdvancedOptionsParams {
...
func (o *UpdateVMAdvancedOptionsParams) WithContext(ctx context.Context) *UpdateVMAdvancedOptionsParams {
	o.SetContext(ctx)
	return o
}
...
func (o *UpdateVMAdvancedOptionsParams) WithHTTPClient(client *http.Client) *UpdateVMAdvancedOptionsParams {
...
// WithExternalCloudtowerID adds the externalCloudtowerID to the update Vm advanced options params
func (o *UpdateVMAdvancedOptionsParams) WithExternalCloudtowerID(externalCloudtowerID *string) *UpdateVMAdvancedOptionsParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the update Vm advanced options params
func (o *UpdateVMAdvancedOptionsParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
	o.ExternalCloudtowerID = externalCloudtowerID
}

// WithRequestBody adds the requestBody to the update Vm advanced options params
func (o *UpdateVMAdvancedOptionsParams) WithRequestBody(requestBody *models.VMUpdateAdvancedOptionsParams) *UpdateVMAdvancedOptionsParams {
...
func (o *UpdateVMAdvancedOptionsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
