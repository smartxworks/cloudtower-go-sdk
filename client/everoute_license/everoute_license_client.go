...
func (a *Client) GetEverouteLicenses(params *GetEverouteLicensesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetEverouteLicensesOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "GetEverouteLicenses",
		Method:             "POST",
		PathPattern:        "/get-everoute-licenses",
	...
	success, ok := result.(*GetEverouteLicensesOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetEverouteLicenses: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) GetEverouteLicensesConnection(params *GetEverouteLicensesConnectionParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetEverouteLicensesConnectionOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "GetEverouteLicensesConnection",
		Method:             "POST",
		PathPattern:        "/get-everoute-licenses-connection",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
	...
	success, ok := result.(*GetEverouteLicensesConnectionOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetEverouteLicensesConnection: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
