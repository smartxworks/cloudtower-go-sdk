...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get nfs inodes params
func (o *GetNfsInodesParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetNfsInodesParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get nfs inodes params
func (o *GetNfsInodesParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
