...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get backup store repositories params
func (o *GetBackupStoreRepositoriesParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetBackupStoreRepositoriesParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get backup store repositories params
func (o *GetBackupStoreRepositoriesParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
