...
// WithExternalCloudtowerID adds the externalCloudtowerID to the resolve alert params
func (o *ResolveAlertParams) WithExternalCloudtowerID(externalCloudtowerID *string) *ResolveAlertParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the resolve alert params
func (o *ResolveAlertParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
