...
// WithExternalCloudtowerID adds the externalCloudtowerID to the delete snapshot group params
func (o *DeleteSnapshotGroupParams) WithExternalCloudtowerID(externalCloudtowerID *string) *DeleteSnapshotGroupParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the delete snapshot group params
func (o *DeleteSnapshotGroupParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
