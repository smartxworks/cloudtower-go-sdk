...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get Vm volume snapshots params
func (o *GetVMVolumeSnapshotsParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetVMVolumeSnapshotsParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get Vm volume snapshots params
func (o *GetVMVolumeSnapshotsParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
