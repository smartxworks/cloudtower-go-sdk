...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get log collections connection params
func (o *GetLogCollectionsConnectionParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetLogCollectionsConnectionParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get log collections connection params
func (o *GetLogCollectionsConnectionParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
