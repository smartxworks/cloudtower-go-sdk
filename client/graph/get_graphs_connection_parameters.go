...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get graphs connection params
func (o *GetGraphsConnectionParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetGraphsConnectionParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get graphs connection params
func (o *GetGraphsConnectionParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
