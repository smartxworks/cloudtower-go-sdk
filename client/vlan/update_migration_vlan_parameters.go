...
// WithExternalCloudtowerID adds the externalCloudtowerID to the update migration vlan params
func (o *UpdateMigrationVlanParams) WithExternalCloudtowerID(externalCloudtowerID *string) *UpdateMigrationVlanParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the update migration vlan params
func (o *UpdateMigrationVlanParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
