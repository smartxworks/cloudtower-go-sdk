...
// WithExternalCloudtowerID adds the externalCloudtowerID to the update management vlan params
func (o *UpdateManagementVlanParams) WithExternalCloudtowerID(externalCloudtowerID *string) *UpdateManagementVlanParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the update management vlan params
func (o *UpdateManagementVlanParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
