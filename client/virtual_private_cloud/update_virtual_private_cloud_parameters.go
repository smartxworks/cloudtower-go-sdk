...
// WithExternalCloudtowerID adds the externalCloudtowerID to the update virtual private cloud params
func (o *UpdateVirtualPrivateCloudParams) WithExternalCloudtowerID(externalCloudtowerID *string) *UpdateVirtualPrivateCloudParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the update virtual private cloud params
func (o *UpdateVirtualPrivateCloudParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
