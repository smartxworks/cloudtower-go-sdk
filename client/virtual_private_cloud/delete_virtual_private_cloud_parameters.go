...
// WithExternalCloudtowerID adds the externalCloudtowerID to the delete virtual private cloud params
func (o *DeleteVirtualPrivateCloudParams) WithExternalCloudtowerID(externalCloudtowerID *string) *DeleteVirtualPrivateCloudParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the delete virtual private cloud params
func (o *DeleteVirtualPrivateCloudParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
