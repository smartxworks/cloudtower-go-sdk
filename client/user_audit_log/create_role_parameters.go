...
func (o *CreateRoleParams) WithRequestBody(requestBody []*models.UserAuditLogCreationParams) *CreateRoleParams {
	o.SetRequestBody(requestBody)
	return o
}

// SetRequestBody adds the requestBody to the create role params
func (o *CreateRoleParams) SetRequestBody(requestBody []*models.UserAuditLogCreationParams) {
