...
func (o *CreateRoleOK) Error() string {
	return fmt.Sprintf("[POST /create-user-audit-log][%d] createRoleOK  %+v", 200, o.Payload)
}
func (o *CreateRoleOK) GetPayload() []*models.WithTaskUserAuditLog {
	return o.Payload
}
...
func (o *CreateRoleBadRequest) Error() string {
	return fmt.Sprintf("[POST /create-user-audit-log][%d] createRoleBadRequest  %+v", 400, o.Payload)
}
...
func (o *CreateRoleNotFound) Error() string {
	return fmt.Sprintf("[POST /create-user-audit-log][%d] createRoleNotFound  %+v", 404, o.Payload)
}
...
func (o *CreateRoleInternalServerError) Error() string {
	return fmt.Sprintf("[POST /create-user-audit-log][%d] createRoleInternalServerError  %+v", 500, o.Payload)
}
