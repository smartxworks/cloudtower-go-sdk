...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get user audit logs params
func (o *GetUserAuditLogsParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetUserAuditLogsParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get user audit logs params
func (o *GetUserAuditLogsParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
