...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get user audit logs connection params
func (o *GetUserAuditLogsConnectionParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetUserAuditLogsConnectionParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get user audit logs connection params
func (o *GetUserAuditLogsConnectionParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
