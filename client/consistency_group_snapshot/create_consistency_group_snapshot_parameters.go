...
// WithExternalCloudtowerID adds the externalCloudtowerID to the create consistency group snapshot params
func (o *CreateConsistencyGroupSnapshotParams) WithExternalCloudtowerID(externalCloudtowerID *string) *CreateConsistencyGroupSnapshotParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the create consistency group snapshot params
func (o *CreateConsistencyGroupSnapshotParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
