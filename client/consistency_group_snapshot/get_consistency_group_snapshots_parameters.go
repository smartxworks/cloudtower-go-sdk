...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get consistency group snapshots params
func (o *GetConsistencyGroupSnapshotsParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetConsistencyGroupSnapshotsParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get consistency group snapshots params
func (o *GetConsistencyGroupSnapshotsParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
