...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get replication plans params
func (o *GetReplicationPlansParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetReplicationPlansParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get replication plans params
func (o *GetReplicationPlansParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
