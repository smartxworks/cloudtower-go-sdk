...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get iscsi connections connection params
func (o *GetIscsiConnectionsConnectionParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetIscsiConnectionsConnectionParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get iscsi connections connection params
func (o *GetIscsiConnectionsConnectionParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
