...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get log service configs params
func (o *GetLogServiceConfigsParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetLogServiceConfigsParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get log service configs params
func (o *GetLogServiceConfigsParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
