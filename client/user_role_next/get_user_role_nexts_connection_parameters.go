...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get user role nexts connection params
func (o *GetUserRoleNextsConnectionParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetUserRoleNextsConnectionParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get user role nexts connection params
func (o *GetUserRoleNextsConnectionParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
