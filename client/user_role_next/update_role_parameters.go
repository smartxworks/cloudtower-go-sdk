...
// WithExternalCloudtowerID adds the externalCloudtowerID to the update role params
func (o *UpdateRoleParams) WithExternalCloudtowerID(externalCloudtowerID *string) *UpdateRoleParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the update role params
func (o *UpdateRoleParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
