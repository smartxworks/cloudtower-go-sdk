...
// NewDeleteIsolationPolicyParams creates a new DeleteIsolationPolicyParams object,
...
func NewDeleteIsolationPolicyParams() *DeleteIsolationPolicyParams {
	return &DeleteIsolationPolicyParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewDeleteIsolationPolicyParamsWithTimeout creates a new DeleteIsolationPolicyParams object
...
// NewDeleteIsolationPolicyParamsWithContext creates a new DeleteIsolationPolicyParams object
...
// NewDeleteIsolationPolicyParamsWithHTTPClient creates a new DeleteIsolationPolicyParams object
...
func (o *DeleteIsolationPolicyParams) WithDefaults() *DeleteIsolationPolicyParams {
	o.SetDefaults()
	return o
}
...
func (o *DeleteIsolationPolicyParams) SetDefaults() {
	...
	val := DeleteIsolationPolicyParams{
...
func (o *DeleteIsolationPolicyParams) WithTimeout(timeout time.Duration) *DeleteIsolationPolicyParams {
...
func (o *DeleteIsolationPolicyParams) WithContext(ctx context.Context) *DeleteIsolationPolicyParams {
	o.SetContext(ctx)
	return o
}
...
func (o *DeleteIsolationPolicyParams) WithHTTPClient(client *http.Client) *DeleteIsolationPolicyParams {
...
// WithExternalCloudtowerID adds the externalCloudtowerID to the delete isolation policy params
func (o *DeleteIsolationPolicyParams) WithExternalCloudtowerID(externalCloudtowerID *string) *DeleteIsolationPolicyParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the delete isolation policy params
func (o *DeleteIsolationPolicyParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
	o.ExternalCloudtowerID = externalCloudtowerID
}

// WithRequestBody adds the requestBody to the delete isolation policy params
func (o *DeleteIsolationPolicyParams) WithRequestBody(requestBody *models.IsolationPolicyDeleteParams) *DeleteIsolationPolicyParams {
...
func (o *DeleteIsolationPolicyParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
