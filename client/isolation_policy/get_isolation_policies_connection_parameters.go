...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get isolation policies connection params
func (o *GetIsolationPoliciesConnectionParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetIsolationPoliciesConnectionParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get isolation policies connection params
func (o *GetIsolationPoliciesConnectionParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
