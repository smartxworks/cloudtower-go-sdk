...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get iscsi targets connection params
func (o *GetIscsiTargetsConnectionParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetIscsiTargetsConnectionParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get iscsi targets connection params
func (o *GetIscsiTargetsConnectionParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
