...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get nfs exports connection params
func (o *GetNfsExportsConnectionParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetNfsExportsConnectionParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get nfs exports connection params
func (o *GetNfsExportsConnectionParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
