...
// WithExternalCloudtowerID adds the externalCloudtowerID to the delete nfs export params
func (o *DeleteNfsExportParams) WithExternalCloudtowerID(externalCloudtowerID *string) *DeleteNfsExportParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the delete nfs export params
func (o *DeleteNfsExportParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
