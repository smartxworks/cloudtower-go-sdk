...
// WithExternalCloudtowerID adds the externalCloudtowerID to the get witness services params
func (o *GetWitnessServicesParams) WithExternalCloudtowerID(externalCloudtowerID *string) *GetWitnessServicesParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the get witness services params
func (o *GetWitnessServicesParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
