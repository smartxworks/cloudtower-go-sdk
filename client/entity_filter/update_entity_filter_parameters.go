...
// WithExternalCloudtowerID adds the externalCloudtowerID to the update entity filter params
func (o *UpdateEntityFilterParams) WithExternalCloudtowerID(externalCloudtowerID *string) *UpdateEntityFilterParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the update entity filter params
func (o *UpdateEntityFilterParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
