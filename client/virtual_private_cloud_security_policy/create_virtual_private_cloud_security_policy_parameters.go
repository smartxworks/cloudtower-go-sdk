...
// WithExternalCloudtowerID adds the externalCloudtowerID to the create virtual private cloud security policy params
func (o *CreateVirtualPrivateCloudSecurityPolicyParams) WithExternalCloudtowerID(externalCloudtowerID *string) *CreateVirtualPrivateCloudSecurityPolicyParams {
	o.SetExternalCloudtowerID(externalCloudtowerID)
	return o
}

// SetExternalCloudtowerID adds the externalCloudtowerId to the create virtual private cloud security policy params
func (o *CreateVirtualPrivateCloudSecurityPolicyParams) SetExternalCloudtowerID(externalCloudtowerID *string) {
