...
type GetSnapshotPlansRequestBody struct {
	...
	MarshalOpts *GetSnapshotPlansRequestBodyMarshalOpts `json:"-"`
}

type GetSnapshotPlansRequestBodyMarshalOpts struct {
...
func (m GetSnapshotPlansRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
