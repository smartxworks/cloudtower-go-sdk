...
type NestedVds struct {
	...
	MarshalOpts *NestedVdsMarshalOpts `json:"-"`
}

type NestedVdsMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedVds) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedVds) validateID(formats strfmt.Registry) error {
...
func (m *NestedVds) validateName(formats strfmt.Registry) error {
