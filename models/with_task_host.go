...
type WithTaskHost struct {
	...
	MarshalOpts *WithTaskHostMarshalOpts `json:"-"`
}

type WithTaskHostMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskHost) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskHost) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskHost) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
