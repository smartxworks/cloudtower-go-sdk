...
type NestedEntityFilter struct {
	...
	MarshalOpts *NestedEntityFilterMarshalOpts `json:"-"`
}

type NestedEntityFilterMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedEntityFilter) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedEntityFilter) validateID(formats strfmt.Registry) error {
...
func (m *NestedEntityFilter) validateName(formats strfmt.Registry) error {
