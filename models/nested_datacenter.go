...
type NestedDatacenter struct {
	...
	MarshalOpts *NestedDatacenterMarshalOpts `json:"-"`
}

type NestedDatacenterMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedDatacenter) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedDatacenter) validateID(formats strfmt.Registry) error {
...
func (m *NestedDatacenter) validateName(formats strfmt.Registry) error {
