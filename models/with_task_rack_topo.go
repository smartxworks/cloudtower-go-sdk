...
type WithTaskRackTopo struct {
	...
	MarshalOpts *WithTaskRackTopoMarshalOpts `json:"-"`
}

type WithTaskRackTopoMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskRackTopo) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskRackTopo) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskRackTopo) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
