...
type GetExportFileDownloadLinksParams struct {
	...
	MarshalOpts *GetExportFileDownloadLinksParamsMarshalOpts `json:"-"`
}

type GetExportFileDownloadLinksParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m GetExportFileDownloadLinksParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
