...
type BrickTopoDeletionParams struct {
	...
	MarshalOpts *BrickTopoDeletionParamsMarshalOpts `json:"-"`
}

type BrickTopoDeletionParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m BrickTopoDeletionParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *BrickTopoDeletionParams) validateWhere(formats strfmt.Registry) error {
...
func (m *BrickTopoDeletionParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BrickTopoDeletionParams) UnmarshalBinary(b []byte) error {
	var res BrickTopoDeletionParams
