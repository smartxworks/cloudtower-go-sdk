...
type GetPmemDimmsConnectionRequestBody struct {
	...
	MarshalOpts *GetPmemDimmsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetPmemDimmsConnectionRequestBodyMarshalOpts struct {
...
func (m GetPmemDimmsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetPmemDimmsConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetPmemDimmsConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetPmemDimmsConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetPmemDimmsConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
