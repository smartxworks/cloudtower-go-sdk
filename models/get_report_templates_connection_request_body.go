...
type GetReportTemplatesConnectionRequestBody struct {
	...
	MarshalOpts *GetReportTemplatesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetReportTemplatesConnectionRequestBodyMarshalOpts struct {
...
func (m GetReportTemplatesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
