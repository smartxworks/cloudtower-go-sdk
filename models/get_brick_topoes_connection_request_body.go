...
type GetBrickTopoesConnectionRequestBody struct {
	...
	MarshalOpts *GetBrickTopoesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetBrickTopoesConnectionRequestBodyMarshalOpts struct {
...
func (m GetBrickTopoesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
