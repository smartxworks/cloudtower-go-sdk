...
type BackupRestoreExecutionConnection struct {
	...
	MarshalOpts *BackupRestoreExecutionConnectionMarshalOpts `json:"-"`
}

type BackupRestoreExecutionConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m BackupRestoreExecutionConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
