...
type GetWitnessesConnectionRequestBody struct {
	...
	MarshalOpts *GetWitnessesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetWitnessesConnectionRequestBodyMarshalOpts struct {
...
func (m GetWitnessesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
