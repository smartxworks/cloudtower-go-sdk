...
type GetUserRoleNextsConnectionRequestBody struct {
	...
	MarshalOpts *GetUserRoleNextsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetUserRoleNextsConnectionRequestBodyMarshalOpts struct {
...
func (m GetUserRoleNextsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetUserRoleNextsConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetUserRoleNextsConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetUserRoleNextsConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetUserRoleNextsConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
