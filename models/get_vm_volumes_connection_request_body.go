...
type GetVMVolumesConnectionRequestBody struct {
	...
	MarshalOpts *GetVMVolumesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetVMVolumesConnectionRequestBodyMarshalOpts struct {
...
func (m GetVMVolumesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
