...
type SecurityGroupDeleteParams struct {
	...
	MarshalOpts *SecurityGroupDeleteParamsMarshalOpts `json:"-"`
}

type SecurityGroupDeleteParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m SecurityGroupDeleteParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *SecurityGroupDeleteParams) validateWhere(formats strfmt.Registry) error {
...
func (m *SecurityGroupDeleteParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SecurityGroupDeleteParams) UnmarshalBinary(b []byte) error {
	var res SecurityGroupDeleteParams
