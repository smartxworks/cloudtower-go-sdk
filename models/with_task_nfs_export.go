...
type WithTaskNfsExport struct {
	...
	MarshalOpts *WithTaskNfsExportMarshalOpts `json:"-"`
}

type WithTaskNfsExportMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskNfsExport) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskNfsExport) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskNfsExport) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
