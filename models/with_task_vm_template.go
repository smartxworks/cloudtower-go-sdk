...
type WithTaskVMTemplate struct {
	...
	MarshalOpts *WithTaskVMTemplateMarshalOpts `json:"-"`
}

type WithTaskVMTemplateMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskVMTemplate) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskVMTemplate) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskVMTemplate) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
