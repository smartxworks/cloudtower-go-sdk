...
type WithTaskUserAuditLog struct {
	...
	MarshalOpts *WithTaskUserAuditLogMarshalOpts `json:"-"`
}

type WithTaskUserAuditLogMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskUserAuditLog) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskUserAuditLog) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskUserAuditLog) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
