...
type IscsiTargetCommonParamsInitiatorChaps struct {
	...
	MarshalOpts *IscsiTargetCommonParamsInitiatorChapsMarshalOpts `json:"-"`
}

type IscsiTargetCommonParamsInitiatorChapsMarshalOpts struct {
...
func (m IscsiTargetCommonParamsInitiatorChaps) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
