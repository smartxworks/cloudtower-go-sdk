...
type WithTaskDeleteContentLibraryImage struct {
	...
	MarshalOpts *WithTaskDeleteContentLibraryImageMarshalOpts `json:"-"`
}

type WithTaskDeleteContentLibraryImageMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteContentLibraryImage) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
