...
type NestedVMVolume struct {
	...
	MarshalOpts *NestedVMVolumeMarshalOpts `json:"-"`
}

type NestedVMVolumeMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedVMVolume) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedVMVolume) validateID(formats strfmt.Registry) error {
...
func (m *NestedVMVolume) validateName(formats strfmt.Registry) error {
