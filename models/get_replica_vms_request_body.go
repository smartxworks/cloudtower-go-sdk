...
// GetReplicaVmsRequestBody get replica vms request body
//
// swagger:model GetReplicaVmsRequestBody
type GetReplicaVmsRequestBody struct {
	...
	MarshalOpts *GetReplicaVmsRequestBodyMarshalOpts `json:"-"`
}

type GetReplicaVmsRequestBodyMarshalOpts struct {
...
func (m GetReplicaVmsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
// Validate validates this get replica vms request body
func (m *GetReplicaVmsRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetReplicaVmsRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetReplicaVmsRequestBody) validateWhere(formats strfmt.Registry) error {
...
// ContextValidate validate this get replica vms request body based on the context it is used
func (m *GetReplicaVmsRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetReplicaVmsRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetReplicaVmsRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetReplicaVmsRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetReplicaVmsRequestBody) UnmarshalBinary(b []byte) error {
	var res GetReplicaVmsRequestBody
