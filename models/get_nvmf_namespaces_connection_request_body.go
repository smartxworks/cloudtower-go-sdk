...
type GetNvmfNamespacesConnectionRequestBody struct {
	...
	MarshalOpts *GetNvmfNamespacesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetNvmfNamespacesConnectionRequestBodyMarshalOpts struct {
...
func (m GetNvmfNamespacesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
