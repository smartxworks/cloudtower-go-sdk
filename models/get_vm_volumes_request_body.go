...
type GetVMVolumesRequestBody struct {
	...
	MarshalOpts *GetVMVolumesRequestBodyMarshalOpts `json:"-"`
}

type GetVMVolumesRequestBodyMarshalOpts struct {
...
func (m GetVMVolumesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
