...
func (m *GetVMVolumesRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetVMVolumesRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetVMVolumesRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetVMVolumesRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
