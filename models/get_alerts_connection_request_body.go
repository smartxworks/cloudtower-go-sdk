...
type GetAlertsConnectionRequestBody struct {
	...
	MarshalOpts *GetAlertsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetAlertsConnectionRequestBodyMarshalOpts struct {
...
func (m GetAlertsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
