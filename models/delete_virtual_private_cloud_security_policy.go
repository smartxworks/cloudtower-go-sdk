...
type DeleteVirtualPrivateCloudSecurityPolicy struct {
	...
	MarshalOpts *DeleteVirtualPrivateCloudSecurityPolicyMarshalOpts `json:"-"`
}

type DeleteVirtualPrivateCloudSecurityPolicyMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteVirtualPrivateCloudSecurityPolicy) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
