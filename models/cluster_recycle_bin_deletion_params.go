...
type ClusterRecycleBinDeletionParams struct {
	...
	MarshalOpts *ClusterRecycleBinDeletionParamsMarshalOpts `json:"-"`
}

type ClusterRecycleBinDeletionParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m ClusterRecycleBinDeletionParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
