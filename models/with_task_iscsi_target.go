...
type WithTaskIscsiTarget struct {
	...
	MarshalOpts *WithTaskIscsiTargetMarshalOpts `json:"-"`
}

type WithTaskIscsiTargetMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskIscsiTarget) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskIscsiTarget) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskIscsiTarget) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
