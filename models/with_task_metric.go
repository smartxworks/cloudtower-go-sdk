...
type WithTaskMetric struct {
	...
	MarshalOpts *WithTaskMetricMarshalOpts `json:"-"`
}

type WithTaskMetricMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskMetric) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskMetric) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskMetric) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
