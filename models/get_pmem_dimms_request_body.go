...
type GetPmemDimmsRequestBody struct {
	...
	MarshalOpts *GetPmemDimmsRequestBodyMarshalOpts `json:"-"`
}

type GetPmemDimmsRequestBodyMarshalOpts struct {
...
func (m GetPmemDimmsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetPmemDimmsRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetPmemDimmsRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetPmemDimmsRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetPmemDimmsRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
