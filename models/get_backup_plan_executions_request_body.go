...
// GetBackupPlanExecutionsRequestBody get backup plan executions request body
//
// swagger:model GetBackupPlanExecutionsRequestBody
type GetBackupPlanExecutionsRequestBody struct {
	...
	MarshalOpts *GetBackupPlanExecutionsRequestBodyMarshalOpts `json:"-"`
}

type GetBackupPlanExecutionsRequestBodyMarshalOpts struct {
...
func (m GetBackupPlanExecutionsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
// Validate validates this get backup plan executions request body
func (m *GetBackupPlanExecutionsRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetBackupPlanExecutionsRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetBackupPlanExecutionsRequestBody) validateWhere(formats strfmt.Registry) error {
...
// ContextValidate validate this get backup plan executions request body based on the context it is used
func (m *GetBackupPlanExecutionsRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetBackupPlanExecutionsRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetBackupPlanExecutionsRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetBackupPlanExecutionsRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetBackupPlanExecutionsRequestBody) UnmarshalBinary(b []byte) error {
	var res GetBackupPlanExecutionsRequestBody
