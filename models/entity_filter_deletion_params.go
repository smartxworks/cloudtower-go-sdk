...
type EntityFilterDeletionParams struct {
	...
	MarshalOpts *EntityFilterDeletionParamsMarshalOpts `json:"-"`
}

type EntityFilterDeletionParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m EntityFilterDeletionParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *EntityFilterDeletionParams) validateWhere(formats strfmt.Registry) error {
...
func (m *EntityFilterDeletionParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EntityFilterDeletionParams) UnmarshalBinary(b []byte) error {
	var res EntityFilterDeletionParams
