...
type GetWitnessesRequestBody struct {
	...
	MarshalOpts *GetWitnessesRequestBodyMarshalOpts `json:"-"`
}

type GetWitnessesRequestBodyMarshalOpts struct {
...
func (m GetWitnessesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
