...
type GetUploadTasksConnectionRequestBody struct {
	...
	MarshalOpts *GetUploadTasksConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetUploadTasksConnectionRequestBodyMarshalOpts struct {
...
func (m GetUploadTasksConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
