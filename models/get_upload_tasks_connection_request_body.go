...
func (m *GetUploadTasksConnectionRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetUploadTasksConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetUploadTasksConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetUploadTasksConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetUploadTasksConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetUploadTasksConnectionRequestBody) UnmarshalBinary(b []byte) error {
	var res GetUploadTasksConnectionRequestBody
