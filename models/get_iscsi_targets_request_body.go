...
type GetIscsiTargetsRequestBody struct {
	...
	MarshalOpts *GetIscsiTargetsRequestBodyMarshalOpts `json:"-"`
}

type GetIscsiTargetsRequestBodyMarshalOpts struct {
...
func (m GetIscsiTargetsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
