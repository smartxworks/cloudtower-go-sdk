...
type GetVsphereEsxiAccountsConnectionRequestBody struct {
	...
	MarshalOpts *GetVsphereEsxiAccountsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetVsphereEsxiAccountsConnectionRequestBodyMarshalOpts struct {
...
func (m GetVsphereEsxiAccountsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetVsphereEsxiAccountsConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetVsphereEsxiAccountsConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetVsphereEsxiAccountsConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetVsphereEsxiAccountsConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
