...
type WithTaskDeleteGraph struct {
	...
	MarshalOpts *WithTaskDeleteGraphMarshalOpts `json:"-"`
}

type WithTaskDeleteGraphMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteGraph) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteGraph) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteGraph) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
