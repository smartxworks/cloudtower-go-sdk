...
type IscsiTargetUpdationParams struct {
	...
	MarshalOpts *IscsiTargetUpdationParamsMarshalOpts `json:"-"`
}

type IscsiTargetUpdationParamsMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	Where_Explicit_Null_When_Empty bool
}

func (m IscsiTargetUpdationParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *IscsiTargetUpdationParams) validateData(formats strfmt.Registry) error {
...
func (m *IscsiTargetUpdationParams) validateWhere(formats strfmt.Registry) error {
...
func (m *IscsiTargetUpdationParams) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IscsiTargetUpdationParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IscsiTargetUpdationParams) UnmarshalBinary(b []byte) error {
	var res IscsiTargetUpdationParams
