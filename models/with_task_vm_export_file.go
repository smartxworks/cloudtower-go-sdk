...
type WithTaskVMExportFile struct {
	...
	MarshalOpts *WithTaskVMExportFileMarshalOpts `json:"-"`
}

type WithTaskVMExportFileMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskVMExportFile) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskVMExportFile) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskVMExportFile) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
