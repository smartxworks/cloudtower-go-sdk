...
type WithTaskCluster struct {
	...
	MarshalOpts *WithTaskClusterMarshalOpts `json:"-"`
}

type WithTaskClusterMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskCluster) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskCluster) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskCluster) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
