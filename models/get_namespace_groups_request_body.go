...
type GetNamespaceGroupsRequestBody struct {
	...
	MarshalOpts *GetNamespaceGroupsRequestBodyMarshalOpts `json:"-"`
}

type GetNamespaceGroupsRequestBodyMarshalOpts struct {
...
func (m GetNamespaceGroupsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetNamespaceGroupsRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetNamespaceGroupsRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetNamespaceGroupsRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetNamespaceGroupsRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetNamespaceGroupsRequestBody) UnmarshalBinary(b []byte) error {
	var res GetNamespaceGroupsRequestBody
