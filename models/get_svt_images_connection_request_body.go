...
type GetSvtImagesConnectionRequestBody struct {
	...
	MarshalOpts *GetSvtImagesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetSvtImagesConnectionRequestBodyMarshalOpts struct {
...
func (m GetSvtImagesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
