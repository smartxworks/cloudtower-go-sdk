...
type GetVMNicsConnectionRequestBody struct {
	...
	MarshalOpts *GetVMNicsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetVMNicsConnectionRequestBodyMarshalOpts struct {
...
func (m GetVMNicsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetVMNicsConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetVMNicsConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetVMNicsConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetVMNicsConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetVMNicsConnectionRequestBody) UnmarshalBinary(b []byte) error {
	var res GetVMNicsConnectionRequestBody
