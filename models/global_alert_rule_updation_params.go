...
type GlobalAlertRuleUpdationParams struct {
	...
	MarshalOpts *GlobalAlertRuleUpdationParamsMarshalOpts `json:"-"`
}

type GlobalAlertRuleUpdationParamsMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	Where_Explicit_Null_When_Empty bool
}

func (m GlobalAlertRuleUpdationParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
type GlobalAlertRuleUpdationParamsData struct {
	...
	MarshalOpts *GlobalAlertRuleUpdationParamsDataMarshalOpts `json:"-"`
}

type GlobalAlertRuleUpdationParamsDataMarshalOpts struct {
	Disabled_Explicit_Null_When_Empty bool

	Thresholds_Explicit_Null_When_Empty bool
}

func (m GlobalAlertRuleUpdationParamsData) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
