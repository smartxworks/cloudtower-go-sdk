...
type CancelUploadTaskParams struct {
	...
	MarshalOpts *CancelUploadTaskParamsMarshalOpts `json:"-"`
}

type CancelUploadTaskParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m CancelUploadTaskParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *CancelUploadTaskParams) validateWhere(formats strfmt.Registry) error {
...
func (m *CancelUploadTaskParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CancelUploadTaskParams) UnmarshalBinary(b []byte) error {
	var res CancelUploadTaskParams
