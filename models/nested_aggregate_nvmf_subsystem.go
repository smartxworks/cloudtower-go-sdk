...
type NestedAggregateNvmfSubsystem struct {
	...
	MarshalOpts *NestedAggregateNvmfSubsystemMarshalOpts `json:"-"`
}

type NestedAggregateNvmfSubsystemMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateNvmfSubsystem) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateNvmfSubsystem) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateNvmfSubsystem) UnmarshalBinary(b []byte) error {
	var res NestedAggregateNvmfSubsystem
