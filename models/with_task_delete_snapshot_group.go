...
type WithTaskDeleteSnapshotGroup struct {
	...
	MarshalOpts *WithTaskDeleteSnapshotGroupMarshalOpts `json:"-"`
}

type WithTaskDeleteSnapshotGroupMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteSnapshotGroup) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteSnapshotGroup) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteSnapshotGroup) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskDeleteSnapshotGroup) UnmarshalBinary(b []byte) error {
	var res WithTaskDeleteSnapshotGroup
