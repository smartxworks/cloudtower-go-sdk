...
type GetIscsiConnectionsRequestBody struct {
	...
	MarshalOpts *GetIscsiConnectionsRequestBodyMarshalOpts `json:"-"`
}

type GetIscsiConnectionsRequestBodyMarshalOpts struct {
...
func (m GetIscsiConnectionsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
