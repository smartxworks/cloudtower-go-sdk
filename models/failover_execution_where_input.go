...
// FailoverExecutionWhereInput failover execution where input
//
// swagger:model FailoverExecutionWhereInput
type FailoverExecutionWhereInput struct {

	// a n d
	AND []*FailoverExecutionWhereInput `json:"AND,omitempty"`

	// n o t
	NOT []*FailoverExecutionWhereInput `json:"NOT,omitempty"`

	// o r
	OR []*FailoverExecutionWhereInput `json:"OR,omitempty"`
	...
	// is test mode not
	IsTestModeNot *bool `json:"is_test_mode_not,omitempty"`

	// replication failover target executions every
	ReplicationFailoverTargetExecutionsEvery *ReplicationFailoverTargetExecutionWhereInput `json:"replication_failover_target_executions_every,omitempty"`

	// replication failover target executions none
	ReplicationFailoverTargetExecutionsNone *ReplicationFailoverTargetExecutionWhereInput `json:"replication_failover_target_executions_none,omitempty"`

	// replication failover target executions some
	ReplicationFailoverTargetExecutionsSome *ReplicationFailoverTargetExecutionWhereInput `json:"replication_failover_target_executions_some,omitempty"`
	...
	// shutdown mode
	ShutdownMode *FailoverShutdownMode `json:"shutdown_mode,omitempty"`

	// shutdown mode in
	ShutdownModeIn []FailoverShutdownMode `json:"shutdown_mode_in,omitempty"`

	// shutdown mode not
	ShutdownModeNot *FailoverShutdownMode `json:"shutdown_mode_not,omitempty"`

	// shutdown mode not in
	ShutdownModeNotIn []FailoverShutdownMode `json:"shutdown_mode_not_in,omitempty"`
	...
	MarshalOpts *FailoverExecutionWhereInputMarshalOpts `json:"-"`
}

type FailoverExecutionWhereInputMarshalOpts struct {
	...
	IsTestMode_Explicit_Null_When_Empty bool

	IsTestModeNot_Explicit_Null_When_Empty bool

	ReplicationFailoverTargetExecutionsEvery_Explicit_Null_When_Empty bool

	ReplicationFailoverTargetExecutionsNone_Explicit_Null_When_Empty bool

	ReplicationFailoverTargetExecutionsSome_Explicit_Null_When_Empty bool
	...
	ShutdownMode_Explicit_Null_When_Empty bool

	ShutdownModeIn_Explicit_Null_When_Empty bool

	ShutdownModeNot_Explicit_Null_When_Empty bool

	ShutdownModeNotIn_Explicit_Null_When_Empty bool
...
func (m FailoverExecutionWhereInput) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
	...
	// handle nullable field is_test_mode
	if m.IsTestMode != nil {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"is_test_mode\":")
		bytes, err := swag.WriteJSON(m.IsTestMode)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
		first = false
	} else if m.MarshalOpts != nil && m.MarshalOpts.IsTestMode_Explicit_Null_When_Empty {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"is_test_mode\":null")
		first = false
	}

	// handle nullable field is_test_mode_not
	if m.IsTestModeNot != nil {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"is_test_mode_not\":")
		bytes, err := swag.WriteJSON(m.IsTestModeNot)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
		first = false
	} else if m.MarshalOpts != nil && m.MarshalOpts.IsTestModeNot_Explicit_Null_When_Empty {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"is_test_mode_not\":null")
		first = false
	}

	// handle nullable field replication_failover_target_executions_every
	if m.ReplicationFailoverTargetExecutionsEvery != nil {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"replication_failover_target_executions_every\":")
		bytes, err := swag.WriteJSON(m.ReplicationFailoverTargetExecutionsEvery)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
		first = false
	} else if m.MarshalOpts != nil && m.MarshalOpts.ReplicationFailoverTargetExecutionsEvery_Explicit_Null_When_Empty {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"replication_failover_target_executions_every\":null")
		first = false
	}

	// handle nullable field replication_failover_target_executions_none
	if m.ReplicationFailoverTargetExecutionsNone != nil {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"replication_failover_target_executions_none\":")
		bytes, err := swag.WriteJSON(m.ReplicationFailoverTargetExecutionsNone)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
		first = false
	} else if m.MarshalOpts != nil && m.MarshalOpts.ReplicationFailoverTargetExecutionsNone_Explicit_Null_When_Empty {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"replication_failover_target_executions_none\":null")
		first = false
	}

	// handle nullable field replication_failover_target_executions_some
	if m.ReplicationFailoverTargetExecutionsSome != nil {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"replication_failover_target_executions_some\":")
		bytes, err := swag.WriteJSON(m.ReplicationFailoverTargetExecutionsSome)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
		first = false
	} else if m.MarshalOpts != nil && m.MarshalOpts.ReplicationFailoverTargetExecutionsSome_Explicit_Null_When_Empty {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"replication_failover_target_executions_some\":null")
		first = false
	}
	...
	// handle nullable field shutdown_mode
	if m.ShutdownMode != nil {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"shutdown_mode\":")
		bytes, err := swag.WriteJSON(m.ShutdownMode)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
		first = false
	} else if m.MarshalOpts != nil && m.MarshalOpts.ShutdownMode_Explicit_Null_When_Empty {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"shutdown_mode\":null")
		first = false
	}

	// handle non nullable field shutdown_mode_in with omitempty
	if !swag.IsZero(m.ShutdownModeIn) {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"shutdown_mode_in\":")
		bytes, err := swag.WriteJSON(m.ShutdownModeIn)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
	...
	// handle nullable field shutdown_mode_not
	if m.ShutdownModeNot != nil {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"shutdown_mode_not\":")
		bytes, err := swag.WriteJSON(m.ShutdownModeNot)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
		first = false
	} else if m.MarshalOpts != nil && m.MarshalOpts.ShutdownModeNot_Explicit_Null_When_Empty {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"shutdown_mode_not\":null")
		first = false
	}

	// handle non nullable field shutdown_mode_not_in with omitempty
	if !swag.IsZero(m.ShutdownModeNotIn) {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"shutdown_mode_not_in\":")
		bytes, err := swag.WriteJSON(m.ShutdownModeNotIn)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
...
// Validate validates this failover execution where input
func (m *FailoverExecutionWhereInput) Validate(formats strfmt.Registry) error {
	var res []error
	...
	if err := m.validateReplicationFailoverTargetExecutionsEvery(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateReplicationFailoverTargetExecutionsNone(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateReplicationFailoverTargetExecutionsSome(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateShutdownMode(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateShutdownModeIn(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateShutdownModeNot(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateShutdownModeNotIn(formats); err != nil {
		res = append(res, err)
	}
...
func (m *FailoverExecutionWhereInput) validateAND(formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) validateNOT(formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) validateOR(formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) validateEntityAsyncStatus(formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) validateEntityAsyncStatusIn(formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) validateEntityAsyncStatusNot(formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) validateEntityAsyncStatusNotIn(formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) validateExternalCloudtower(formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) validateReplicationFailoverTargetExecutionsEvery(formats strfmt.Registry) error {
	if swag.IsZero(m.ReplicationFailoverTargetExecutionsEvery) { // not required
		return nil
	}

	if m.ReplicationFailoverTargetExecutionsEvery != nil {
		if err := m.ReplicationFailoverTargetExecutionsEvery.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("replication_failover_target_executions_every")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("replication_failover_target_executions_every")
			}
			return err
		}
	}
...
func (m *FailoverExecutionWhereInput) validateReplicationFailoverTargetExecutionsNone(formats strfmt.Registry) error {
	if swag.IsZero(m.ReplicationFailoverTargetExecutionsNone) { // not required
		return nil
	}

	if m.ReplicationFailoverTargetExecutionsNone != nil {
		if err := m.ReplicationFailoverTargetExecutionsNone.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("replication_failover_target_executions_none")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("replication_failover_target_executions_none")
			}
			return err
		}
	}
...
func (m *FailoverExecutionWhereInput) validateReplicationFailoverTargetExecutionsSome(formats strfmt.Registry) error {
	if swag.IsZero(m.ReplicationFailoverTargetExecutionsSome) { // not required
		return nil
	}

	if m.ReplicationFailoverTargetExecutionsSome != nil {
		if err := m.ReplicationFailoverTargetExecutionsSome.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("replication_failover_target_executions_some")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("replication_failover_target_executions_some")
			}
			return err
		}
	}
...
func (m *FailoverExecutionWhereInput) validateReplicationService(formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) validateShutdownMode(formats strfmt.Registry) error {
	if swag.IsZero(m.ShutdownMode) { // not required
		return nil
	}

	if m.ShutdownMode != nil {
		if err := m.ShutdownMode.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("shutdown_mode")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("shutdown_mode")
			}
			return err
		}
	}
...
func (m *FailoverExecutionWhereInput) validateShutdownModeIn(formats strfmt.Registry) error {
	if swag.IsZero(m.ShutdownModeIn) { // not required
		return nil
	}

	for i := 0; i < len(m.ShutdownModeIn); i++ {

		if err := m.ShutdownModeIn[i].Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("shutdown_mode_in" + "." + strconv.Itoa(i))
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("shutdown_mode_in" + "." + strconv.Itoa(i))
			}
			return err
		}
...
func (m *FailoverExecutionWhereInput) validateShutdownModeNot(formats strfmt.Registry) error {
	if swag.IsZero(m.ShutdownModeNot) { // not required
		return nil
	}

	if m.ShutdownModeNot != nil {
		if err := m.ShutdownModeNot.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("shutdown_mode_not")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("shutdown_mode_not")
			}
			return err
		}
	}
...
func (m *FailoverExecutionWhereInput) validateShutdownModeNotIn(formats strfmt.Registry) error {
	if swag.IsZero(m.ShutdownModeNotIn) { // not required
		return nil
	}

	for i := 0; i < len(m.ShutdownModeNotIn); i++ {

		if err := m.ShutdownModeNotIn[i].Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("shutdown_mode_not_in" + "." + strconv.Itoa(i))
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("shutdown_mode_not_in" + "." + strconv.Itoa(i))
			}
			return err
		}
...
func (m *FailoverExecutionWhereInput) validateState(formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) validateStateIn(formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) validateStateNot(formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) validateStateNotIn(formats strfmt.Registry) error {
...
// ContextValidate validate this failover execution where input based on the context it is used
func (m *FailoverExecutionWhereInput) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
	...
	if err := m.contextValidateReplicationFailoverTargetExecutionsEvery(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateReplicationFailoverTargetExecutionsNone(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateReplicationFailoverTargetExecutionsSome(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateShutdownMode(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateShutdownModeIn(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateShutdownModeNot(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateShutdownModeNotIn(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *FailoverExecutionWhereInput) contextValidateAND(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) contextValidateNOT(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) contextValidateOR(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) contextValidateEntityAsyncStatus(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) contextValidateEntityAsyncStatusIn(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) contextValidateEntityAsyncStatusNot(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) contextValidateEntityAsyncStatusNotIn(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) contextValidateExternalCloudtower(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) contextValidateReplicationFailoverTargetExecutionsEvery(ctx context.Context, formats strfmt.Registry) error {

	if m.ReplicationFailoverTargetExecutionsEvery != nil {
		if err := m.ReplicationFailoverTargetExecutionsEvery.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("replication_failover_target_executions_every")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("replication_failover_target_executions_every")
...
func (m *FailoverExecutionWhereInput) contextValidateReplicationFailoverTargetExecutionsNone(ctx context.Context, formats strfmt.Registry) error {

	if m.ReplicationFailoverTargetExecutionsNone != nil {
		if err := m.ReplicationFailoverTargetExecutionsNone.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("replication_failover_target_executions_none")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("replication_failover_target_executions_none")
...
func (m *FailoverExecutionWhereInput) contextValidateReplicationFailoverTargetExecutionsSome(ctx context.Context, formats strfmt.Registry) error {

	if m.ReplicationFailoverTargetExecutionsSome != nil {
		if err := m.ReplicationFailoverTargetExecutionsSome.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("replication_failover_target_executions_some")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("replication_failover_target_executions_some")
...
func (m *FailoverExecutionWhereInput) contextValidateReplicationService(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) contextValidateShutdownMode(ctx context.Context, formats strfmt.Registry) error {

	if m.ShutdownMode != nil {
		if err := m.ShutdownMode.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("shutdown_mode")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("shutdown_mode")
...
func (m *FailoverExecutionWhereInput) contextValidateShutdownModeIn(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.ShutdownModeIn); i++ {

		if err := m.ShutdownModeIn[i].ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("shutdown_mode_in" + "." + strconv.Itoa(i))
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("shutdown_mode_in" + "." + strconv.Itoa(i))
...
func (m *FailoverExecutionWhereInput) contextValidateShutdownModeNot(ctx context.Context, formats strfmt.Registry) error {

	if m.ShutdownModeNot != nil {
		if err := m.ShutdownModeNot.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("shutdown_mode_not")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("shutdown_mode_not")
...
func (m *FailoverExecutionWhereInput) contextValidateShutdownModeNotIn(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.ShutdownModeNotIn); i++ {

		if err := m.ShutdownModeNotIn[i].ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("shutdown_mode_not_in" + "." + strconv.Itoa(i))
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("shutdown_mode_not_in" + "." + strconv.Itoa(i))
...
func (m *FailoverExecutionWhereInput) contextValidateState(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) contextValidateStateIn(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) contextValidateStateNot(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) contextValidateStateNotIn(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FailoverExecutionWhereInput) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *FailoverExecutionWhereInput) UnmarshalBinary(b []byte) error {
	var res FailoverExecutionWhereInput
