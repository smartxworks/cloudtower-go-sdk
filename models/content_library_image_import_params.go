...
func (m *ContentLibraryImageImportParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ContentLibraryImageImportParams) validateData(formats strfmt.Registry) error {
...
func (m *ContentLibraryImageImportParams) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ContentLibraryImageImportParams) UnmarshalBinary(b []byte) error {
	var res ContentLibraryImageImportParams
