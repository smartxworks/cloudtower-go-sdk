...
type NamespaceGroupConnection struct {
	...
	MarshalOpts *NamespaceGroupConnectionMarshalOpts `json:"-"`
}

type NamespaceGroupConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m NamespaceGroupConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
