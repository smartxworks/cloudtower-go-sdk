...
type GetDatacentersRequestBody struct {
	...
	MarshalOpts *GetDatacentersRequestBodyMarshalOpts `json:"-"`
}

type GetDatacentersRequestBodyMarshalOpts struct {
...
func (m GetDatacentersRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
