...
type NestedAggregateContentLibraryVMTemplate struct {
	...
	MarshalOpts *NestedAggregateContentLibraryVMTemplateMarshalOpts `json:"-"`
}

type NestedAggregateContentLibraryVMTemplateMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateContentLibraryVMTemplate) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateContentLibraryVMTemplate) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NestedAggregateContentLibraryVMTemplate) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateContentLibraryVMTemplate) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
...
func (m *NestedAggregateContentLibraryVMTemplate) UnmarshalBinary(b []byte) error {
	var res NestedAggregateContentLibraryVMTemplate
