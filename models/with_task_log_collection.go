...
type WithTaskLogCollection struct {
	...
	MarshalOpts *WithTaskLogCollectionMarshalOpts `json:"-"`
}

type WithTaskLogCollectionMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskLogCollection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskLogCollection) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskLogCollection) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
