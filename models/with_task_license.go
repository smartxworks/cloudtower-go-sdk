...
type WithTaskLicense struct {
	...
	MarshalOpts *WithTaskLicenseMarshalOpts `json:"-"`
}

type WithTaskLicenseMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskLicense) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskLicense) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskLicense) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
