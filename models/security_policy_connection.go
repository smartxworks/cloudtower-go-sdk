...
type SecurityPolicyConnection struct {
	...
	MarshalOpts *SecurityPolicyConnectionMarshalOpts `json:"-"`
}

type SecurityPolicyConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m SecurityPolicyConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
