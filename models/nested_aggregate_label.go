...
type NestedAggregateLabel struct {
	...
	MarshalOpts *NestedAggregateLabelMarshalOpts `json:"-"`
}

type NestedAggregateLabelMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateLabel) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateLabel) validateCount(formats strfmt.Registry) error {
