...
// Validate validates this get backup store repositories request body
func (m *GetBackupStoreRepositoriesRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetBackupStoreRepositoriesRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetBackupStoreRepositoriesRequestBody) validateWhere(formats strfmt.Registry) error {
...
// ContextValidate validate this get backup store repositories request body based on the context it is used
func (m *GetBackupStoreRepositoriesRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetBackupStoreRepositoriesRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetBackupStoreRepositoriesRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetBackupStoreRepositoriesRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetBackupStoreRepositoriesRequestBody) UnmarshalBinary(b []byte) error {
	var res GetBackupStoreRepositoriesRequestBody
