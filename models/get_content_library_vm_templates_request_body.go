...
type GetContentLibraryVMTemplatesRequestBody struct {
	...
	MarshalOpts *GetContentLibraryVMTemplatesRequestBodyMarshalOpts `json:"-"`
}

type GetContentLibraryVMTemplatesRequestBodyMarshalOpts struct {
...
func (m GetContentLibraryVMTemplatesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
