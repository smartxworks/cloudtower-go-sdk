...
type GetDiskMetricInput struct {
	...
	MarshalOpts *GetDiskMetricInputMarshalOpts `json:"-"`
}

type GetDiskMetricInputMarshalOpts struct {
...
func (m GetDiskMetricInput) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetDiskMetricInput) validateDisks(formats strfmt.Registry) error {
...
func (m *GetDiskMetricInput) validateMetrics(formats strfmt.Registry) error {
...
func (m *GetDiskMetricInput) validateRange(formats strfmt.Registry) error {
...
func (m *GetDiskMetricInput) contextValidateDisks(ctx context.Context, formats strfmt.Registry) error {
