...
type NestedAggregateVMTemplate struct {
	...
	MarshalOpts *NestedAggregateVMTemplateMarshalOpts `json:"-"`
}

type NestedAggregateVMTemplateMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateVMTemplate) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
