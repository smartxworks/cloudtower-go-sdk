...
type VMTemplateConnection struct {
	...
	MarshalOpts *VMTemplateConnectionMarshalOpts `json:"-"`
}

type VMTemplateConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m VMTemplateConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *VMTemplateConnection) validateAggregate(formats strfmt.Registry) error {
...
func (m *VMTemplateConnection) contextValidateAggregate(ctx context.Context, formats strfmt.Registry) error {
