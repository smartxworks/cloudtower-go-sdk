...
type GetGlobalAlertRulesConnectionRequestBody struct {
	...
	MarshalOpts *GetGlobalAlertRulesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetGlobalAlertRulesConnectionRequestBodyMarshalOpts struct {
...
func (m GetGlobalAlertRulesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
