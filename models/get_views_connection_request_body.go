...
type GetViewsConnectionRequestBody struct {
	...
	MarshalOpts *GetViewsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetViewsConnectionRequestBodyMarshalOpts struct {
...
func (m GetViewsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
