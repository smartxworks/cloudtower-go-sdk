...
type GetVdsesConnectionRequestBody struct {
	...
	MarshalOpts *GetVdsesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetVdsesConnectionRequestBodyMarshalOpts struct {
...
func (m GetVdsesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
