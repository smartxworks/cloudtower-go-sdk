...
type WithTaskDeleteDatacenter struct {
	...
	MarshalOpts *WithTaskDeleteDatacenterMarshalOpts `json:"-"`
}

type WithTaskDeleteDatacenterMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteDatacenter) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteDatacenter) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteDatacenter) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskDeleteDatacenter) UnmarshalBinary(b []byte) error {
	var res WithTaskDeleteDatacenter
