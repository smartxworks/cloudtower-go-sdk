...
type GetVMPlacementGroupsConnectionRequestBody struct {
	...
	MarshalOpts *GetVMPlacementGroupsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetVMPlacementGroupsConnectionRequestBodyMarshalOpts struct {
...
func (m GetVMPlacementGroupsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
