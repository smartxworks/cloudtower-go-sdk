...
type NestedAggregateGlobalAlertRule struct {
	...
	MarshalOpts *NestedAggregateGlobalAlertRuleMarshalOpts `json:"-"`
}

type NestedAggregateGlobalAlertRuleMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateGlobalAlertRule) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateGlobalAlertRule) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateGlobalAlertRule) UnmarshalBinary(b []byte) error {
	var res NestedAggregateGlobalAlertRule
