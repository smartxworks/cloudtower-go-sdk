...
type ApplicationConnection struct {
	...
	MarshalOpts *ApplicationConnectionMarshalOpts `json:"-"`
}

type ApplicationConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m ApplicationConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *ApplicationConnection) validateAggregate(formats strfmt.Registry) error {
...
func (m *ApplicationConnection) contextValidateAggregate(ctx context.Context, formats strfmt.Registry) error {
