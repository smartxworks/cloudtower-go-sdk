...
type GetContentLibraryImagesRequestBody struct {
	...
	MarshalOpts *GetContentLibraryImagesRequestBodyMarshalOpts `json:"-"`
}

type GetContentLibraryImagesRequestBodyMarshalOpts struct {
...
func (m GetContentLibraryImagesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
