...
func (m *GetGlobalAlertRulesRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetGlobalAlertRulesRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetGlobalAlertRulesRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetGlobalAlertRulesRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetGlobalAlertRulesRequestBody) UnmarshalBinary(b []byte) error {
	var res GetGlobalAlertRulesRequestBody
