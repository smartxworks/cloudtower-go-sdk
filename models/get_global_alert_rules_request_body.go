...
type GetGlobalAlertRulesRequestBody struct {
	...
	MarshalOpts *GetGlobalAlertRulesRequestBodyMarshalOpts `json:"-"`
}

type GetGlobalAlertRulesRequestBodyMarshalOpts struct {
...
func (m GetGlobalAlertRulesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
