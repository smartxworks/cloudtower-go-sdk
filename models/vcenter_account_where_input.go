...
type VcenterAccountWhereInput struct {
	...
	MarshalOpts *VcenterAccountWhereInputMarshalOpts `json:"-"`
}

type VcenterAccountWhereInputMarshalOpts struct {
...
func (m VcenterAccountWhereInput) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
