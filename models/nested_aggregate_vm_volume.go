...
type NestedAggregateVMVolume struct {
	...
	MarshalOpts *NestedAggregateVMVolumeMarshalOpts `json:"-"`
}

type NestedAggregateVMVolumeMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateVMVolume) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
