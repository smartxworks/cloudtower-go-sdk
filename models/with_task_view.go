...
type WithTaskView struct {
	...
	MarshalOpts *WithTaskViewMarshalOpts `json:"-"`
}

type WithTaskViewMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskView) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskView) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskView) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
