...
type GetEveroutePackagesConnectionRequestBody struct {
	...
	MarshalOpts *GetEveroutePackagesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetEveroutePackagesConnectionRequestBodyMarshalOpts struct {
...
func (m GetEveroutePackagesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
