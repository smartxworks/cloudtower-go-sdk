...
type WithTaskNvmfSubsystem struct {
	...
	MarshalOpts *WithTaskNvmfSubsystemMarshalOpts `json:"-"`
}

type WithTaskNvmfSubsystemMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskNvmfSubsystem) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskNvmfSubsystem) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskNvmfSubsystem) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
