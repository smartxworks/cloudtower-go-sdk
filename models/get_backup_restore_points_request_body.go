...
type GetBackupRestorePointsRequestBody struct {
	...
	MarshalOpts *GetBackupRestorePointsRequestBodyMarshalOpts `json:"-"`
}

type GetBackupRestorePointsRequestBodyMarshalOpts struct {
...
func (m GetBackupRestorePointsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
