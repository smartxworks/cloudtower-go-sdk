...
type GetDisksConnectionRequestBody struct {
	...
	MarshalOpts *GetDisksConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetDisksConnectionRequestBodyMarshalOpts struct {
...
func (m GetDisksConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
