...
type GetNodeTopoesRequestBody struct {
	...
	MarshalOpts *GetNodeTopoesRequestBodyMarshalOpts `json:"-"`
}

type GetNodeTopoesRequestBodyMarshalOpts struct {
...
func (m GetNodeTopoesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
