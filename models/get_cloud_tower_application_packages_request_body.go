...
type GetCloudTowerApplicationPackagesRequestBody struct {
	...
	MarshalOpts *GetCloudTowerApplicationPackagesRequestBodyMarshalOpts `json:"-"`
}

type GetCloudTowerApplicationPackagesRequestBodyMarshalOpts struct {
...
func (m GetCloudTowerApplicationPackagesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetCloudTowerApplicationPackagesRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCloudTowerApplicationPackagesRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetCloudTowerApplicationPackagesRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetCloudTowerApplicationPackagesRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetCloudTowerApplicationPackagesRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetCloudTowerApplicationPackagesRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetCloudTowerApplicationPackagesRequestBody) UnmarshalBinary(b []byte) error {
	var res GetCloudTowerApplicationPackagesRequestBody
