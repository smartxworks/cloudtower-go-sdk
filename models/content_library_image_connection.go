...
type ContentLibraryImageConnection struct {
	...
	MarshalOpts *ContentLibraryImageConnectionMarshalOpts `json:"-"`
}

type ContentLibraryImageConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m ContentLibraryImageConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *ContentLibraryImageConnection) validateAggregate(formats strfmt.Registry) error {
...
func (m *ContentLibraryImageConnection) contextValidateAggregate(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ContentLibraryImageConnection) UnmarshalBinary(b []byte) error {
	var res ContentLibraryImageConnection
