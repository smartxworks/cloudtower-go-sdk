...
type NestedNamespaceGroup struct {
	...
	MarshalOpts *NestedNamespaceGroupMarshalOpts `json:"-"`
}

type NestedNamespaceGroupMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedNamespaceGroup) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedNamespaceGroup) validateID(formats strfmt.Registry) error {
...
func (m *NestedNamespaceGroup) validateName(formats strfmt.Registry) error {
