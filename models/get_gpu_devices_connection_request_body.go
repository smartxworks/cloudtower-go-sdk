...
type GetGpuDevicesConnectionRequestBody struct {
	...
	MarshalOpts *GetGpuDevicesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetGpuDevicesConnectionRequestBodyMarshalOpts struct {
...
func (m GetGpuDevicesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetGpuDevicesConnectionRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetGpuDevicesConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetGpuDevicesConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetGpuDevicesConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetGpuDevicesConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetGpuDevicesConnectionRequestBody) UnmarshalBinary(b []byte) error {
	var res GetGpuDevicesConnectionRequestBody
