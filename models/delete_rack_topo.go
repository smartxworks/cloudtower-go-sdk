...
type DeleteRackTopo struct {
	...
	MarshalOpts *DeleteRackTopoMarshalOpts `json:"-"`
}

type DeleteRackTopoMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteRackTopo) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *DeleteRackTopo) validateID(formats strfmt.Registry) error {
