...
type SnmpTransportWhereInput struct {
	...
	MarshalOpts *SnmpTransportWhereInputMarshalOpts `json:"-"`
}

type SnmpTransportWhereInputMarshalOpts struct {
...
func (m SnmpTransportWhereInput) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
