...
type VMExportParams struct {
	...
	MarshalOpts *VMExportParamsMarshalOpts `json:"-"`
}

type VMExportParamsMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	Where_Explicit_Null_When_Empty bool
}

func (m VMExportParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *VMExportParams) validateData(formats strfmt.Registry) error {
...
func (m *VMExportParams) validateWhere(formats strfmt.Registry) error {
...
func (m *VMExportParams) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VMExportParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
