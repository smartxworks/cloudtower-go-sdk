...
type SecurityPolicyDeleteParams struct {
	...
	MarshalOpts *SecurityPolicyDeleteParamsMarshalOpts `json:"-"`
}

type SecurityPolicyDeleteParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m SecurityPolicyDeleteParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *SecurityPolicyDeleteParams) validateWhere(formats strfmt.Registry) error {
...
func (m *SecurityPolicyDeleteParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SecurityPolicyDeleteParams) UnmarshalBinary(b []byte) error {
	var res SecurityPolicyDeleteParams
