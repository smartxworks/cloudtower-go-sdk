...
type GetOrganizationsConnectionRequestBody struct {
	...
	MarshalOpts *GetOrganizationsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetOrganizationsConnectionRequestBodyMarshalOpts struct {
...
func (m GetOrganizationsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
