...
type NestedAggregateVMPlacementGroup struct {
	...
	MarshalOpts *NestedAggregateVMPlacementGroupMarshalOpts `json:"-"`
}

type NestedAggregateVMPlacementGroupMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateVMPlacementGroup) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateVMPlacementGroup) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NestedAggregateVMPlacementGroup) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateVMPlacementGroup) UnmarshalBinary(b []byte) error {
	var res NestedAggregateVMPlacementGroup
