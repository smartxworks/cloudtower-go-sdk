...
type DeleteVM struct {
	...
	MarshalOpts *DeleteVMMarshalOpts `json:"-"`
}

type DeleteVMMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteVM) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *DeleteVM) validateID(formats strfmt.Registry) error {
