...
const (
	...
	// NetworkTypeCUSTOM captures enum value "CUSTOM"
	NetworkTypeCUSTOM NetworkType = "CUSTOM"

	// NetworkTypeERSPAN captures enum value "ERSPAN"
	NetworkTypeERSPAN NetworkType = "ERSPAN"

	// NetworkTypeINTERNAL captures enum value "INTERNAL"
...
func init() {
	var res []NetworkType
	if err := json.Unmarshal([]byte(`["ACCESS","CUSTOM","ERSPAN","INTERNAL","MANAGEMENT","MIGRATION","STORAGE","STORAGE_ACCESS","VM","VPC_SYS","VPC_VM"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
