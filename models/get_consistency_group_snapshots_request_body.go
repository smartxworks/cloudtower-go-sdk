...
type GetConsistencyGroupSnapshotsRequestBody struct {
	...
	MarshalOpts *GetConsistencyGroupSnapshotsRequestBodyMarshalOpts `json:"-"`
}

type GetConsistencyGroupSnapshotsRequestBodyMarshalOpts struct {
...
func (m GetConsistencyGroupSnapshotsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
