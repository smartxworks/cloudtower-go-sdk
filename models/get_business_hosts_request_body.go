...
// GetBusinessHostsRequestBody get business hosts request body
//
// swagger:model GetBusinessHostsRequestBody
type GetBusinessHostsRequestBody struct {
	...
	MarshalOpts *GetBusinessHostsRequestBodyMarshalOpts `json:"-"`
}

type GetBusinessHostsRequestBodyMarshalOpts struct {
...
func (m GetBusinessHostsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
// Validate validates this get business hosts request body
func (m *GetBusinessHostsRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetBusinessHostsRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetBusinessHostsRequestBody) validateWhere(formats strfmt.Registry) error {
...
// ContextValidate validate this get business hosts request body based on the context it is used
func (m *GetBusinessHostsRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetBusinessHostsRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetBusinessHostsRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetBusinessHostsRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetBusinessHostsRequestBody) UnmarshalBinary(b []byte) error {
	var res GetBusinessHostsRequestBody
