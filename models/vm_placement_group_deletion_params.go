...
type VMPlacementGroupDeletionParams struct {
	...
	MarshalOpts *VMPlacementGroupDeletionParamsMarshalOpts `json:"-"`
}

type VMPlacementGroupDeletionParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m VMPlacementGroupDeletionParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
