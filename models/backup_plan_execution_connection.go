...
type BackupPlanExecutionConnection struct {
	...
	MarshalOpts *BackupPlanExecutionConnectionMarshalOpts `json:"-"`
}

type BackupPlanExecutionConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m BackupPlanExecutionConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
