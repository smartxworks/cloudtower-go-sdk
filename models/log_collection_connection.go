...
type LogCollectionConnection struct {
	...
	MarshalOpts *LogCollectionConnectionMarshalOpts `json:"-"`
}

type LogCollectionConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m LogCollectionConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
