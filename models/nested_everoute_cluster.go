...
type NestedEverouteCluster struct {
	...
	MarshalOpts *NestedEverouteClusterMarshalOpts `json:"-"`
}

type NestedEverouteClusterMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedEverouteCluster) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedEverouteCluster) validateID(formats strfmt.Registry) error {
...
func (m *NestedEverouteCluster) validateName(formats strfmt.Registry) error {
