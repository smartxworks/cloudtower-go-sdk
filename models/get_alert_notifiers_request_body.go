...
type GetAlertNotifiersRequestBody struct {
	...
	MarshalOpts *GetAlertNotifiersRequestBodyMarshalOpts `json:"-"`
}

type GetAlertNotifiersRequestBodyMarshalOpts struct {
...
func (m GetAlertNotifiersRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
