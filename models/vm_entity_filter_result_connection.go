...
type VMEntityFilterResultConnection struct {
	...
	MarshalOpts *VMEntityFilterResultConnectionMarshalOpts `json:"-"`
}

type VMEntityFilterResultConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m VMEntityFilterResultConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *VMEntityFilterResultConnection) validateAggregate(formats strfmt.Registry) error {
...
func (m *VMEntityFilterResultConnection) contextValidateAggregate(ctx context.Context, formats strfmt.Registry) error {
