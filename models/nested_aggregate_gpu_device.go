...
type NestedAggregateGpuDevice struct {
	...
	MarshalOpts *NestedAggregateGpuDeviceMarshalOpts `json:"-"`
}

type NestedAggregateGpuDeviceMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateGpuDevice) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
