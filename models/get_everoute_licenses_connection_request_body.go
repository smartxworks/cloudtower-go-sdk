...
type GetEverouteLicensesConnectionRequestBody struct {
	...
	MarshalOpts *GetEverouteLicensesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetEverouteLicensesConnectionRequestBodyMarshalOpts struct {
...
func (m GetEverouteLicensesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
