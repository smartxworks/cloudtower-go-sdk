...
func (m *GetEverouteLicensesConnectionRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetEverouteLicensesConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetEverouteLicensesConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetEverouteLicensesConnectionRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetEverouteLicensesConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetEverouteLicensesConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetEverouteLicensesConnectionRequestBody) UnmarshalBinary(b []byte) error {
	var res GetEverouteLicensesConnectionRequestBody
