...
type GetVMVolumeSnapshotsConnectionRequestBody struct {
	...
	MarshalOpts *GetVMVolumeSnapshotsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetVMVolumeSnapshotsConnectionRequestBodyMarshalOpts struct {
...
func (m GetVMVolumeSnapshotsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetVMVolumeSnapshotsConnectionRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetVMVolumeSnapshotsConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetVMVolumeSnapshotsConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetVMVolumeSnapshotsConnectionRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetVMVolumeSnapshotsConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetVMVolumeSnapshotsConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetVMVolumeSnapshotsConnectionRequestBody) UnmarshalBinary(b []byte) error {
	var res GetVMVolumeSnapshotsConnectionRequestBody
