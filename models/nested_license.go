...
type NestedLicense struct {
	...
	MarshalOpts *NestedLicenseMarshalOpts `json:"-"`
}

type NestedLicenseMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m NestedLicense) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedLicense) validateID(formats strfmt.Registry) error {
