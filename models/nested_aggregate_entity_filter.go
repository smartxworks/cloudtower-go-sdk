...
type NestedAggregateEntityFilter struct {
	...
	MarshalOpts *NestedAggregateEntityFilterMarshalOpts `json:"-"`
}

type NestedAggregateEntityFilterMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateEntityFilter) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateEntityFilter) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateEntityFilter) UnmarshalBinary(b []byte) error {
	var res NestedAggregateEntityFilter
