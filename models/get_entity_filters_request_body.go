...
type GetEntityFiltersRequestBody struct {
	...
	MarshalOpts *GetEntityFiltersRequestBodyMarshalOpts `json:"-"`
}

type GetEntityFiltersRequestBodyMarshalOpts struct {
...
func (m GetEntityFiltersRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
