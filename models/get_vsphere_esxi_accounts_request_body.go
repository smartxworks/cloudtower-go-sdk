...
type GetVsphereEsxiAccountsRequestBody struct {
	...
	MarshalOpts *GetVsphereEsxiAccountsRequestBodyMarshalOpts `json:"-"`
}

type GetVsphereEsxiAccountsRequestBodyMarshalOpts struct {
...
func (m GetVsphereEsxiAccountsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
