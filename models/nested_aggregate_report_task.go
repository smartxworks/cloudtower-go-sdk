...
type NestedAggregateReportTask struct {
	...
	MarshalOpts *NestedAggregateReportTaskMarshalOpts `json:"-"`
}

type NestedAggregateReportTaskMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateReportTask) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateReportTask) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateReportTask) UnmarshalBinary(b []byte) error {
	var res NestedAggregateReportTask
