...
type WithTaskEntityFilter struct {
	...
	MarshalOpts *WithTaskEntityFilterMarshalOpts `json:"-"`
}

type WithTaskEntityFilterMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskEntityFilter) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskEntityFilter) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskEntityFilter) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
