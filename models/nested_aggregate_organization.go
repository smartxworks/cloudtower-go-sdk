...
type NestedAggregateOrganization struct {
	...
	MarshalOpts *NestedAggregateOrganizationMarshalOpts `json:"-"`
}

type NestedAggregateOrganizationMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateOrganization) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateOrganization) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateOrganization) UnmarshalBinary(b []byte) error {
	var res NestedAggregateOrganization
