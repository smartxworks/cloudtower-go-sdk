...
type DeleteNfsExport struct {
	...
	MarshalOpts *DeleteNfsExportMarshalOpts `json:"-"`
}

type DeleteNfsExportMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteNfsExport) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *DeleteNfsExport) validateID(formats strfmt.Registry) error {
