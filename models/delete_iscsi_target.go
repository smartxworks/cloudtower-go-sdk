...
type DeleteIscsiTarget struct {
	...
	MarshalOpts *DeleteIscsiTargetMarshalOpts `json:"-"`
}

type DeleteIscsiTargetMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteIscsiTarget) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *DeleteIscsiTarget) validateID(formats strfmt.Registry) error {
