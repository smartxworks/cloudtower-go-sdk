...
type NvmfNamespaceSnapshotConnection struct {
	...
	MarshalOpts *NvmfNamespaceSnapshotConnectionMarshalOpts `json:"-"`
}

type NvmfNamespaceSnapshotConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m NvmfNamespaceSnapshotConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
