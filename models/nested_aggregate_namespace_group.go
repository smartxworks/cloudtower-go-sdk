...
type NestedAggregateNamespaceGroup struct {
	...
	MarshalOpts *NestedAggregateNamespaceGroupMarshalOpts `json:"-"`
}

type NestedAggregateNamespaceGroupMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateNamespaceGroup) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateNamespaceGroup) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateNamespaceGroup) UnmarshalBinary(b []byte) error {
	var res NestedAggregateNamespaceGroup
