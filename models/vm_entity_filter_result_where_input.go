...
type VMEntityFilterResultWhereInput struct {
	...
	MarshalOpts *VMEntityFilterResultWhereInputMarshalOpts `json:"-"`
}

type VMEntityFilterResultWhereInputMarshalOpts struct {
...
func (m VMEntityFilterResultWhereInput) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
