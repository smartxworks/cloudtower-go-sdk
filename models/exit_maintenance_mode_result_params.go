...
type ExitMaintenanceModeResultParams struct {
	...
	MarshalOpts *ExitMaintenanceModeResultParamsMarshalOpts `json:"-"`
}

type ExitMaintenanceModeResultParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m ExitMaintenanceModeResultParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *ExitMaintenanceModeResultParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ExitMaintenanceModeResultParams) validateWhere(formats strfmt.Registry) error {
...
func (m *ExitMaintenanceModeResultParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ExitMaintenanceModeResultParams) UnmarshalBinary(b []byte) error {
	var res ExitMaintenanceModeResultParams
