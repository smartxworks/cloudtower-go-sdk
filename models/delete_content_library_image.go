...
type DeleteContentLibraryImage struct {
	...
	MarshalOpts *DeleteContentLibraryImageMarshalOpts `json:"-"`
}

type DeleteContentLibraryImageMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteContentLibraryImage) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
