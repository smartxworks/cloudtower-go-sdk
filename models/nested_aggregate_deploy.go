...
type NestedAggregateDeploy struct {
	...
	MarshalOpts *NestedAggregateDeployMarshalOpts `json:"-"`
}

type NestedAggregateDeployMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateDeploy) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateDeploy) validateCount(formats strfmt.Registry) error {
