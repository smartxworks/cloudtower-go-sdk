...
type GetVMEntityFilterResultsRequestBody struct {
	...
	MarshalOpts *GetVMEntityFilterResultsRequestBodyMarshalOpts `json:"-"`
}

type GetVMEntityFilterResultsRequestBodyMarshalOpts struct {
...
func (m GetVMEntityFilterResultsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetVMEntityFilterResultsRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetVMEntityFilterResultsRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetVMEntityFilterResultsRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetVMEntityFilterResultsRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
