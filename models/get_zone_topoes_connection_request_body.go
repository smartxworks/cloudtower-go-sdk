...
type GetZoneTopoesConnectionRequestBody struct {
	...
	MarshalOpts *GetZoneTopoesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetZoneTopoesConnectionRequestBodyMarshalOpts struct {
...
func (m GetZoneTopoesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
