...
type WithTaskUser struct {
	...
	MarshalOpts *WithTaskUserMarshalOpts `json:"-"`
}

type WithTaskUserMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskUser) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskUser) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskUser) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
