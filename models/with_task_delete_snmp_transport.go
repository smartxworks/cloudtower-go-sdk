...
type WithTaskDeleteSnmpTransport struct {
	...
	MarshalOpts *WithTaskDeleteSnmpTransportMarshalOpts `json:"-"`
}

type WithTaskDeleteSnmpTransportMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteSnmpTransport) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteSnmpTransport) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteSnmpTransport) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskDeleteSnmpTransport) UnmarshalBinary(b []byte) error {
	var res WithTaskDeleteSnmpTransport
