...
type NestedAggregateGraph struct {
	...
	MarshalOpts *NestedAggregateGraphMarshalOpts `json:"-"`
}

type NestedAggregateGraphMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateGraph) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateGraph) validateCount(formats strfmt.Registry) error {
