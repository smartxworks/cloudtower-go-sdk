...
type GetElfDataStoresRequestBody struct {
	...
	MarshalOpts *GetElfDataStoresRequestBodyMarshalOpts `json:"-"`
}

type GetElfDataStoresRequestBodyMarshalOpts struct {
...
func (m GetElfDataStoresRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
