...
func (m *GetElfDataStoresRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetElfDataStoresRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetElfDataStoresRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetElfDataStoresRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetElfDataStoresRequestBody) UnmarshalBinary(b []byte) error {
	var res GetElfDataStoresRequestBody
