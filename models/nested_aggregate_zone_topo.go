...
type NestedAggregateZoneTopo struct {
	...
	MarshalOpts *NestedAggregateZoneTopoMarshalOpts `json:"-"`
}

type NestedAggregateZoneTopoMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateZoneTopo) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateZoneTopo) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateZoneTopo) UnmarshalBinary(b []byte) error {
	var res NestedAggregateZoneTopo
