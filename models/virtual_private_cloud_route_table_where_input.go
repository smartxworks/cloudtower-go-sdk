...
type VirtualPrivateCloudRouteTableWhereInput struct {
	...
	MarshalOpts *VirtualPrivateCloudRouteTableWhereInputMarshalOpts `json:"-"`
}

type VirtualPrivateCloudRouteTableWhereInputMarshalOpts struct {
	...
	RoutesEvery_Explicit_Null_When_Empty bool

	RoutesNone_Explicit_Null_When_Empty bool

	RoutesSome_Explicit_Null_When_Empty bool
...
func (m VirtualPrivateCloudRouteTableWhereInput) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
	...
	// handle nullable field routes_every
	if m.RoutesEvery != nil {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"routes_every\":")
		bytes, err := swag.WriteJSON(m.RoutesEvery)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
		first = false
	} else if m.MarshalOpts != nil && m.MarshalOpts.RoutesEvery_Explicit_Null_When_Empty {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"routes_every\":null")
		first = false
	}

	// handle nullable field routes_none
	if m.RoutesNone != nil {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"routes_none\":")
		bytes, err := swag.WriteJSON(m.RoutesNone)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
		first = false
	} else if m.MarshalOpts != nil && m.MarshalOpts.RoutesNone_Explicit_Null_When_Empty {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"routes_none\":null")
		first = false
	}

	// handle nullable field routes_some
	if m.RoutesSome != nil {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"routes_some\":")
		bytes, err := swag.WriteJSON(m.RoutesSome)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
		first = false
	} else if m.MarshalOpts != nil && m.MarshalOpts.RoutesSome_Explicit_Null_When_Empty {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"routes_some\":null")
		first = false
	}
