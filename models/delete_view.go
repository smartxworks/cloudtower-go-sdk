...
type DeleteView struct {
	...
	MarshalOpts *DeleteViewMarshalOpts `json:"-"`
}

type DeleteViewMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteView) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *DeleteView) validateID(formats strfmt.Registry) error {
