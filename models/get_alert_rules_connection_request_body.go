...
type GetAlertRulesConnectionRequestBody struct {
	...
	MarshalOpts *GetAlertRulesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetAlertRulesConnectionRequestBodyMarshalOpts struct {
...
func (m GetAlertRulesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetAlertRulesConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetAlertRulesConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetAlertRulesConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetAlertRulesConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
