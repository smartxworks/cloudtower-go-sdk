...
type NestedAggregateUploadTask struct {
	...
	MarshalOpts *NestedAggregateUploadTaskMarshalOpts `json:"-"`
}

type NestedAggregateUploadTaskMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateUploadTask) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
