...
type GetWitnessMetricInput struct {
	...
	MarshalOpts *GetWitnessMetricInputMarshalOpts `json:"-"`
}

type GetWitnessMetricInputMarshalOpts struct {
...
func (m GetWitnessMetricInput) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetWitnessMetricInput) validateClusters(formats strfmt.Registry) error {
...
func (m *GetWitnessMetricInput) validateMetrics(formats strfmt.Registry) error {
...
func (m *GetWitnessMetricInput) validateRange(formats strfmt.Registry) error {
...
func (m *GetWitnessMetricInput) contextValidateClusters(ctx context.Context, formats strfmt.Registry) error {
