...
type GetNfsExportsRequestBody struct {
	...
	MarshalOpts *GetNfsExportsRequestBodyMarshalOpts `json:"-"`
}

type GetNfsExportsRequestBodyMarshalOpts struct {
...
func (m GetNfsExportsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
