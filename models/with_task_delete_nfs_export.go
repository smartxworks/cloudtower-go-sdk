...
type WithTaskDeleteNfsExport struct {
	...
	MarshalOpts *WithTaskDeleteNfsExportMarshalOpts `json:"-"`
}

type WithTaskDeleteNfsExportMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteNfsExport) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteNfsExport) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteNfsExport) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskDeleteNfsExport) UnmarshalBinary(b []byte) error {
	var res WithTaskDeleteNfsExport
