...
type NestedAggregateSnmpTransport struct {
	...
	MarshalOpts *NestedAggregateSnmpTransportMarshalOpts `json:"-"`
}

type NestedAggregateSnmpTransportMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateSnmpTransport) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateSnmpTransport) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateSnmpTransport) UnmarshalBinary(b []byte) error {
	var res NestedAggregateSnmpTransport
