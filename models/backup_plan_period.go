...
const (
	...
	// BackupPlanPeriodHOURLY captures enum value "HOURLY"
	BackupPlanPeriodHOURLY BackupPlanPeriod = "HOURLY"

	// BackupPlanPeriodMINUTELY captures enum value "MINUTELY"
	BackupPlanPeriodMINUTELY BackupPlanPeriod = "MINUTELY"
...
func init() {
	...
	if err := json.Unmarshal([]byte(`["DAILY","HOURLY","MINUTELY","MONTHLY","WEEKLY","YEARLY"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
