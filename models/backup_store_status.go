...
const (
	...
	// BackupStoreStatusINITERROR captures enum value "INIT_ERROR"
	BackupStoreStatusINITERROR BackupStoreStatus = "INIT_ERROR"
)
...
func init() {
	...
	if err := json.Unmarshal([]byte(`["CONNECTED","CONNECTING","DISABLED","ERROR","INIT","INIT_ERROR"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
