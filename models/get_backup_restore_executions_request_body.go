...
type GetBackupRestoreExecutionsRequestBody struct {
	...
	MarshalOpts *GetBackupRestoreExecutionsRequestBodyMarshalOpts `json:"-"`
}

type GetBackupRestoreExecutionsRequestBodyMarshalOpts struct {
...
func (m GetBackupRestoreExecutionsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
