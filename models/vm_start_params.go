...
type VMStartParams struct {
	...
	MarshalOpts *VMStartParamsMarshalOpts `json:"-"`
}

type VMStartParamsMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	Where_Explicit_Null_When_Empty bool
}

func (m VMStartParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
type VMStartParamsData struct {
	...
	MarshalOpts *VMStartParamsDataMarshalOpts `json:"-"`
}

type VMStartParamsDataMarshalOpts struct {
	HostID_Explicit_Null_When_Empty bool
}

func (m VMStartParamsData) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
