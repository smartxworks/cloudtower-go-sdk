...
type WithTaskDeleteCluster struct {
	...
	MarshalOpts *WithTaskDeleteClusterMarshalOpts `json:"-"`
}

type WithTaskDeleteClusterMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteCluster) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteCluster) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteCluster) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
