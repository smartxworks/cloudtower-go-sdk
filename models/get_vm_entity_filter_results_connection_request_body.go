...
type GetVMEntityFilterResultsConnectionRequestBody struct {
	...
	MarshalOpts *GetVMEntityFilterResultsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetVMEntityFilterResultsConnectionRequestBodyMarshalOpts struct {
...
func (m GetVMEntityFilterResultsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
