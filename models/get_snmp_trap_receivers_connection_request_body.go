...
type GetSnmpTrapReceiversConnectionRequestBody struct {
	...
	MarshalOpts *GetSnmpTrapReceiversConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetSnmpTrapReceiversConnectionRequestBodyMarshalOpts struct {
...
func (m GetSnmpTrapReceiversConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
