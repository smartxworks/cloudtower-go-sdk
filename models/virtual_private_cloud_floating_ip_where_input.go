...
type VirtualPrivateCloudFloatingIPWhereInput struct {
	...
	MarshalOpts *VirtualPrivateCloudFloatingIPWhereInputMarshalOpts `json:"-"`
}

type VirtualPrivateCloudFloatingIPWhereInputMarshalOpts struct {
...
func (m VirtualPrivateCloudFloatingIPWhereInput) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *VirtualPrivateCloudFloatingIPWhereInput) validateExternalSubnetGroup(formats strfmt.Registry) error {
...
func (m *VirtualPrivateCloudFloatingIPWhereInput) contextValidateExternalSubnetGroup(ctx context.Context, formats strfmt.Registry) error {
