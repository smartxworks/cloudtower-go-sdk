...
type GpuDevice struct {
	...
	MarshalOpts *GpuDeviceMarshalOpts `json:"-"`
}

type GpuDeviceMarshalOpts struct {
...
func (m GpuDevice) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GpuDevice) validateBrand(formats strfmt.Registry) error {
...
func (m *GpuDevice) validateBusLocation(formats strfmt.Registry) error {
...
func (m *GpuDevice) validateDescription(formats strfmt.Registry) error {
...
func (m *GpuDevice) validateDriverInfo(formats strfmt.Registry) error {
...
func (m *GpuDevice) validateEntityAsyncStatus(formats strfmt.Registry) error {
...
func (m *GpuDevice) validateHost(formats strfmt.Registry) error {
...
func (m *GpuDevice) validateID(formats strfmt.Registry) error {
...
func (m *GpuDevice) validateLabels(formats strfmt.Registry) error {
...
func (m *GpuDevice) validateLocalCreatedAt(formats strfmt.Registry) error {
...
func (m *GpuDevice) validateLocalID(formats strfmt.Registry) error {
...
func (m *GpuDevice) validateMdevSupportedTypes(formats strfmt.Registry) error {
...
func (m *GpuDevice) validateModel(formats strfmt.Registry) error {
...
func (m *GpuDevice) validateName(formats strfmt.Registry) error {
...
func (m *GpuDevice) validateStatus(formats strfmt.Registry) error {
...
func (m *GpuDevice) validateUserUsage(formats strfmt.Registry) error {
...
func (m *GpuDevice) validateVms(formats strfmt.Registry) error {
...
func (m *GpuDevice) contextValidateDriverInfo(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GpuDevice) contextValidateEntityAsyncStatus(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GpuDevice) contextValidateHost(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GpuDevice) contextValidateLabels(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GpuDevice) contextValidateMdevSupportedTypes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GpuDevice) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GpuDevice) contextValidateUserUsage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GpuDevice) contextValidateVms(ctx context.Context, formats strfmt.Registry) error {
