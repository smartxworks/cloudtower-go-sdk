...
type DeleteCloudTowerApplicationPackage struct {
	...
	MarshalOpts *DeleteCloudTowerApplicationPackageMarshalOpts `json:"-"`
}

type DeleteCloudTowerApplicationPackageMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteCloudTowerApplicationPackage) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
