...
type NestedAggregateIscsiTarget struct {
	...
	MarshalOpts *NestedAggregateIscsiTargetMarshalOpts `json:"-"`
}

type NestedAggregateIscsiTargetMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateIscsiTarget) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateIscsiTarget) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateIscsiTarget) UnmarshalBinary(b []byte) error {
	var res NestedAggregateIscsiTarget
