...
type WithTaskReportTemplate struct {
	...
	MarshalOpts *WithTaskReportTemplateMarshalOpts `json:"-"`
}

type WithTaskReportTemplateMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskReportTemplate) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskReportTemplate) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskReportTemplate) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskReportTemplate) UnmarshalBinary(b []byte) error {
	var res WithTaskReportTemplate
