...
type DeleteConsistencyGroupSnapshot struct {
	...
	MarshalOpts *DeleteConsistencyGroupSnapshotMarshalOpts `json:"-"`
}

type DeleteConsistencyGroupSnapshotMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteConsistencyGroupSnapshot) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
