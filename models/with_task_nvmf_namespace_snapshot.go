...
type WithTaskNvmfNamespaceSnapshot struct {
	...
	MarshalOpts *WithTaskNvmfNamespaceSnapshotMarshalOpts `json:"-"`
}

type WithTaskNvmfNamespaceSnapshotMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskNvmfNamespaceSnapshot) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskNvmfNamespaceSnapshot) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskNvmfNamespaceSnapshot) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskNvmfNamespaceSnapshot) UnmarshalBinary(b []byte) error {
	var res WithTaskNvmfNamespaceSnapshot
