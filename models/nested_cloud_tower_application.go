...
type NestedCloudTowerApplication struct {
	...
	MarshalOpts *NestedCloudTowerApplicationMarshalOpts `json:"-"`
}

type NestedCloudTowerApplicationMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedCloudTowerApplication) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedCloudTowerApplication) validateID(formats strfmt.Registry) error {
...
func (m *NestedCloudTowerApplication) validateName(formats strfmt.Registry) error {
...
func (m *NestedCloudTowerApplication) UnmarshalBinary(b []byte) error {
	var res NestedCloudTowerApplication
