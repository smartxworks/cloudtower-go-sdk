...
type CloudTowerApplicationConnection struct {
	...
	MarshalOpts *CloudTowerApplicationConnectionMarshalOpts `json:"-"`
}

type CloudTowerApplicationConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m CloudTowerApplicationConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *CloudTowerApplicationConnection) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CloudTowerApplicationConnection) validateAggregate(formats strfmt.Registry) error {
...
func (m *CloudTowerApplicationConnection) contextValidateAggregate(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CloudTowerApplicationConnection) UnmarshalBinary(b []byte) error {
	var res CloudTowerApplicationConnection
