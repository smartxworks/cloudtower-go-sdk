...
type NestedAggregateNfsInode struct {
	...
	MarshalOpts *NestedAggregateNfsInodeMarshalOpts `json:"-"`
}

type NestedAggregateNfsInodeMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateNfsInode) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateNfsInode) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateNfsInode) UnmarshalBinary(b []byte) error {
	var res NestedAggregateNfsInode
