...
type GetGlobalSettingsesRequestBody struct {
	...
	MarshalOpts *GetGlobalSettingsesRequestBodyMarshalOpts `json:"-"`
}

type GetGlobalSettingsesRequestBodyMarshalOpts struct {
...
func (m GetGlobalSettingsesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
