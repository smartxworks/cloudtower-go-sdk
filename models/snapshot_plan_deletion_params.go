...
type SnapshotPlanDeletionParams struct {
	...
	MarshalOpts *SnapshotPlanDeletionParamsMarshalOpts `json:"-"`
}

type SnapshotPlanDeletionParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m SnapshotPlanDeletionParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *SnapshotPlanDeletionParams) validateWhere(formats strfmt.Registry) error {
...
func (m *SnapshotPlanDeletionParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SnapshotPlanDeletionParams) UnmarshalBinary(b []byte) error {
	var res SnapshotPlanDeletionParams
