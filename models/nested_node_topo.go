...
type NestedNodeTopo struct {
	...
	MarshalOpts *NestedNodeTopoMarshalOpts `json:"-"`
}

type NestedNodeTopoMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedNodeTopo) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedNodeTopo) validateID(formats strfmt.Registry) error {
...
func (m *NestedNodeTopo) validateName(formats strfmt.Registry) error {
