...
type GetVcenterAccountsConnectionRequestBody struct {
	...
	MarshalOpts *GetVcenterAccountsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetVcenterAccountsConnectionRequestBodyMarshalOpts struct {
...
func (m GetVcenterAccountsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
