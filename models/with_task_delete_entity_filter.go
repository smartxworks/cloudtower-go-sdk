...
type WithTaskDeleteEntityFilter struct {
	...
	MarshalOpts *WithTaskDeleteEntityFilterMarshalOpts `json:"-"`
}

type WithTaskDeleteEntityFilterMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteEntityFilter) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteEntityFilter) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteEntityFilter) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskDeleteEntityFilter) UnmarshalBinary(b []byte) error {
	var res WithTaskDeleteEntityFilter
