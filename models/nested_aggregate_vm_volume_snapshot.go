...
type NestedAggregateVMVolumeSnapshot struct {
	...
	MarshalOpts *NestedAggregateVMVolumeSnapshotMarshalOpts `json:"-"`
}

type NestedAggregateVMVolumeSnapshotMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateVMVolumeSnapshot) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateVMVolumeSnapshot) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NestedAggregateVMVolumeSnapshot) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateVMVolumeSnapshot) UnmarshalBinary(b []byte) error {
	var res NestedAggregateVMVolumeSnapshot
