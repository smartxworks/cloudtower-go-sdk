...
func (m *GetMigrateTransmittersRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetMigrateTransmittersRequestBody) validateWhere(formats strfmt.Registry) error {
...
// ContextValidate validate this get migrate transmitters request body based on the context it is used
...
func (m *GetMigrateTransmittersRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetMigrateTransmittersRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
