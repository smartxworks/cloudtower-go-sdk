...
type WithTaskDeleteVlan struct {
	...
	MarshalOpts *WithTaskDeleteVlanMarshalOpts `json:"-"`
}

type WithTaskDeleteVlanMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteVlan) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteVlan) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteVlan) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
