...
type GetNvmfSubsystemsRequestBody struct {
	...
	MarshalOpts *GetNvmfSubsystemsRequestBodyMarshalOpts `json:"-"`
}

type GetNvmfSubsystemsRequestBodyMarshalOpts struct {
...
func (m GetNvmfSubsystemsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
