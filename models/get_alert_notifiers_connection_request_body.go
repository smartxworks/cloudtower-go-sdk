...
type GetAlertNotifiersConnectionRequestBody struct {
	...
	MarshalOpts *GetAlertNotifiersConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetAlertNotifiersConnectionRequestBodyMarshalOpts struct {
...
func (m GetAlertNotifiersConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
