...
type ClusterUpgradeHistoryConnection struct {
	...
	MarshalOpts *ClusterUpgradeHistoryConnectionMarshalOpts `json:"-"`
}

type ClusterUpgradeHistoryConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m ClusterUpgradeHistoryConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
