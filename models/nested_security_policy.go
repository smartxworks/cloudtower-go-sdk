...
type NestedSecurityPolicy struct {
	...
	MarshalOpts *NestedSecurityPolicyMarshalOpts `json:"-"`
}

type NestedSecurityPolicyMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedSecurityPolicy) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedSecurityPolicy) validateID(formats strfmt.Registry) error {
...
func (m *NestedSecurityPolicy) validateName(formats strfmt.Registry) error {
