...
type GetVMTemplatesConnectionRequestBody struct {
	...
	MarshalOpts *GetVMTemplatesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetVMTemplatesConnectionRequestBodyMarshalOpts struct {
...
func (m GetVMTemplatesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
