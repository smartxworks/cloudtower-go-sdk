...
type AlertNotifierConnection struct {
	...
	MarshalOpts *AlertNotifierConnectionMarshalOpts `json:"-"`
}

type AlertNotifierConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m AlertNotifierConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
