...
type NvmfNamespaceConnection struct {
	...
	MarshalOpts *NvmfNamespaceConnectionMarshalOpts `json:"-"`
}

type NvmfNamespaceConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m NvmfNamespaceConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NvmfNamespaceConnection) validateAggregate(formats strfmt.Registry) error {
...
func (m *NvmfNamespaceConnection) contextValidateAggregate(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NvmfNamespaceConnection) UnmarshalBinary(b []byte) error {
	var res NvmfNamespaceConnection
