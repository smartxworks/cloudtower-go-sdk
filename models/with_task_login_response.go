...
type WithTaskLoginResponse struct {
	...
	MarshalOpts *WithTaskLoginResponseMarshalOpts `json:"-"`
}

type WithTaskLoginResponseMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskLoginResponse) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskLoginResponse) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskLoginResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
