...
type NestedAggregateEverouteCluster struct {
	...
	MarshalOpts *NestedAggregateEverouteClusterMarshalOpts `json:"-"`
}

type NestedAggregateEverouteClusterMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateEverouteCluster) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateEverouteCluster) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateEverouteCluster) UnmarshalBinary(b []byte) error {
	var res NestedAggregateEverouteCluster
