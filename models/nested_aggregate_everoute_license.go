...
type NestedAggregateEverouteLicense struct {
	...
	MarshalOpts *NestedAggregateEverouteLicenseMarshalOpts `json:"-"`
}

type NestedAggregateEverouteLicenseMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateEverouteLicense) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateEverouteLicense) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateEverouteLicense) UnmarshalBinary(b []byte) error {
	var res NestedAggregateEverouteLicense
