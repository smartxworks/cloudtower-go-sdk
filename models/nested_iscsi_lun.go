...
type NestedIscsiLun struct {
	...
	MarshalOpts *NestedIscsiLunMarshalOpts `json:"-"`
}

type NestedIscsiLunMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedIscsiLun) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedIscsiLun) validateID(formats strfmt.Registry) error {
...
func (m *NestedIscsiLun) validateName(formats strfmt.Registry) error {
