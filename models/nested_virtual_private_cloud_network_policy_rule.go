...
// NestedVirtualPrivateCloudNetworkPolicyRule nested virtual private cloud network policy rule
//
// swagger:model NestedVirtualPrivateCloudNetworkPolicyRule
type NestedVirtualPrivateCloudNetworkPolicyRule struct {
	...
	// ports
	Ports []*NestedVirtualPrivateCloudNetworkPolicyRulePort `json:"ports,omitempty"`
	...
	MarshalOpts *NestedVirtualPrivateCloudNetworkPolicyRuleMarshalOpts `json:"-"`
}

type NestedVirtualPrivateCloudNetworkPolicyRuleMarshalOpts struct {
...
func (m NestedVirtualPrivateCloudNetworkPolicyRule) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
// Validate validates this nested virtual private cloud network policy rule
func (m *NestedVirtualPrivateCloudNetworkPolicyRule) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NestedVirtualPrivateCloudNetworkPolicyRule) validatePorts(formats strfmt.Registry) error {
...
func (m *NestedVirtualPrivateCloudNetworkPolicyRule) validateSecurityGroup(formats strfmt.Registry) error {
...
func (m *NestedVirtualPrivateCloudNetworkPolicyRule) validateSelector(formats strfmt.Registry) error {
...
func (m *NestedVirtualPrivateCloudNetworkPolicyRule) validateType(formats strfmt.Registry) error {
...
// ContextValidate validate this nested virtual private cloud network policy rule based on the context it is used
func (m *NestedVirtualPrivateCloudNetworkPolicyRule) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NestedVirtualPrivateCloudNetworkPolicyRule) contextValidatePorts(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedVirtualPrivateCloudNetworkPolicyRule) contextValidateSecurityGroup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedVirtualPrivateCloudNetworkPolicyRule) contextValidateSelector(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedVirtualPrivateCloudNetworkPolicyRule) contextValidateType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedVirtualPrivateCloudNetworkPolicyRule) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NestedVirtualPrivateCloudNetworkPolicyRule) UnmarshalBinary(b []byte) error {
	var res NestedVirtualPrivateCloudNetworkPolicyRule
