...
type IscsiConnectionConnection struct {
	...
	MarshalOpts *IscsiConnectionConnectionMarshalOpts `json:"-"`
}

type IscsiConnectionConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m IscsiConnectionConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
