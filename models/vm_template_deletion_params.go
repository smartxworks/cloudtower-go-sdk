...
type VMTemplateDeletionParams struct {
	...
	MarshalOpts *VMTemplateDeletionParamsMarshalOpts `json:"-"`
}

type VMTemplateDeletionParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m VMTemplateDeletionParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
