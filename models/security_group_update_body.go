...
type SecurityGroupUpdateBody struct {
	...
	MarshalOpts *SecurityGroupUpdateBodyMarshalOpts `json:"-"`
}

type SecurityGroupUpdateBodyMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	Where_Explicit_Null_When_Empty bool
}

func (m SecurityGroupUpdateBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *SecurityGroupUpdateBody) validateData(formats strfmt.Registry) error {
...
func (m *SecurityGroupUpdateBody) validateWhere(formats strfmt.Registry) error {
...
func (m *SecurityGroupUpdateBody) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SecurityGroupUpdateBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SecurityGroupUpdateBody) UnmarshalBinary(b []byte) error {
	var res SecurityGroupUpdateBody
