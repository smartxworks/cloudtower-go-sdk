...
type DeleteLogCollection struct {
	...
	MarshalOpts *DeleteLogCollectionMarshalOpts `json:"-"`
}

type DeleteLogCollectionMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteLogCollection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *DeleteLogCollection) validateID(formats strfmt.Registry) error {
