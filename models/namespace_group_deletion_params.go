...
type NamespaceGroupDeletionParams struct {
	...
	MarshalOpts *NamespaceGroupDeletionParamsMarshalOpts `json:"-"`
}

type NamespaceGroupDeletionParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m NamespaceGroupDeletionParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
