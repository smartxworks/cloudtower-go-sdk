...
type EnterMaintenanceModeCheckParams struct {
	...
	MarshalOpts *EnterMaintenanceModeCheckParamsMarshalOpts `json:"-"`
}

type EnterMaintenanceModeCheckParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m EnterMaintenanceModeCheckParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *EnterMaintenanceModeCheckParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *EnterMaintenanceModeCheckParams) validateWhere(formats strfmt.Registry) error {
...
func (m *EnterMaintenanceModeCheckParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EnterMaintenanceModeCheckParams) UnmarshalBinary(b []byte) error {
	var res EnterMaintenanceModeCheckParams
