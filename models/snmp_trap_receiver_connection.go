...
type SnmpTrapReceiverConnection struct {
	...
	MarshalOpts *SnmpTrapReceiverConnectionMarshalOpts `json:"-"`
}

type SnmpTrapReceiverConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m SnmpTrapReceiverConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
