...
func (m *GetLicensesConnectionRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetLicensesConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetLicensesConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetLicensesConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetLicensesConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetLicensesConnectionRequestBody) UnmarshalBinary(b []byte) error {
	var res GetLicensesConnectionRequestBody
