...
type GetLicensesConnectionRequestBody struct {
	...
	MarshalOpts *GetLicensesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetLicensesConnectionRequestBodyMarshalOpts struct {
...
func (m GetLicensesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
