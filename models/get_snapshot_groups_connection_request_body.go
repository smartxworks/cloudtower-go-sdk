...
type GetSnapshotGroupsConnectionRequestBody struct {
	...
	MarshalOpts *GetSnapshotGroupsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetSnapshotGroupsConnectionRequestBodyMarshalOpts struct {
...
func (m GetSnapshotGroupsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
