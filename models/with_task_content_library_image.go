...
type WithTaskContentLibraryImage struct {
	...
	MarshalOpts *WithTaskContentLibraryImageMarshalOpts `json:"-"`
}

type WithTaskContentLibraryImageMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskContentLibraryImage) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
