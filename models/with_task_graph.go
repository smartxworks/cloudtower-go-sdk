...
type WithTaskGraph struct {
	...
	MarshalOpts *WithTaskGraphMarshalOpts `json:"-"`
}

type WithTaskGraphMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskGraph) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskGraph) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskGraph) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
