...
type WithTaskDeleteVMSnapshot struct {
	...
	MarshalOpts *WithTaskDeleteVMSnapshotMarshalOpts `json:"-"`
}

type WithTaskDeleteVMSnapshotMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteVMSnapshot) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
