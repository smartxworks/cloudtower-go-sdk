...
type SnapshotGroupKeepParams struct {
	...
	MarshalOpts *SnapshotGroupKeepParamsMarshalOpts `json:"-"`
}

type SnapshotGroupKeepParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m SnapshotGroupKeepParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *SnapshotGroupKeepParams) validateWhere(formats strfmt.Registry) error {
...
func (m *SnapshotGroupKeepParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SnapshotGroupKeepParams) UnmarshalBinary(b []byte) error {
	var res SnapshotGroupKeepParams
