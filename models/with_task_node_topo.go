...
type WithTaskNodeTopo struct {
	...
	MarshalOpts *WithTaskNodeTopoMarshalOpts `json:"-"`
}

type WithTaskNodeTopoMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskNodeTopo) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskNodeTopo) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskNodeTopo) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
