...
type RackTopoDeletionParams struct {
	...
	MarshalOpts *RackTopoDeletionParamsMarshalOpts `json:"-"`
}

type RackTopoDeletionParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m RackTopoDeletionParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *RackTopoDeletionParams) validateWhere(formats strfmt.Registry) error {
...
func (m *RackTopoDeletionParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RackTopoDeletionParams) UnmarshalBinary(b []byte) error {
	var res RackTopoDeletionParams
