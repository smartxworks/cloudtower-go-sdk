...
type NestedAggregateConsistencyGroupSnapshot struct {
	...
	MarshalOpts *NestedAggregateConsistencyGroupSnapshotMarshalOpts `json:"-"`
}

type NestedAggregateConsistencyGroupSnapshotMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateConsistencyGroupSnapshot) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateConsistencyGroupSnapshot) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NestedAggregateConsistencyGroupSnapshot) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateConsistencyGroupSnapshot) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
...
func (m *NestedAggregateConsistencyGroupSnapshot) UnmarshalBinary(b []byte) error {
	var res NestedAggregateConsistencyGroupSnapshot
