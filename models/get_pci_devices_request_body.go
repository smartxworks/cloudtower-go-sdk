...
// GetPciDevicesRequestBody get pci devices request body
//
// swagger:model GetPciDevicesRequestBody
type GetPciDevicesRequestBody struct {
	...
	// order by
	OrderBy *PciDeviceOrderByInput `json:"orderBy,omitempty"`

	// skip
	Skip *int32 `json:"skip,omitempty"`

	// where
	Where *PciDeviceWhereInput `json:"where,omitempty"`

	MarshalOpts *GetPciDevicesRequestBodyMarshalOpts `json:"-"`
}

type GetPciDevicesRequestBodyMarshalOpts struct {
...
func (m GetPciDevicesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
// Validate validates this get pci devices request body
func (m *GetPciDevicesRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetPciDevicesRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetPciDevicesRequestBody) validateWhere(formats strfmt.Registry) error {
...
// ContextValidate validate this get pci devices request body based on the context it is used
func (m *GetPciDevicesRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetPciDevicesRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetPciDevicesRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetPciDevicesRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetPciDevicesRequestBody) UnmarshalBinary(b []byte) error {
	var res GetPciDevicesRequestBody
