...
type NestedNvmfNamespace struct {
	...
	MarshalOpts *NestedNvmfNamespaceMarshalOpts `json:"-"`
}

type NestedNvmfNamespaceMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedNvmfNamespace) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedNvmfNamespace) validateID(formats strfmt.Registry) error {
...
func (m *NestedNvmfNamespace) validateName(formats strfmt.Registry) error {
