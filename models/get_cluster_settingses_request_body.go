...
type GetClusterSettingsesRequestBody struct {
	...
	MarshalOpts *GetClusterSettingsesRequestBodyMarshalOpts `json:"-"`
}

type GetClusterSettingsesRequestBodyMarshalOpts struct {
...
func (m GetClusterSettingsesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetClusterSettingsesRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetClusterSettingsesRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetClusterSettingsesRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetClusterSettingsesRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetClusterSettingsesRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetClusterSettingsesRequestBody) UnmarshalBinary(b []byte) error {
	var res GetClusterSettingsesRequestBody
