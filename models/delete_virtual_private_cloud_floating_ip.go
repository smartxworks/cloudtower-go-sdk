...
type DeleteVirtualPrivateCloudFloatingIP struct {
	...
	MarshalOpts *DeleteVirtualPrivateCloudFloatingIPMarshalOpts `json:"-"`
}

type DeleteVirtualPrivateCloudFloatingIPMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteVirtualPrivateCloudFloatingIP) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
