...
type GetBrickTopoesRequestBody struct {
	...
	MarshalOpts *GetBrickTopoesRequestBodyMarshalOpts `json:"-"`
}

type GetBrickTopoesRequestBodyMarshalOpts struct {
...
func (m GetBrickTopoesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
