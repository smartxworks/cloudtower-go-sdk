...
type GetHostServiceMetricInput struct {
	...
	MarshalOpts *GetHostServiceMetricInputMarshalOpts `json:"-"`
}

type GetHostServiceMetricInputMarshalOpts struct {
...
func (m GetHostServiceMetricInput) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetHostServiceMetricInput) validateHosts(formats strfmt.Registry) error {
...
func (m *GetHostServiceMetricInput) validateMetrics(formats strfmt.Registry) error {
...
func (m *GetHostServiceMetricInput) validateRange(formats strfmt.Registry) error {
...
func (m *GetHostServiceMetricInput) validateServices(formats strfmt.Registry) error {
...
func (m *GetHostServiceMetricInput) contextValidateHosts(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetHostServiceMetricInput) UnmarshalBinary(b []byte) error {
	var res GetHostServiceMetricInput
