...
type NestedNfsExport struct {
	...
	MarshalOpts *NestedNfsExportMarshalOpts `json:"-"`
}

type NestedNfsExportMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedNfsExport) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedNfsExport) validateID(formats strfmt.Registry) error {
...
func (m *NestedNfsExport) validateName(formats strfmt.Registry) error {
