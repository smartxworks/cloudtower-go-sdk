...
type GetNfsInodesRequestBody struct {
	...
	MarshalOpts *GetNfsInodesRequestBodyMarshalOpts `json:"-"`
}

type GetNfsInodesRequestBodyMarshalOpts struct {
...
func (m GetNfsInodesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
