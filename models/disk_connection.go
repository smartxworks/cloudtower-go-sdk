...
type DiskConnection struct {
	...
	MarshalOpts *DiskConnectionMarshalOpts `json:"-"`
}

type DiskConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m DiskConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *DiskConnection) validateAggregate(formats strfmt.Registry) error {
...
func (m *DiskConnection) contextValidateAggregate(ctx context.Context, formats strfmt.Registry) error {
