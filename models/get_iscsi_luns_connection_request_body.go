...
type GetIscsiLunsConnectionRequestBody struct {
	...
	MarshalOpts *GetIscsiLunsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetIscsiLunsConnectionRequestBodyMarshalOpts struct {
...
func (m GetIscsiLunsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
