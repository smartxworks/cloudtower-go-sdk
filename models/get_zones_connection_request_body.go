...
type GetZonesConnectionRequestBody struct {
	...
	MarshalOpts *GetZonesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetZonesConnectionRequestBodyMarshalOpts struct {
...
func (m GetZonesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetZonesConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetZonesConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetZonesConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetZonesConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
