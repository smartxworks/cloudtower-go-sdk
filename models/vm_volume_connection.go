...
type VMVolumeConnection struct {
	...
	MarshalOpts *VMVolumeConnectionMarshalOpts `json:"-"`
}

type VMVolumeConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m VMVolumeConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *VMVolumeConnection) validateAggregate(formats strfmt.Registry) error {
...
func (m *VMVolumeConnection) contextValidateAggregate(ctx context.Context, formats strfmt.Registry) error {
