...
type NestedDisk struct {
	...
	MarshalOpts *NestedDiskMarshalOpts `json:"-"`
}

type NestedDiskMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedDisk) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedDisk) validateID(formats strfmt.Registry) error {
...
func (m *NestedDisk) validateName(formats strfmt.Registry) error {
