...
type UninstallCloudTowerApplicationParams struct {
	...
	MarshalOpts *UninstallCloudTowerApplicationParamsMarshalOpts `json:"-"`
}

type UninstallCloudTowerApplicationParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m UninstallCloudTowerApplicationParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *UninstallCloudTowerApplicationParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UninstallCloudTowerApplicationParams) validateWhere(formats strfmt.Registry) error {
...
func (m *UninstallCloudTowerApplicationParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UninstallCloudTowerApplicationParams) UnmarshalBinary(b []byte) error {
	var res UninstallCloudTowerApplicationParams
