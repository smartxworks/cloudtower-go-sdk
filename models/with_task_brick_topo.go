...
type WithTaskBrickTopo struct {
	...
	MarshalOpts *WithTaskBrickTopoMarshalOpts `json:"-"`
}

type WithTaskBrickTopoMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskBrickTopo) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskBrickTopo) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskBrickTopo) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
