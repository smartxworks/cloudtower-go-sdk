...
type GetV2EverouteLicensesConnectionRequestBody struct {
	...
	MarshalOpts *GetV2EverouteLicensesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetV2EverouteLicensesConnectionRequestBodyMarshalOpts struct {
...
func (m GetV2EverouteLicensesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
