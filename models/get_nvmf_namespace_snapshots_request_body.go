...
type GetNvmfNamespaceSnapshotsRequestBody struct {
	...
	MarshalOpts *GetNvmfNamespaceSnapshotsRequestBodyMarshalOpts `json:"-"`
}

type GetNvmfNamespaceSnapshotsRequestBodyMarshalOpts struct {
...
func (m GetNvmfNamespaceSnapshotsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
