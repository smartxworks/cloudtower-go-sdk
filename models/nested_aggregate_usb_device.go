...
type NestedAggregateUsbDevice struct {
	...
	MarshalOpts *NestedAggregateUsbDeviceMarshalOpts `json:"-"`
}

type NestedAggregateUsbDeviceMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateUsbDevice) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateUsbDevice) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateUsbDevice) UnmarshalBinary(b []byte) error {
	var res NestedAggregateUsbDevice
