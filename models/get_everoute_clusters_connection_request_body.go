...
type GetEverouteClustersConnectionRequestBody struct {
	...
	MarshalOpts *GetEverouteClustersConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetEverouteClustersConnectionRequestBodyMarshalOpts struct {
...
func (m GetEverouteClustersConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
