...
type NestedAggregateContentLibraryImage struct {
	...
	MarshalOpts *NestedAggregateContentLibraryImageMarshalOpts `json:"-"`
}

type NestedAggregateContentLibraryImageMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateContentLibraryImage) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateContentLibraryImage) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NestedAggregateContentLibraryImage) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateContentLibraryImage) UnmarshalBinary(b []byte) error {
	var res NestedAggregateContentLibraryImage
