...
type IsolationPolicyConnection struct {
	...
	MarshalOpts *IsolationPolicyConnectionMarshalOpts `json:"-"`
}

type IsolationPolicyConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m IsolationPolicyConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *IsolationPolicyConnection) validateAggregate(formats strfmt.Registry) error {
...
func (m *IsolationPolicyConnection) contextValidateAggregate(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IsolationPolicyConnection) UnmarshalBinary(b []byte) error {
	var res IsolationPolicyConnection
