...
type ZoneTopoConnection struct {
	...
	MarshalOpts *ZoneTopoConnectionMarshalOpts `json:"-"`
}

type ZoneTopoConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m ZoneTopoConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *ZoneTopoConnection) validateAggregate(formats strfmt.Registry) error {
...
func (m *ZoneTopoConnection) contextValidateAggregate(ctx context.Context, formats strfmt.Registry) error {
