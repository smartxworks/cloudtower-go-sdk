...
type WithTaskDeleteVM struct {
	...
	MarshalOpts *WithTaskDeleteVMMarshalOpts `json:"-"`
}

type WithTaskDeleteVMMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteVM) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteVM) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteVM) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
