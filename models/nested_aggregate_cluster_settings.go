...
type NestedAggregateClusterSettings struct {
	...
	MarshalOpts *NestedAggregateClusterSettingsMarshalOpts `json:"-"`
}

type NestedAggregateClusterSettingsMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateClusterSettings) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
