...
type GetSvtImagesRequestBody struct {
	...
	MarshalOpts *GetSvtImagesRequestBodyMarshalOpts `json:"-"`
}

type GetSvtImagesRequestBodyMarshalOpts struct {
...
func (m GetSvtImagesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
