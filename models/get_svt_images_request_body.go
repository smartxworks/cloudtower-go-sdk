...
func (m *GetSvtImagesRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetSvtImagesRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetSvtImagesRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetSvtImagesRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
