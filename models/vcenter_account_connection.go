...
type VcenterAccountConnection struct {
	...
	MarshalOpts *VcenterAccountConnectionMarshalOpts `json:"-"`
}

type VcenterAccountConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m VcenterAccountConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
