...
type NestedContentLibraryVMTemplate struct {
	...
	MarshalOpts *NestedContentLibraryVMTemplateMarshalOpts `json:"-"`
}

type NestedContentLibraryVMTemplateMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedContentLibraryVMTemplate) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
