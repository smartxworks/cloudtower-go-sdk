...
type WithTaskDeleteBrickTopo struct {
	...
	MarshalOpts *WithTaskDeleteBrickTopoMarshalOpts `json:"-"`
}

type WithTaskDeleteBrickTopoMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteBrickTopo) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
