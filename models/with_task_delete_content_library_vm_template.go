...
type WithTaskDeleteContentLibraryVMTemplate struct {
	...
	MarshalOpts *WithTaskDeleteContentLibraryVMTemplateMarshalOpts `json:"-"`
}

type WithTaskDeleteContentLibraryVMTemplateMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteContentLibraryVMTemplate) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
