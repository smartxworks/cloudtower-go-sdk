...
func init() {
	...
	if err := json.Unmarshal([]byte(`["ERROR","INSTALL_FAILED","INSTALLING","RUNNING","SCALE_FAILED","SCALING","TERMINATE_FAILED","TERMINATING","UPGRADE_FAILED","UPGRADING"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
