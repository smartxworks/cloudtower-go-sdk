...
type WithTaskVMSnapshot struct {
	...
	MarshalOpts *WithTaskVMSnapshotMarshalOpts `json:"-"`
}

type WithTaskVMSnapshotMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskVMSnapshot) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskVMSnapshot) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskVMSnapshot) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
