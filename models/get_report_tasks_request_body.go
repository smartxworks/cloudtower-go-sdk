...
type GetReportTasksRequestBody struct {
	...
	MarshalOpts *GetReportTasksRequestBodyMarshalOpts `json:"-"`
}

type GetReportTasksRequestBodyMarshalOpts struct {
...
func (m GetReportTasksRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetReportTasksRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetReportTasksRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetReportTasksRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetReportTasksRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
