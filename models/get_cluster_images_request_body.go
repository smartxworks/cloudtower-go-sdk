...
type GetClusterImagesRequestBody struct {
	...
	MarshalOpts *GetClusterImagesRequestBodyMarshalOpts `json:"-"`
}

type GetClusterImagesRequestBodyMarshalOpts struct {
...
func (m GetClusterImagesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
