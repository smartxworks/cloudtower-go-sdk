...
type VdsDeletionParams struct {
	...
	MarshalOpts *VdsDeletionParamsMarshalOpts `json:"-"`
}

type VdsDeletionParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m VdsDeletionParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *VdsDeletionParams) validateWhere(formats strfmt.Registry) error {
...
func (m *VdsDeletionParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
