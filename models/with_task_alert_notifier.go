...
type WithTaskAlertNotifier struct {
	...
	MarshalOpts *WithTaskAlertNotifierMarshalOpts `json:"-"`
}

type WithTaskAlertNotifierMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskAlertNotifier) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskAlertNotifier) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskAlertNotifier) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
