...
type SnapshotGroupConnection struct {
	...
	MarshalOpts *SnapshotGroupConnectionMarshalOpts `json:"-"`
}

type SnapshotGroupConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m SnapshotGroupConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
