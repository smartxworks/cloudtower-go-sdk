...
type SecurityGroupConnection struct {
	...
	MarshalOpts *SecurityGroupConnectionMarshalOpts `json:"-"`
}

type SecurityGroupConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m SecurityGroupConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
