...
type GetOrganizationsRequestBody struct {
	...
	MarshalOpts *GetOrganizationsRequestBodyMarshalOpts `json:"-"`
}

type GetOrganizationsRequestBodyMarshalOpts struct {
...
func (m GetOrganizationsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
