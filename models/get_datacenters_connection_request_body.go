...
type GetDatacentersConnectionRequestBody struct {
	...
	MarshalOpts *GetDatacentersConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetDatacentersConnectionRequestBodyMarshalOpts struct {
...
func (m GetDatacentersConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
