...
// GetSMTPServersRequestBody get Smtp servers request body
//
// swagger:model GetSmtpServersRequestBody
type GetSMTPServersRequestBody struct {
	...
	MarshalOpts *GetSMTPServersRequestBodyMarshalOpts `json:"-"`
}

type GetSMTPServersRequestBodyMarshalOpts struct {
...
func (m GetSMTPServersRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
// Validate validates this get Smtp servers request body
func (m *GetSMTPServersRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetSMTPServersRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetSMTPServersRequestBody) validateWhere(formats strfmt.Registry) error {
...
// ContextValidate validate this get Smtp servers request body based on the context it is used
func (m *GetSMTPServersRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetSMTPServersRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetSMTPServersRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetSMTPServersRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetSMTPServersRequestBody) UnmarshalBinary(b []byte) error {
	var res GetSMTPServersRequestBody
