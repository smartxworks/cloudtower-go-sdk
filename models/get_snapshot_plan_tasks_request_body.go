...
type GetSnapshotPlanTasksRequestBody struct {
	...
	MarshalOpts *GetSnapshotPlanTasksRequestBodyMarshalOpts `json:"-"`
}

type GetSnapshotPlanTasksRequestBodyMarshalOpts struct {
...
func (m GetSnapshotPlanTasksRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
