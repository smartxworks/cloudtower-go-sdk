...
type GetVMDisksConnectionRequestBody struct {
	...
	MarshalOpts *GetVMDisksConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetVMDisksConnectionRequestBodyMarshalOpts struct {
...
func (m GetVMDisksConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetVMDisksConnectionRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetVMDisksConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetVMDisksConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetVMDisksConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetVMDisksConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetVMDisksConnectionRequestBody) UnmarshalBinary(b []byte) error {
	var res GetVMDisksConnectionRequestBody
