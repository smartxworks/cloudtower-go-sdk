...
type GetVlansConnectionRequestBody struct {
	...
	MarshalOpts *GetVlansConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetVlansConnectionRequestBodyMarshalOpts struct {
...
func (m GetVlansConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
