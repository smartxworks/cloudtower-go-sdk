...
type GetSnapshotPlansConnectionRequestBody struct {
	...
	MarshalOpts *GetSnapshotPlansConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetSnapshotPlansConnectionRequestBodyMarshalOpts struct {
...
func (m GetSnapshotPlansConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetSnapshotPlansConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetSnapshotPlansConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetSnapshotPlansConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetSnapshotPlansConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
