...
type GetNvmfSubsystemsConnectionRequestBody struct {
	...
	MarshalOpts *GetNvmfSubsystemsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetNvmfSubsystemsConnectionRequestBodyMarshalOpts struct {
...
func (m GetNvmfSubsystemsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
