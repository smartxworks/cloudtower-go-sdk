...
type NestedAggregateUserAuditLog struct {
	...
	MarshalOpts *NestedAggregateUserAuditLogMarshalOpts `json:"-"`
}

type NestedAggregateUserAuditLogMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateUserAuditLog) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
