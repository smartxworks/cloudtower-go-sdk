...
type DeleteVirtualPrivateCloudRouterGateway struct {
	...
	MarshalOpts *DeleteVirtualPrivateCloudRouterGatewayMarshalOpts `json:"-"`
}

type DeleteVirtualPrivateCloudRouterGatewayMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteVirtualPrivateCloudRouterGateway) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
