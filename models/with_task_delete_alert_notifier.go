...
type WithTaskDeleteAlertNotifier struct {
	...
	MarshalOpts *WithTaskDeleteAlertNotifierMarshalOpts `json:"-"`
}

type WithTaskDeleteAlertNotifierMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteAlertNotifier) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteAlertNotifier) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteAlertNotifier) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskDeleteAlertNotifier) UnmarshalBinary(b []byte) error {
	var res WithTaskDeleteAlertNotifier
