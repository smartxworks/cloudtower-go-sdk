...
type NestedAggregateVMEntityFilterResult struct {
	...
	MarshalOpts *NestedAggregateVMEntityFilterResultMarshalOpts `json:"-"`
}

type NestedAggregateVMEntityFilterResultMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateVMEntityFilterResult) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateVMEntityFilterResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NestedAggregateVMEntityFilterResult) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateVMEntityFilterResult) UnmarshalBinary(b []byte) error {
	var res NestedAggregateVMEntityFilterResult
