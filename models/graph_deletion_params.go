...
type GraphDeletionParams struct {
	...
	MarshalOpts *GraphDeletionParamsMarshalOpts `json:"-"`
}

type GraphDeletionParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m GraphDeletionParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
