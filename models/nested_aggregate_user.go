...
type NestedAggregateUser struct {
	...
	MarshalOpts *NestedAggregateUserMarshalOpts `json:"-"`
}

type NestedAggregateUserMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateUser) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateUser) validateCount(formats strfmt.Registry) error {
