...
type ContentLibraryVMTemplateExportParams struct {
	...
	MarshalOpts *ContentLibraryVMTemplateExportParamsMarshalOpts `json:"-"`
}

type ContentLibraryVMTemplateExportParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m ContentLibraryVMTemplateExportParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
