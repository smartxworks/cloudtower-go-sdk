...
type NestedAggregateVds struct {
	...
	MarshalOpts *NestedAggregateVdsMarshalOpts `json:"-"`
}

type NestedAggregateVdsMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateVds) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateVds) validateCount(formats strfmt.Registry) error {
