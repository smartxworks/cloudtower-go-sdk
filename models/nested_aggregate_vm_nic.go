...
type NestedAggregateVMNic struct {
	...
	MarshalOpts *NestedAggregateVMNicMarshalOpts `json:"-"`
}

type NestedAggregateVMNicMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateVMNic) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateVMNic) validateCount(formats strfmt.Registry) error {
