...
type NestedAggregateVirtualPrivateCloudSecurityGroup struct {
	...
	MarshalOpts *NestedAggregateVirtualPrivateCloudSecurityGroupMarshalOpts `json:"-"`
}

type NestedAggregateVirtualPrivateCloudSecurityGroupMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateVirtualPrivateCloudSecurityGroup) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
