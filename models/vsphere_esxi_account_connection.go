...
type VsphereEsxiAccountConnection struct {
	...
	MarshalOpts *VsphereEsxiAccountConnectionMarshalOpts `json:"-"`
}

type VsphereEsxiAccountConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m VsphereEsxiAccountConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
