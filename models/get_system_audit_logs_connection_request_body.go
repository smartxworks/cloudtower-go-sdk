...
type GetSystemAuditLogsConnectionRequestBody struct {
	...
	MarshalOpts *GetSystemAuditLogsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetSystemAuditLogsConnectionRequestBodyMarshalOpts struct {
...
func (m GetSystemAuditLogsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
