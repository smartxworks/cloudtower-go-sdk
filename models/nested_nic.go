...
type NestedNic struct {
	...
	MarshalOpts *NestedNicMarshalOpts `json:"-"`
}

type NestedNicMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedNic) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedNic) validateID(formats strfmt.Registry) error {
...
func (m *NestedNic) validateName(formats strfmt.Registry) error {
