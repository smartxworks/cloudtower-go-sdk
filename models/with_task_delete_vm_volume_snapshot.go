...
type WithTaskDeleteVMVolumeSnapshot struct {
	...
	MarshalOpts *WithTaskDeleteVMVolumeSnapshotMarshalOpts `json:"-"`
}

type WithTaskDeleteVMVolumeSnapshotMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteVMVolumeSnapshot) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteVMVolumeSnapshot) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteVMVolumeSnapshot) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskDeleteVMVolumeSnapshot) UnmarshalBinary(b []byte) error {
	var res WithTaskDeleteVMVolumeSnapshot
