...
type WithTaskSnapshotGroup struct {
	...
	MarshalOpts *WithTaskSnapshotGroupMarshalOpts `json:"-"`
}

type WithTaskSnapshotGroupMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskSnapshotGroup) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskSnapshotGroup) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskSnapshotGroup) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
