...
type NestedAggregateIsolationPolicy struct {
	...
	MarshalOpts *NestedAggregateIsolationPolicyMarshalOpts `json:"-"`
}

type NestedAggregateIsolationPolicyMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateIsolationPolicy) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateIsolationPolicy) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateIsolationPolicy) UnmarshalBinary(b []byte) error {
	var res NestedAggregateIsolationPolicy
