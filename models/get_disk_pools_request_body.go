...
// GetDiskPoolsRequestBody get disk pools request body
//
// swagger:model GetDiskPoolsRequestBody
type GetDiskPoolsRequestBody struct {
	...
	MarshalOpts *GetDiskPoolsRequestBodyMarshalOpts `json:"-"`
}

type GetDiskPoolsRequestBodyMarshalOpts struct {
...
func (m GetDiskPoolsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
// Validate validates this get disk pools request body
func (m *GetDiskPoolsRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDiskPoolsRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetDiskPoolsRequestBody) validateWhere(formats strfmt.Registry) error {
...
// ContextValidate validate this get disk pools request body based on the context it is used
func (m *GetDiskPoolsRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetDiskPoolsRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetDiskPoolsRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetDiskPoolsRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetDiskPoolsRequestBody) UnmarshalBinary(b []byte) error {
	var res GetDiskPoolsRequestBody
