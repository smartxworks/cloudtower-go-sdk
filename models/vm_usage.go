...
func init() {
	var res []VMUsage
	if err := json.Unmarshal([]byte(`["ADVANCED_MONITORING","AGENT_MESH_NODE","BACKUP_CONTROLLER","BUNDLE_APPLICATION","CLOUDTOWER","EVEROUTE_CONTROLLER","REGISTRY","REPLICATION_CONTROLLER","SFS_CONTROLLER","SKS_MANAGEMENT"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
