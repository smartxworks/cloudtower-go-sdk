...
func init() {
	var res []VMUsage
	if err := json.Unmarshal([]byte(`["ADVANCED_MONITORING","BACKUP_CONTROLLER","BUNDLE_APPLICATION","CLOUDTOWER","EVEROUTE_CONTROLLER","REGISTRY","SKS_MANAGEMENT"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
