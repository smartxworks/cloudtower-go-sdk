...
const (
	...
	// VMUsageCLOUDTOWERPASSIVE captures enum value "CLOUDTOWER_PASSIVE"
	VMUsageCLOUDTOWERPASSIVE VMUsage = "CLOUDTOWER_PASSIVE"

	// VMUsageCLOUDTOWERWITNESS captures enum value "CLOUDTOWER_WITNESS"
	VMUsageCLOUDTOWERWITNESS VMUsage = "CLOUDTOWER_WITNESS"

	// VMUsageEVEROUTECONTROLLER captures enum value "EVEROUTE_CONTROLLER"
	VMUsageEVEROUTECONTROLLER VMUsage = "EVEROUTE_CONTROLLER"

	// VMUsageEVEROUTELB captures enum value "EVEROUTE_LB"
	VMUsageEVEROUTELB VMUsage = "EVEROUTE_LB"

	// VMUsageEVEROUTEVPCEDGE captures enum value "EVEROUTE_VPC_EDGE"
	VMUsageEVEROUTEVPCEDGE VMUsage = "EVEROUTE_VPC_EDGE"
...
func init() {
	var res []VMUsage
	if err := json.Unmarshal([]byte(`["ADVANCED_MONITORING","AGENT_MESH_NODE","BACKUP_CONTROLLER","BUNDLE_APPLICATION","CLOUDTOWER","CLOUDTOWER_PASSIVE","CLOUDTOWER_WITNESS","EVEROUTE_CONTROLLER","EVEROUTE_LB","EVEROUTE_VPC_EDGE","REGISTRY","REPLICATION_CONTROLLER","SFS_CONTROLLER","SHARE_REGISTRY","SKS_MANAGEMENT"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
