...
type GetVMExportFilesConnectionRequestBody struct {
	...
	MarshalOpts *GetVMExportFilesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetVMExportFilesConnectionRequestBodyMarshalOpts struct {
...
func (m GetVMExportFilesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
