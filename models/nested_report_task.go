...
type NestedReportTask struct {
	...
	MarshalOpts *NestedReportTaskMarshalOpts `json:"-"`
}

type NestedReportTaskMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedReportTask) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedReportTask) validateID(formats strfmt.Registry) error {
...
func (m *NestedReportTask) validateName(formats strfmt.Registry) error {
