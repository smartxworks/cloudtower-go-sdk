...
type NestedAggregateSnapshotGroup struct {
	...
	MarshalOpts *NestedAggregateSnapshotGroupMarshalOpts `json:"-"`
}

type NestedAggregateSnapshotGroupMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateSnapshotGroup) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateSnapshotGroup) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateSnapshotGroup) UnmarshalBinary(b []byte) error {
	var res NestedAggregateSnapshotGroup
