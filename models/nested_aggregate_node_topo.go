...
type NestedAggregateNodeTopo struct {
	...
	MarshalOpts *NestedAggregateNodeTopoMarshalOpts `json:"-"`
}

type NestedAggregateNodeTopoMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateNodeTopo) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateNodeTopo) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateNodeTopo) UnmarshalBinary(b []byte) error {
	var res NestedAggregateNodeTopo
