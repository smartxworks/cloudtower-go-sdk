...
type WithTaskVMVolume struct {
	...
	MarshalOpts *WithTaskVMVolumeMarshalOpts `json:"-"`
}

type WithTaskVMVolumeMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskVMVolume) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskVMVolume) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskVMVolume) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
