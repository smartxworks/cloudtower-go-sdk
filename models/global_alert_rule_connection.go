...
type GlobalAlertRuleConnection struct {
	...
	MarshalOpts *GlobalAlertRuleConnectionMarshalOpts `json:"-"`
}

type GlobalAlertRuleConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m GlobalAlertRuleConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
