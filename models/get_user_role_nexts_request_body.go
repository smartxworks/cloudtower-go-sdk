...
func (m *GetUserRoleNextsRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetUserRoleNextsRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetUserRoleNextsRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetUserRoleNextsRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetUserRoleNextsRequestBody) UnmarshalBinary(b []byte) error {
	var res GetUserRoleNextsRequestBody
