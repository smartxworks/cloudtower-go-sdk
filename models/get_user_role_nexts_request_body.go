...
type GetUserRoleNextsRequestBody struct {
	...
	MarshalOpts *GetUserRoleNextsRequestBodyMarshalOpts `json:"-"`
}

type GetUserRoleNextsRequestBodyMarshalOpts struct {
...
func (m GetUserRoleNextsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
