...
type WithTaskLabel struct {
	...
	MarshalOpts *WithTaskLabelMarshalOpts `json:"-"`
}

type WithTaskLabelMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskLabel) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskLabel) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskLabel) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
