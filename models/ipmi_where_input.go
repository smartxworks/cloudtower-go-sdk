...
type IpmiWhereInput struct {
	...
	MarshalOpts *IpmiWhereInputMarshalOpts `json:"-"`
}

type IpmiWhereInputMarshalOpts struct {
	...
	ValidNot_Explicit_Null_When_Empty bool
}

func (m IpmiWhereInput) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
	...
	// handle nullable field valid_not
	if m.ValidNot != nil {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"valid_not\":")
		bytes, err := swag.WriteJSON(m.ValidNot)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
		first = false
	} else if m.MarshalOpts != nil && m.MarshalOpts.ValidNot_Explicit_Null_When_Empty {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"valid_not\":null")
		first = false
	}
