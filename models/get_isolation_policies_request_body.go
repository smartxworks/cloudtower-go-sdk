...
type GetIsolationPoliciesRequestBody struct {
	...
	MarshalOpts *GetIsolationPoliciesRequestBodyMarshalOpts `json:"-"`
}

type GetIsolationPoliciesRequestBodyMarshalOpts struct {
...
func (m GetIsolationPoliciesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
