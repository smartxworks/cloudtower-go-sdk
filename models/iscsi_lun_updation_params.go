...
type IscsiLunUpdationParams struct {
	...
	MarshalOpts *IscsiLunUpdationParamsMarshalOpts `json:"-"`
}

type IscsiLunUpdationParamsMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	Where_Explicit_Null_When_Empty bool
}

func (m IscsiLunUpdationParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *IscsiLunUpdationParams) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
