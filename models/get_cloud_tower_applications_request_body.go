...
type GetCloudTowerApplicationsRequestBody struct {
	...
	MarshalOpts *GetCloudTowerApplicationsRequestBodyMarshalOpts `json:"-"`
}

type GetCloudTowerApplicationsRequestBodyMarshalOpts struct {
...
func (m GetCloudTowerApplicationsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetCloudTowerApplicationsRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCloudTowerApplicationsRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetCloudTowerApplicationsRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetCloudTowerApplicationsRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetCloudTowerApplicationsRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetCloudTowerApplicationsRequestBody) UnmarshalBinary(b []byte) error {
	var res GetCloudTowerApplicationsRequestBody
