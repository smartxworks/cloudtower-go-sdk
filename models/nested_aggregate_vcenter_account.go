...
type NestedAggregateVcenterAccount struct {
	...
	MarshalOpts *NestedAggregateVcenterAccountMarshalOpts `json:"-"`
}

type NestedAggregateVcenterAccountMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateVcenterAccount) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateVcenterAccount) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateVcenterAccount) UnmarshalBinary(b []byte) error {
	var res NestedAggregateVcenterAccount
