...
func (m *GetNvmfNamespaceSnapshotsConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetNvmfNamespaceSnapshotsConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetNvmfNamespaceSnapshotsConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetNvmfNamespaceSnapshotsConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
