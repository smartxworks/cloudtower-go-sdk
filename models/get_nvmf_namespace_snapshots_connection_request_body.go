...
type GetNvmfNamespaceSnapshotsConnectionRequestBody struct {
	...
	MarshalOpts *GetNvmfNamespaceSnapshotsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetNvmfNamespaceSnapshotsConnectionRequestBodyMarshalOpts struct {
...
func (m GetNvmfNamespaceSnapshotsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
