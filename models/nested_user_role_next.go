...
type NestedUserRoleNext struct {
	...
	MarshalOpts *NestedUserRoleNextMarshalOpts `json:"-"`
}

type NestedUserRoleNextMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedUserRoleNext) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedUserRoleNext) validateID(formats strfmt.Registry) error {
...
func (m *NestedUserRoleNext) validateName(formats strfmt.Registry) error {
