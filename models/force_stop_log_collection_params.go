...
type ForceStopLogCollectionParams struct {
	...
	MarshalOpts *ForceStopLogCollectionParamsMarshalOpts `json:"-"`
}

type ForceStopLogCollectionParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m ForceStopLogCollectionParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
