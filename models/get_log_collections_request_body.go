...
type GetLogCollectionsRequestBody struct {
	...
	MarshalOpts *GetLogCollectionsRequestBodyMarshalOpts `json:"-"`
}

type GetLogCollectionsRequestBodyMarshalOpts struct {
...
func (m GetLogCollectionsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
