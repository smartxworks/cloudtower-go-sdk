...
type GetVMSnapshotsRequestBody struct {
	...
	MarshalOpts *GetVMSnapshotsRequestBodyMarshalOpts `json:"-"`
}

type GetVMSnapshotsRequestBodyMarshalOpts struct {
...
func (m GetVMSnapshotsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
