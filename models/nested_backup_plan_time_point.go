...
type NestedBackupPlanTimePoint struct {
	...
	MarshalOpts *NestedBackupPlanTimePointMarshalOpts `json:"-"`
}

type NestedBackupPlanTimePointMarshalOpts struct {
	Date_Explicit_Null_When_Empty bool

	DatePosition_Explicit_Null_When_Empty bool
...
func (m NestedBackupPlanTimePoint) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
