...
type GetGpuDevicesRequestBody struct {
	...
	MarshalOpts *GetGpuDevicesRequestBodyMarshalOpts `json:"-"`
}

type GetGpuDevicesRequestBodyMarshalOpts struct {
...
func (m GetGpuDevicesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetGpuDevicesRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetGpuDevicesRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetGpuDevicesRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetGpuDevicesRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetGpuDevicesRequestBody) UnmarshalBinary(b []byte) error {
	var res GetGpuDevicesRequestBody
