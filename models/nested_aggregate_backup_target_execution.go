...
type NestedAggregateBackupTargetExecution struct {
	...
	MarshalOpts *NestedAggregateBackupTargetExecutionMarshalOpts `json:"-"`
}

type NestedAggregateBackupTargetExecutionMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateBackupTargetExecution) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
