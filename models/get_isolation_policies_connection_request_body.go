...
type GetIsolationPoliciesConnectionRequestBody struct {
	...
	MarshalOpts *GetIsolationPoliciesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetIsolationPoliciesConnectionRequestBodyMarshalOpts struct {
...
func (m GetIsolationPoliciesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
