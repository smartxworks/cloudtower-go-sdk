...
type NestedReportTemplate struct {
	...
	MarshalOpts *NestedReportTemplateMarshalOpts `json:"-"`
}

type NestedReportTemplateMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedReportTemplate) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedReportTemplate) validateID(formats strfmt.Registry) error {
...
func (m *NestedReportTemplate) validateName(formats strfmt.Registry) error {
