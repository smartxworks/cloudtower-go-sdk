...
type GetUserAuditLogsConnectionRequestBody struct {
	...
	MarshalOpts *GetUserAuditLogsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetUserAuditLogsConnectionRequestBodyMarshalOpts struct {
...
func (m GetUserAuditLogsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetUserAuditLogsConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetUserAuditLogsConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetUserAuditLogsConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetUserAuditLogsConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
