...
type GetUsbDevicesConnectionRequestBody struct {
	...
	MarshalOpts *GetUsbDevicesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetUsbDevicesConnectionRequestBodyMarshalOpts struct {
...
func (m GetUsbDevicesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
