...
type WithTaskSnmpTransport struct {
	...
	MarshalOpts *WithTaskSnmpTransportMarshalOpts `json:"-"`
}

type WithTaskSnmpTransportMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskSnmpTransport) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskSnmpTransport) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskSnmpTransport) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
