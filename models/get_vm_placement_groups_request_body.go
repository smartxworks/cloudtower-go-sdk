...
type GetVMPlacementGroupsRequestBody struct {
	...
	MarshalOpts *GetVMPlacementGroupsRequestBodyMarshalOpts `json:"-"`
}

type GetVMPlacementGroupsRequestBodyMarshalOpts struct {
...
func (m GetVMPlacementGroupsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
