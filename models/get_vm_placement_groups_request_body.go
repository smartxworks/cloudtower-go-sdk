...
func (m *GetVMPlacementGroupsRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetVMPlacementGroupsRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetVMPlacementGroupsRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetVMPlacementGroupsRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetVMPlacementGroupsRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetVMPlacementGroupsRequestBody) UnmarshalBinary(b []byte) error {
	var res GetVMPlacementGroupsRequestBody
