...
type DeleteVMVolumeSnapshot struct {
	...
	MarshalOpts *DeleteVMVolumeSnapshotMarshalOpts `json:"-"`
}

type DeleteVMVolumeSnapshotMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteVMVolumeSnapshot) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *DeleteVMVolumeSnapshot) validateID(formats strfmt.Registry) error {
...
func (m *DeleteVMVolumeSnapshot) UnmarshalBinary(b []byte) error {
	var res DeleteVMVolumeSnapshot
