...
type DeleteSecurityGroup struct {
	...
	MarshalOpts *DeleteSecurityGroupMarshalOpts `json:"-"`
}

type DeleteSecurityGroupMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteSecurityGroup) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *DeleteSecurityGroup) validateID(formats strfmt.Registry) error {
