...
type GetSnmpTransportsConnectionRequestBody struct {
	...
	MarshalOpts *GetSnmpTransportsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetSnmpTransportsConnectionRequestBodyMarshalOpts struct {
...
func (m GetSnmpTransportsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetSnmpTransportsConnectionRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetSnmpTransportsConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetSnmpTransportsConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetSnmpTransportsConnectionRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetSnmpTransportsConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetSnmpTransportsConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetSnmpTransportsConnectionRequestBody) UnmarshalBinary(b []byte) error {
	var res GetSnmpTransportsConnectionRequestBody
