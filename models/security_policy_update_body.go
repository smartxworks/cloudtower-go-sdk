...
type SecurityPolicyUpdateBody struct {
	...
	MarshalOpts *SecurityPolicyUpdateBodyMarshalOpts `json:"-"`
}

type SecurityPolicyUpdateBodyMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	Where_Explicit_Null_When_Empty bool
}

func (m SecurityPolicyUpdateBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *SecurityPolicyUpdateBody) validateData(formats strfmt.Registry) error {
...
func (m *SecurityPolicyUpdateBody) validateWhere(formats strfmt.Registry) error {
...
func (m *SecurityPolicyUpdateBody) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SecurityPolicyUpdateBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SecurityPolicyUpdateBody) UnmarshalBinary(b []byte) error {
	var res SecurityPolicyUpdateBody
