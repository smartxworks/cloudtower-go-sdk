...
type SnapshotGroupRollbackParams struct {
	...
	MarshalOpts *SnapshotGroupRollbackParamsMarshalOpts `json:"-"`
}

type SnapshotGroupRollbackParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m SnapshotGroupRollbackParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *SnapshotGroupRollbackParams) validateWhere(formats strfmt.Registry) error {
...
func (m *SnapshotGroupRollbackParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
