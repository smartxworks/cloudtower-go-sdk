...
type DeleteLabel struct {
	...
	MarshalOpts *DeleteLabelMarshalOpts `json:"-"`
}

type DeleteLabelMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteLabel) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *DeleteLabel) validateID(formats strfmt.Registry) error {
