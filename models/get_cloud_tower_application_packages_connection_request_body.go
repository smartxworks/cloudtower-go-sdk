...
type GetCloudTowerApplicationPackagesConnectionRequestBody struct {
	...
	MarshalOpts *GetCloudTowerApplicationPackagesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetCloudTowerApplicationPackagesConnectionRequestBodyMarshalOpts struct {
...
func (m GetCloudTowerApplicationPackagesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetCloudTowerApplicationPackagesConnectionRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCloudTowerApplicationPackagesConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetCloudTowerApplicationPackagesConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetCloudTowerApplicationPackagesConnectionRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetCloudTowerApplicationPackagesConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetCloudTowerApplicationPackagesConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetCloudTowerApplicationPackagesConnectionRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetCloudTowerApplicationPackagesConnectionRequestBody) UnmarshalBinary(b []byte) error {
	var res GetCloudTowerApplicationPackagesConnectionRequestBody
