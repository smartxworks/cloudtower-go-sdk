...
type GetReportTasksConnectionRequestBody struct {
	...
	MarshalOpts *GetReportTasksConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetReportTasksConnectionRequestBodyMarshalOpts struct {
...
func (m GetReportTasksConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
