...
type NestedAggregateSecurityPolicy struct {
	...
	MarshalOpts *NestedAggregateSecurityPolicyMarshalOpts `json:"-"`
}

type NestedAggregateSecurityPolicyMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateSecurityPolicy) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateSecurityPolicy) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateSecurityPolicy) UnmarshalBinary(b []byte) error {
	var res NestedAggregateSecurityPolicy
