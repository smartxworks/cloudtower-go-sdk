...
type GetClusterImagesConnectionRequestBody struct {
	...
	MarshalOpts *GetClusterImagesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetClusterImagesConnectionRequestBodyMarshalOpts struct {
...
func (m GetClusterImagesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
