...
type WithTaskGpuDevice struct {
	...
	MarshalOpts *WithTaskGpuDeviceMarshalOpts `json:"-"`
}

type WithTaskGpuDeviceMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskGpuDevice) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskGpuDevice) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskGpuDevice) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
