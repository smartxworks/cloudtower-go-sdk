...
type NestedVM struct {
	...
	MarshalOpts *NestedVMMarshalOpts `json:"-"`
}

type NestedVMMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedVM) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedVM) validateID(formats strfmt.Registry) error {
...
func (m *NestedVM) validateName(formats strfmt.Registry) error {
