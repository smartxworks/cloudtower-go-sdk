...
type WithTaskDeleteNamespaceGroup struct {
	...
	MarshalOpts *WithTaskDeleteNamespaceGroupMarshalOpts `json:"-"`
}

type WithTaskDeleteNamespaceGroupMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteNamespaceGroup) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteNamespaceGroup) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteNamespaceGroup) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskDeleteNamespaceGroup) UnmarshalBinary(b []byte) error {
	var res WithTaskDeleteNamespaceGroup
