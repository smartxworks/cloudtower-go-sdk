...
type VMRemoveGpuDeviceParams struct {
	...
	MarshalOpts *VMRemoveGpuDeviceParamsMarshalOpts `json:"-"`
}

type VMRemoveGpuDeviceParamsMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	Where_Explicit_Null_When_Empty bool
}

func (m VMRemoveGpuDeviceParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *VMRemoveGpuDeviceParams) validateData(formats strfmt.Registry) error {
...
func (m *VMRemoveGpuDeviceParams) validateWhere(formats strfmt.Registry) error {
...
func (m *VMRemoveGpuDeviceParams) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VMRemoveGpuDeviceParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VMRemoveGpuDeviceParams) UnmarshalBinary(b []byte) error {
	var res VMRemoveGpuDeviceParams
