...
type GetElfImagesConnectionRequestBody struct {
	...
	MarshalOpts *GetElfImagesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetElfImagesConnectionRequestBodyMarshalOpts struct {
...
func (m GetElfImagesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetElfImagesConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetElfImagesConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetElfImagesConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetElfImagesConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
