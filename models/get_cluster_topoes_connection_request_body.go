...
type GetClusterTopoesConnectionRequestBody struct {
	...
	MarshalOpts *GetClusterTopoesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetClusterTopoesConnectionRequestBodyMarshalOpts struct {
...
func (m GetClusterTopoesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetClusterTopoesConnectionRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetClusterTopoesConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetClusterTopoesConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetClusterTopoesConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetClusterTopoesConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetClusterTopoesConnectionRequestBody) UnmarshalBinary(b []byte) error {
	var res GetClusterTopoesConnectionRequestBody
