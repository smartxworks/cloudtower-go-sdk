...
type DeleteVMSnapshot struct {
	...
	MarshalOpts *DeleteVMSnapshotMarshalOpts `json:"-"`
}

type DeleteVMSnapshotMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteVMSnapshot) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *DeleteVMSnapshot) validateID(formats strfmt.Registry) error {
