...
type GetNfsExportsConnectionRequestBody struct {
	...
	MarshalOpts *GetNfsExportsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetNfsExportsConnectionRequestBodyMarshalOpts struct {
...
func (m GetNfsExportsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetNfsExportsConnectionRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetNfsExportsConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetNfsExportsConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetNfsExportsConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetNfsExportsConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetNfsExportsConnectionRequestBody) UnmarshalBinary(b []byte) error {
	var res GetNfsExportsConnectionRequestBody
