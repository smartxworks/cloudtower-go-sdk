...
func (m *GetElfImagesRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetElfImagesRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetElfImagesRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetElfImagesRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
