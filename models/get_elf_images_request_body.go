...
type GetElfImagesRequestBody struct {
	...
	MarshalOpts *GetElfImagesRequestBodyMarshalOpts `json:"-"`
}

type GetElfImagesRequestBodyMarshalOpts struct {
...
func (m GetElfImagesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
