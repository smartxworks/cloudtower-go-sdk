...
type ClusterSettingsConnection struct {
	...
	MarshalOpts *ClusterSettingsConnectionMarshalOpts `json:"-"`
}

type ClusterSettingsConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m ClusterSettingsConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
