...
type GetLabelsConnectionRequestBody struct {
	...
	MarshalOpts *GetLabelsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetLabelsConnectionRequestBodyMarshalOpts struct {
...
func (m GetLabelsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
