...
type NvmfNamespaceWhereInput struct {
	...
	// snapshot plans every
	SnapshotPlansEvery *SnapshotPlanWhereInput `json:"snapshot_plans_every,omitempty"`

	// snapshot plans none
	SnapshotPlansNone *SnapshotPlanWhereInput `json:"snapshot_plans_none,omitempty"`

	// snapshot plans some
	SnapshotPlansSome *SnapshotPlanWhereInput `json:"snapshot_plans_some,omitempty"`
	...
	MarshalOpts *NvmfNamespaceWhereInputMarshalOpts `json:"-"`
}

type NvmfNamespaceWhereInputMarshalOpts struct {
	...
	IsSharedNot_Explicit_Null_When_Empty bool
	...
	NamespaceIDGt_Explicit_Null_When_Empty bool

	NamespaceIDGte_Explicit_Null_When_Empty bool

	NamespaceIDIn_Explicit_Null_When_Empty bool

	NamespaceIDLt_Explicit_Null_When_Empty bool

	NamespaceIDLte_Explicit_Null_When_Empty bool

	NamespaceIDNot_Explicit_Null_When_Empty bool

	NamespaceIDNotIn_Explicit_Null_When_Empty bool
	...
	SnapshotPlansEvery_Explicit_Null_When_Empty bool

	SnapshotPlansNone_Explicit_Null_When_Empty bool

	SnapshotPlansSome_Explicit_Null_When_Empty bool
...
func (m NvmfNamespaceWhereInput) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
	...
	// handle nullable field is_shared_not
	if m.IsSharedNot != nil {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"is_shared_not\":")
		bytes, err := swag.WriteJSON(m.IsSharedNot)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
		first = false
	} else if m.MarshalOpts != nil && m.MarshalOpts.IsSharedNot_Explicit_Null_When_Empty {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"is_shared_not\":null")
		first = false
	}
	...
	// handle nullable field namespace_id_gt
	if m.NamespaceIDGt != nil {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"namespace_id_gt\":")
		bytes, err := swag.WriteJSON(m.NamespaceIDGt)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
		first = false
	} else if m.MarshalOpts != nil && m.MarshalOpts.NamespaceIDGt_Explicit_Null_When_Empty {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"namespace_id_gt\":null")
		first = false
	}

	// handle nullable field namespace_id_gte
	if m.NamespaceIDGte != nil {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"namespace_id_gte\":")
		bytes, err := swag.WriteJSON(m.NamespaceIDGte)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
		first = false
	} else if m.MarshalOpts != nil && m.MarshalOpts.NamespaceIDGte_Explicit_Null_When_Empty {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"namespace_id_gte\":null")
		first = false
	}

	// handle non nullable field namespace_id_in with omitempty
	if !swag.IsZero(m.NamespaceIDIn) {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"namespace_id_in\":")
		bytes, err := swag.WriteJSON(m.NamespaceIDIn)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
	...
	// handle nullable field namespace_id_lt
	if m.NamespaceIDLt != nil {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"namespace_id_lt\":")
		bytes, err := swag.WriteJSON(m.NamespaceIDLt)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
		first = false
	} else if m.MarshalOpts != nil && m.MarshalOpts.NamespaceIDLt_Explicit_Null_When_Empty {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"namespace_id_lt\":null")
		first = false
	}

	// handle nullable field namespace_id_lte
	if m.NamespaceIDLte != nil {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"namespace_id_lte\":")
		bytes, err := swag.WriteJSON(m.NamespaceIDLte)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
		first = false
	} else if m.MarshalOpts != nil && m.MarshalOpts.NamespaceIDLte_Explicit_Null_When_Empty {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"namespace_id_lte\":null")
		first = false
	}

	// handle nullable field namespace_id_not
	if m.NamespaceIDNot != nil {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"namespace_id_not\":")
		bytes, err := swag.WriteJSON(m.NamespaceIDNot)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
		first = false
	} else if m.MarshalOpts != nil && m.MarshalOpts.NamespaceIDNot_Explicit_Null_When_Empty {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"namespace_id_not\":null")
		first = false
	}

	// handle non nullable field namespace_id_not_in with omitempty
	if !swag.IsZero(m.NamespaceIDNotIn) {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"namespace_id_not_in\":")
		bytes, err := swag.WriteJSON(m.NamespaceIDNotIn)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
	...
	// handle nullable field snapshot_plans_every
	if m.SnapshotPlansEvery != nil {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"snapshot_plans_every\":")
		bytes, err := swag.WriteJSON(m.SnapshotPlansEvery)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
		first = false
	} else if m.MarshalOpts != nil && m.MarshalOpts.SnapshotPlansEvery_Explicit_Null_When_Empty {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"snapshot_plans_every\":null")
		first = false
	}

	// handle nullable field snapshot_plans_none
	if m.SnapshotPlansNone != nil {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"snapshot_plans_none\":")
		bytes, err := swag.WriteJSON(m.SnapshotPlansNone)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
		first = false
	} else if m.MarshalOpts != nil && m.MarshalOpts.SnapshotPlansNone_Explicit_Null_When_Empty {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"snapshot_plans_none\":null")
		first = false
	}

	// handle nullable field snapshot_plans_some
	if m.SnapshotPlansSome != nil {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"snapshot_plans_some\":")
		bytes, err := swag.WriteJSON(m.SnapshotPlansSome)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
		first = false
	} else if m.MarshalOpts != nil && m.MarshalOpts.SnapshotPlansSome_Explicit_Null_When_Empty {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"snapshot_plans_some\":null")
		first = false
	}
...
func (m *NvmfNamespaceWhereInput) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateSnapshotPlansEvery(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateSnapshotPlansNone(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateSnapshotPlansSome(formats); err != nil {
		res = append(res, err)
	}
...
func (m *NvmfNamespaceWhereInput) validateBusinessHostGroupsEvery(formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) validateBusinessHostGroupsNone(formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) validateBusinessHostGroupsSome(formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) validateBusinessHostsEvery(formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) validateBusinessHostsNone(formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) validateBusinessHostsSome(formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) validateConfigurationMethod(formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) validateConfigurationMethodIn(formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) validateConfigurationMethodNot(formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) validateConfigurationMethodNotIn(formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) validateEncryptMethod(formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) validateEncryptMethodIn(formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) validateEncryptMethodNot(formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) validateEncryptMethodNotIn(formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) validateResiliencyType(formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) validateResiliencyTypeIn(formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) validateResiliencyTypeNot(formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) validateResiliencyTypeNotIn(formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) validateSnapshotPlansEvery(formats strfmt.Registry) error {
	if swag.IsZero(m.SnapshotPlansEvery) { // not required
		return nil
	}

	if m.SnapshotPlansEvery != nil {
		if err := m.SnapshotPlansEvery.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("snapshot_plans_every")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("snapshot_plans_every")
			}
			return err
		}
	}
...
func (m *NvmfNamespaceWhereInput) validateSnapshotPlansNone(formats strfmt.Registry) error {
	if swag.IsZero(m.SnapshotPlansNone) { // not required
		return nil
	}

	if m.SnapshotPlansNone != nil {
		if err := m.SnapshotPlansNone.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("snapshot_plans_none")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("snapshot_plans_none")
			}
			return err
		}
	}
...
func (m *NvmfNamespaceWhereInput) validateSnapshotPlansSome(formats strfmt.Registry) error {
	if swag.IsZero(m.SnapshotPlansSome) { // not required
		return nil
	}

	if m.SnapshotPlansSome != nil {
		if err := m.SnapshotPlansSome.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("snapshot_plans_some")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("snapshot_plans_some")
			}
			return err
		}
	}
...
func (m *NvmfNamespaceWhereInput) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateSnapshotPlansEvery(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateSnapshotPlansNone(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateSnapshotPlansSome(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *NvmfNamespaceWhereInput) contextValidateBusinessHostGroupsEvery(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) contextValidateBusinessHostGroupsNone(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) contextValidateBusinessHostGroupsSome(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) contextValidateBusinessHostsEvery(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) contextValidateBusinessHostsNone(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) contextValidateBusinessHostsSome(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) contextValidateConfigurationMethod(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) contextValidateConfigurationMethodIn(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) contextValidateConfigurationMethodNot(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) contextValidateConfigurationMethodNotIn(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) contextValidateEncryptMethod(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) contextValidateEncryptMethodIn(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) contextValidateEncryptMethodNot(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) contextValidateEncryptMethodNotIn(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) contextValidateResiliencyType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) contextValidateResiliencyTypeIn(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) contextValidateResiliencyTypeNot(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) contextValidateResiliencyTypeNotIn(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NvmfNamespaceWhereInput) contextValidateSnapshotPlansEvery(ctx context.Context, formats strfmt.Registry) error {

	if m.SnapshotPlansEvery != nil {
		if err := m.SnapshotPlansEvery.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("snapshot_plans_every")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("snapshot_plans_every")
...
func (m *NvmfNamespaceWhereInput) contextValidateSnapshotPlansNone(ctx context.Context, formats strfmt.Registry) error {

	if m.SnapshotPlansNone != nil {
		if err := m.SnapshotPlansNone.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("snapshot_plans_none")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("snapshot_plans_none")
...
func (m *NvmfNamespaceWhereInput) contextValidateSnapshotPlansSome(ctx context.Context, formats strfmt.Registry) error {

	if m.SnapshotPlansSome != nil {
		if err := m.SnapshotPlansSome.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("snapshot_plans_some")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("snapshot_plans_some")
