...
type DeleteOrganization struct {
	...
	MarshalOpts *DeleteOrganizationMarshalOpts `json:"-"`
}

type DeleteOrganizationMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteOrganization) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *DeleteOrganization) validateID(formats strfmt.Registry) error {
