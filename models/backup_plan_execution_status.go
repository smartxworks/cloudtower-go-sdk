...
const (
	...
	// BackupPlanExecutionStatusWAITINGEXECUTE captures enum value "WAITING_EXECUTE"
	BackupPlanExecutionStatusWAITINGEXECUTE BackupPlanExecutionStatus = "WAITING_EXECUTE"
)
...
func init() {
	...
	if err := json.Unmarshal([]byte(`["FAILED","NEVER_EXECUTE","PARTIAL_SUCCESS","PAUSED","RUNNING","SUCCESS","WAITING_EXECUTE"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
