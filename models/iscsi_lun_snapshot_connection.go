...
type IscsiLunSnapshotConnection struct {
	...
	MarshalOpts *IscsiLunSnapshotConnectionMarshalOpts `json:"-"`
}

type IscsiLunSnapshotConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m IscsiLunSnapshotConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
