...
type NestedAggregateVM struct {
	...
	MarshalOpts *NestedAggregateVMMarshalOpts `json:"-"`
}

type NestedAggregateVMMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateVM) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateVM) validateCount(formats strfmt.Registry) error {
