...
type VMVolumeWhereUniqueInput struct {
	...
	MarshalOpts *VMVolumeWhereUniqueInputMarshalOpts `json:"-"`
}

type VMVolumeWhereUniqueInputMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	LocalID_Explicit_Null_When_Empty bool
}

func (m VMVolumeWhereUniqueInput) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
