...
type GetEntityFiltersConnectionRequestBody struct {
	...
	MarshalOpts *GetEntityFiltersConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetEntityFiltersConnectionRequestBodyMarshalOpts struct {
...
func (m GetEntityFiltersConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
