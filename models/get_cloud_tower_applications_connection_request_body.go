...
type GetCloudTowerApplicationsConnectionRequestBody struct {
	...
	MarshalOpts *GetCloudTowerApplicationsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetCloudTowerApplicationsConnectionRequestBodyMarshalOpts struct {
...
func (m GetCloudTowerApplicationsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetCloudTowerApplicationsConnectionRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCloudTowerApplicationsConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetCloudTowerApplicationsConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetCloudTowerApplicationsConnectionRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetCloudTowerApplicationsConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetCloudTowerApplicationsConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetCloudTowerApplicationsConnectionRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetCloudTowerApplicationsConnectionRequestBody) UnmarshalBinary(b []byte) error {
	var res GetCloudTowerApplicationsConnectionRequestBody
