...
func (m *IscsiLun) validateEncryptMethod(formats strfmt.Registry) error {
...
func (m *IscsiLun) contextValidateConfigurationMethod(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IscsiLun) contextValidateEncryptMethod(ctx context.Context, formats strfmt.Registry) error {
