...
type GetIscsiLunsRequestBody struct {
	...
	MarshalOpts *GetIscsiLunsRequestBodyMarshalOpts `json:"-"`
}

type GetIscsiLunsRequestBodyMarshalOpts struct {
...
func (m GetIscsiLunsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetIscsiLunsRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetIscsiLunsRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetIscsiLunsRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetIscsiLunsRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetIscsiLunsRequestBody) UnmarshalBinary(b []byte) error {
	var res GetIscsiLunsRequestBody
