...
type WithTaskDeleteNvmfSubsystem struct {
	...
	MarshalOpts *WithTaskDeleteNvmfSubsystemMarshalOpts `json:"-"`
}

type WithTaskDeleteNvmfSubsystemMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteNvmfSubsystem) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
