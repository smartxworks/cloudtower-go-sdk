...
type WithTaskSnmpTrapReceiver struct {
	...
	MarshalOpts *WithTaskSnmpTrapReceiverMarshalOpts `json:"-"`
}

type WithTaskSnmpTrapReceiverMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskSnmpTrapReceiver) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskSnmpTrapReceiver) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskSnmpTrapReceiver) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskSnmpTrapReceiver) UnmarshalBinary(b []byte) error {
	var res WithTaskSnmpTrapReceiver
