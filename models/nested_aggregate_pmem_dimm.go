...
type NestedAggregatePmemDimm struct {
	...
	MarshalOpts *NestedAggregatePmemDimmMarshalOpts `json:"-"`
}

type NestedAggregatePmemDimmMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregatePmemDimm) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregatePmemDimm) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregatePmemDimm) UnmarshalBinary(b []byte) error {
	var res NestedAggregatePmemDimm
