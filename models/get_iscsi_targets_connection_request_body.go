...
type GetIscsiTargetsConnectionRequestBody struct {
	...
	MarshalOpts *GetIscsiTargetsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetIscsiTargetsConnectionRequestBodyMarshalOpts struct {
...
func (m GetIscsiTargetsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
