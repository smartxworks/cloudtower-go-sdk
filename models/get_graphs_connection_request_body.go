...
type GetGraphsConnectionRequestBody struct {
	...
	MarshalOpts *GetGraphsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetGraphsConnectionRequestBodyMarshalOpts struct {
...
func (m GetGraphsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
