...
type NestedAggregateDatacenter struct {
	...
	MarshalOpts *NestedAggregateDatacenterMarshalOpts `json:"-"`
}

type NestedAggregateDatacenterMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateDatacenter) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
