...
type GetSnapshotPlanTasksConnectionRequestBody struct {
	...
	MarshalOpts *GetSnapshotPlanTasksConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetSnapshotPlanTasksConnectionRequestBodyMarshalOpts struct {
...
func (m GetSnapshotPlanTasksConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
