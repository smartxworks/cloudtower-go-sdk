...
type GetVMTemplatesRequestBody struct {
	...
	MarshalOpts *GetVMTemplatesRequestBodyMarshalOpts `json:"-"`
}

type GetVMTemplatesRequestBodyMarshalOpts struct {
...
func (m GetVMTemplatesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetVMTemplatesRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetVMTemplatesRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetVMTemplatesRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetVMTemplatesRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
