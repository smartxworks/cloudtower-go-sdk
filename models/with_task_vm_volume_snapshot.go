...
type WithTaskVMVolumeSnapshot struct {
	...
	MarshalOpts *WithTaskVMVolumeSnapshotMarshalOpts `json:"-"`
}

type WithTaskVMVolumeSnapshotMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskVMVolumeSnapshot) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
