...
type GetUserAuditLogsRequestBody struct {
	...
	MarshalOpts *GetUserAuditLogsRequestBodyMarshalOpts `json:"-"`
}

type GetUserAuditLogsRequestBodyMarshalOpts struct {
...
func (m GetUserAuditLogsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
