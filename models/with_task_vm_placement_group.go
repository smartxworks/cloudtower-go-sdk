...
type WithTaskVMPlacementGroup struct {
	...
	MarshalOpts *WithTaskVMPlacementGroupMarshalOpts `json:"-"`
}

type WithTaskVMPlacementGroupMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskVMPlacementGroup) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
