...
type GetElfStoragePoliciesRequestBody struct {
	...
	MarshalOpts *GetElfStoragePoliciesRequestBodyMarshalOpts `json:"-"`
}

type GetElfStoragePoliciesRequestBodyMarshalOpts struct {
...
func (m GetElfStoragePoliciesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetElfStoragePoliciesRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetElfStoragePoliciesRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetElfStoragePoliciesRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetElfStoragePoliciesRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
