...
type NestedAggregateSnapshotPlan struct {
	...
	MarshalOpts *NestedAggregateSnapshotPlanMarshalOpts `json:"-"`
}

type NestedAggregateSnapshotPlanMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateSnapshotPlan) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateSnapshotPlan) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateSnapshotPlan) UnmarshalBinary(b []byte) error {
	var res NestedAggregateSnapshotPlan
