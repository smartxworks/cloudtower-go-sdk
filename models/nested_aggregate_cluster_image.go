...
type NestedAggregateClusterImage struct {
	...
	MarshalOpts *NestedAggregateClusterImageMarshalOpts `json:"-"`
}

type NestedAggregateClusterImageMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateClusterImage) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateClusterImage) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateClusterImage) UnmarshalBinary(b []byte) error {
	var res NestedAggregateClusterImage
