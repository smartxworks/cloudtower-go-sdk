...
type WithTaskDisk struct {
	...
	MarshalOpts *WithTaskDiskMarshalOpts `json:"-"`
}

type WithTaskDiskMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDisk) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDisk) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDisk) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
