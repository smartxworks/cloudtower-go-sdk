...
type GetEverouteLicensesRequestBody struct {
	...
	MarshalOpts *GetEverouteLicensesRequestBodyMarshalOpts `json:"-"`
}

type GetEverouteLicensesRequestBodyMarshalOpts struct {
...
func (m GetEverouteLicensesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
