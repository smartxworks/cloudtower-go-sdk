...
type NestedAggregateDisk struct {
	...
	MarshalOpts *NestedAggregateDiskMarshalOpts `json:"-"`
}

type NestedAggregateDiskMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateDisk) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateDisk) validateCount(formats strfmt.Registry) error {
