...
type GetBackupPlanExecutionsConnectionRequestBody struct {
	...
	MarshalOpts *GetBackupPlanExecutionsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetBackupPlanExecutionsConnectionRequestBodyMarshalOpts struct {
...
func (m GetBackupPlanExecutionsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
