...
type NestedAggregateNfsExport struct {
	...
	MarshalOpts *NestedAggregateNfsExportMarshalOpts `json:"-"`
}

type NestedAggregateNfsExportMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateNfsExport) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateNfsExport) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateNfsExport) UnmarshalBinary(b []byte) error {
	var res NestedAggregateNfsExport
