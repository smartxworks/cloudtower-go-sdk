...
type NvmfSubsystemUpdationParams struct {
	...
	MarshalOpts *NvmfSubsystemUpdationParamsMarshalOpts `json:"-"`
}

type NvmfSubsystemUpdationParamsMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	Where_Explicit_Null_When_Empty bool
}

func (m NvmfSubsystemUpdationParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
