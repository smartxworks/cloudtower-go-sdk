...
type IscsiLunSnapshotDeletionParams struct {
	...
	MarshalOpts *IscsiLunSnapshotDeletionParamsMarshalOpts `json:"-"`
}

type IscsiLunSnapshotDeletionParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m IscsiLunSnapshotDeletionParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
