...
type WithTaskDeleteVMPlacementGroup struct {
	...
	MarshalOpts *WithTaskDeleteVMPlacementGroupMarshalOpts `json:"-"`
}

type WithTaskDeleteVMPlacementGroupMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteVMPlacementGroup) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteVMPlacementGroup) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteVMPlacementGroup) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskDeleteVMPlacementGroup) UnmarshalBinary(b []byte) error {
	var res WithTaskDeleteVMPlacementGroup
