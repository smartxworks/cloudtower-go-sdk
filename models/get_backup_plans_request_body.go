...
type GetBackupPlansRequestBody struct {
	...
	MarshalOpts *GetBackupPlansRequestBodyMarshalOpts `json:"-"`
}

type GetBackupPlansRequestBodyMarshalOpts struct {
...
func (m GetBackupPlansRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
