...
type NestedAggregateIscsiConnection struct {
	...
	MarshalOpts *NestedAggregateIscsiConnectionMarshalOpts `json:"-"`
}

type NestedAggregateIscsiConnectionMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateIscsiConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateIscsiConnection) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateIscsiConnection) UnmarshalBinary(b []byte) error {
	var res NestedAggregateIscsiConnection
