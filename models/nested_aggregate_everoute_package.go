...
type NestedAggregateEveroutePackage struct {
	...
	MarshalOpts *NestedAggregateEveroutePackageMarshalOpts `json:"-"`
}

type NestedAggregateEveroutePackageMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateEveroutePackage) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateEveroutePackage) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateEveroutePackage) UnmarshalBinary(b []byte) error {
	var res NestedAggregateEveroutePackage
