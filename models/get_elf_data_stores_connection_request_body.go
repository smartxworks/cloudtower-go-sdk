...
type GetElfDataStoresConnectionRequestBody struct {
	...
	MarshalOpts *GetElfDataStoresConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetElfDataStoresConnectionRequestBodyMarshalOpts struct {
...
func (m GetElfDataStoresConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
