...
type WithTaskDeleteConsistencyGroup struct {
	...
	MarshalOpts *WithTaskDeleteConsistencyGroupMarshalOpts `json:"-"`
}

type WithTaskDeleteConsistencyGroupMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteConsistencyGroup) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteConsistencyGroup) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteConsistencyGroup) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskDeleteConsistencyGroup) UnmarshalBinary(b []byte) error {
	var res WithTaskDeleteConsistencyGroup
