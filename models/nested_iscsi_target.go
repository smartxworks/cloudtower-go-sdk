...
type NestedIscsiTarget struct {
	...
	MarshalOpts *NestedIscsiTargetMarshalOpts `json:"-"`
}

type NestedIscsiTargetMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedIscsiTarget) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedIscsiTarget) validateID(formats strfmt.Registry) error {
...
func (m *NestedIscsiTarget) validateName(formats strfmt.Registry) error {
