...
type DeleteIscsiLunSnapshot struct {
	...
	MarshalOpts *DeleteIscsiLunSnapshotMarshalOpts `json:"-"`
}

type DeleteIscsiLunSnapshotMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteIscsiLunSnapshot) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *DeleteIscsiLunSnapshot) validateID(formats strfmt.Registry) error {
...
func (m *DeleteIscsiLunSnapshot) UnmarshalBinary(b []byte) error {
	var res DeleteIscsiLunSnapshot
