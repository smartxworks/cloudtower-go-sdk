...
type NestedAggregateAlertNotifier struct {
	...
	MarshalOpts *NestedAggregateAlertNotifierMarshalOpts `json:"-"`
}

type NestedAggregateAlertNotifierMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateAlertNotifier) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateAlertNotifier) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateAlertNotifier) UnmarshalBinary(b []byte) error {
	var res NestedAggregateAlertNotifier
