...
type WithTaskDeleteVMFolder struct {
	...
	MarshalOpts *WithTaskDeleteVMFolderMarshalOpts `json:"-"`
}

type WithTaskDeleteVMFolderMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteVMFolder) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteVMFolder) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteVMFolder) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskDeleteVMFolder) UnmarshalBinary(b []byte) error {
	var res WithTaskDeleteVMFolder
