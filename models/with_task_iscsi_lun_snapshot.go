...
type WithTaskIscsiLunSnapshot struct {
	...
	MarshalOpts *WithTaskIscsiLunSnapshotMarshalOpts `json:"-"`
}

type WithTaskIscsiLunSnapshotMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskIscsiLunSnapshot) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskIscsiLunSnapshot) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskIscsiLunSnapshot) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskIscsiLunSnapshot) UnmarshalBinary(b []byte) error {
	var res WithTaskIscsiLunSnapshot
