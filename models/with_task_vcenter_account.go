...
type WithTaskVcenterAccount struct {
	...
	MarshalOpts *WithTaskVcenterAccountMarshalOpts `json:"-"`
}

type WithTaskVcenterAccountMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskVcenterAccount) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskVcenterAccount) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskVcenterAccount) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskVcenterAccount) UnmarshalBinary(b []byte) error {
	var res WithTaskVcenterAccount
