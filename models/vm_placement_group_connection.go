...
type VMPlacementGroupConnection struct {
	...
	MarshalOpts *VMPlacementGroupConnectionMarshalOpts `json:"-"`
}

type VMPlacementGroupConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m VMPlacementGroupConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
