...
type DeleteNvmfSubsystem struct {
	...
	MarshalOpts *DeleteNvmfSubsystemMarshalOpts `json:"-"`
}

type DeleteNvmfSubsystemMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteNvmfSubsystem) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *DeleteNvmfSubsystem) validateID(formats strfmt.Registry) error {
