...
type GraphConnection struct {
	...
	MarshalOpts *GraphConnectionMarshalOpts `json:"-"`
}

type GraphConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m GraphConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GraphConnection) validateAggregate(formats strfmt.Registry) error {
...
func (m *GraphConnection) contextValidateAggregate(ctx context.Context, formats strfmt.Registry) error {
