...
type GetClusterSettingsesConnectionRequestBody struct {
	...
	MarshalOpts *GetClusterSettingsesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetClusterSettingsesConnectionRequestBodyMarshalOpts struct {
...
func (m GetClusterSettingsesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetClusterSettingsesConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetClusterSettingsesConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetClusterSettingsesConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetClusterSettingsesConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
