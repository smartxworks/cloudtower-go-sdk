...
func (m *IscsiTarget) validateUsage(formats strfmt.Registry) error {
...
func (m *IscsiTarget) contextValidateUsage(ctx context.Context, formats strfmt.Registry) error {
