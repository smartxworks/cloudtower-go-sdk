...
type WithTaskClusterSettings struct {
	...
	MarshalOpts *WithTaskClusterSettingsMarshalOpts `json:"-"`
}

type WithTaskClusterSettingsMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskClusterSettings) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskClusterSettings) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskClusterSettings) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskClusterSettings) UnmarshalBinary(b []byte) error {
	var res WithTaskClusterSettings
