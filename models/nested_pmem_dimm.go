...
type NestedPmemDimm struct {
	...
	MarshalOpts *NestedPmemDimmMarshalOpts `json:"-"`
}

type NestedPmemDimmMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedPmemDimm) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedPmemDimm) validateID(formats strfmt.Registry) error {
...
func (m *NestedPmemDimm) validateName(formats strfmt.Registry) error {
