...
type NestedAggregateSvtImage struct {
	...
	MarshalOpts *NestedAggregateSvtImageMarshalOpts `json:"-"`
}

type NestedAggregateSvtImageMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateSvtImage) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateSvtImage) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateSvtImage) UnmarshalBinary(b []byte) error {
	var res NestedAggregateSvtImage
