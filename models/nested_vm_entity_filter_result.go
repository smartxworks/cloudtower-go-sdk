...
type NestedVMEntityFilterResult struct {
	...
	MarshalOpts *NestedVMEntityFilterResultMarshalOpts `json:"-"`
}

type NestedVMEntityFilterResultMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m NestedVMEntityFilterResult) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedVMEntityFilterResult) validateID(formats strfmt.Registry) error {
...
func (m *NestedVMEntityFilterResult) UnmarshalBinary(b []byte) error {
	var res NestedVMEntityFilterResult
