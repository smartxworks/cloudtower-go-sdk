...
func (m *GetNamespaceGroupsConnectionRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetNamespaceGroupsConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetNamespaceGroupsConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetNamespaceGroupsConnectionRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetNamespaceGroupsConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetNamespaceGroupsConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetNamespaceGroupsConnectionRequestBody) UnmarshalBinary(b []byte) error {
	var res GetNamespaceGroupsConnectionRequestBody
