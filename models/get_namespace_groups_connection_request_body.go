...
type GetNamespaceGroupsConnectionRequestBody struct {
	...
	MarshalOpts *GetNamespaceGroupsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetNamespaceGroupsConnectionRequestBodyMarshalOpts struct {
...
func (m GetNamespaceGroupsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
