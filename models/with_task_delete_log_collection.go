...
type WithTaskDeleteLogCollection struct {
	...
	MarshalOpts *WithTaskDeleteLogCollectionMarshalOpts `json:"-"`
}

type WithTaskDeleteLogCollectionMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteLogCollection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteLogCollection) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteLogCollection) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskDeleteLogCollection) UnmarshalBinary(b []byte) error {
	var res WithTaskDeleteLogCollection
