...
type SecurityGroupUpdateParams struct {
	...
	MarshalOpts *SecurityGroupUpdateParamsMarshalOpts `json:"-"`
}

type SecurityGroupUpdateParamsMarshalOpts struct {
...
func (m SecurityGroupUpdateParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
