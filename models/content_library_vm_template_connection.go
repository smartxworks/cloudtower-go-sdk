...
type ContentLibraryVMTemplateConnection struct {
	...
	MarshalOpts *ContentLibraryVMTemplateConnectionMarshalOpts `json:"-"`
}

type ContentLibraryVMTemplateConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m ContentLibraryVMTemplateConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
