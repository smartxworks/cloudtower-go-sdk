...
type GetDeploysConnectionRequestBody struct {
	...
	MarshalOpts *GetDeploysConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetDeploysConnectionRequestBodyMarshalOpts struct {
...
func (m GetDeploysConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
