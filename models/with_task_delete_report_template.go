...
type WithTaskDeleteReportTemplate struct {
	...
	MarshalOpts *WithTaskDeleteReportTemplateMarshalOpts `json:"-"`
}

type WithTaskDeleteReportTemplateMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteReportTemplate) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteReportTemplate) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteReportTemplate) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskDeleteReportTemplate) UnmarshalBinary(b []byte) error {
	var res WithTaskDeleteReportTemplate
