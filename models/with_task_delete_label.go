...
type WithTaskDeleteLabel struct {
	...
	MarshalOpts *WithTaskDeleteLabelMarshalOpts `json:"-"`
}

type WithTaskDeleteLabelMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteLabel) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteLabel) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteLabel) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
