...
type NestedAggregateApplication struct {
	...
	MarshalOpts *NestedAggregateApplicationMarshalOpts `json:"-"`
}

type NestedAggregateApplicationMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateApplication) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateApplication) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateApplication) UnmarshalBinary(b []byte) error {
	var res NestedAggregateApplication
