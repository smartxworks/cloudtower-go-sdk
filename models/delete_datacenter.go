...
type DeleteDatacenter struct {
	...
	MarshalOpts *DeleteDatacenterMarshalOpts `json:"-"`
}

type DeleteDatacenterMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteDatacenter) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *DeleteDatacenter) validateID(formats strfmt.Registry) error {
