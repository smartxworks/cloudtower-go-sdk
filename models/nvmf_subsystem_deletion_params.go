...
type NvmfSubsystemDeletionParams struct {
	...
	MarshalOpts *NvmfSubsystemDeletionParamsMarshalOpts `json:"-"`
}

type NvmfSubsystemDeletionParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m NvmfSubsystemDeletionParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NvmfSubsystemDeletionParams) validateWhere(formats strfmt.Registry) error {
...
func (m *NvmfSubsystemDeletionParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NvmfSubsystemDeletionParams) UnmarshalBinary(b []byte) error {
	var res NvmfSubsystemDeletionParams
