...
type WithTaskDeleteSnmpTrapReceiver struct {
	...
	MarshalOpts *WithTaskDeleteSnmpTrapReceiverMarshalOpts `json:"-"`
}

type WithTaskDeleteSnmpTrapReceiverMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteSnmpTrapReceiver) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteSnmpTrapReceiver) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteSnmpTrapReceiver) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskDeleteSnmpTrapReceiver) UnmarshalBinary(b []byte) error {
	var res WithTaskDeleteSnmpTrapReceiver
