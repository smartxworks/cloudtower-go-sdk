...
type WithTaskDeleteVMVolume struct {
	...
	MarshalOpts *WithTaskDeleteVMVolumeMarshalOpts `json:"-"`
}

type WithTaskDeleteVMVolumeMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteVMVolume) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteVMVolume) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteVMVolume) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskDeleteVMVolume) UnmarshalBinary(b []byte) error {
	var res WithTaskDeleteVMVolume
