...
type VMCloneParams struct {
	...
	MarshalOpts *VMCloneParamsMarshalOpts `json:"-"`
}

type VMCloneParamsMarshalOpts struct {
	...
	SrcVMID_Explicit_Null_When_Empty bool
...
func (m VMCloneParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
	...
	// handle nullable field src_vm_id
	if m.SrcVMID != nil {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"src_vm_id\":")
		bytes, err := swag.WriteJSON(m.SrcVMID)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
		first = false
	} else if m.MarshalOpts != nil && m.MarshalOpts.SrcVMID_Explicit_Null_When_Empty {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"src_vm_id\":null")
		first = false
	}
...
func (m *VMCloneParams) validateHaPriority(formats strfmt.Registry) error {
...
func (m *VMCloneParams) contextValidateHaPriority(ctx context.Context, formats strfmt.Registry) error {
