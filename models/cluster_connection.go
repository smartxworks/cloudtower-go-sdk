...
type ClusterConnection struct {
	...
	MarshalOpts *ClusterConnectionMarshalOpts `json:"-"`
}

type ClusterConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m ClusterConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *ClusterConnection) validateAggregate(formats strfmt.Registry) error {
...
func (m *ClusterConnection) contextValidateAggregate(ctx context.Context, formats strfmt.Registry) error {
