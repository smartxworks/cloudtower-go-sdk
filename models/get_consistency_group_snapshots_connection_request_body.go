...
type GetConsistencyGroupSnapshotsConnectionRequestBody struct {
	...
	MarshalOpts *GetConsistencyGroupSnapshotsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetConsistencyGroupSnapshotsConnectionRequestBodyMarshalOpts struct {
...
func (m GetConsistencyGroupSnapshotsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
