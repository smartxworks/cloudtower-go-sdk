...
type GetClusterUpgradeHistoriesConnectionRequestBody struct {
	...
	MarshalOpts *GetClusterUpgradeHistoriesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetClusterUpgradeHistoriesConnectionRequestBodyMarshalOpts struct {
...
func (m GetClusterUpgradeHistoriesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
