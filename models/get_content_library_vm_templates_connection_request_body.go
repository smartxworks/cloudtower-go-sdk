...
type GetContentLibraryVMTemplatesConnectionRequestBody struct {
	...
	MarshalOpts *GetContentLibraryVMTemplatesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetContentLibraryVMTemplatesConnectionRequestBodyMarshalOpts struct {
...
func (m GetContentLibraryVMTemplatesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
