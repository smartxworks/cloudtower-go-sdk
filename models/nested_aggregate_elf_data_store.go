...
type NestedAggregateElfDataStore struct {
	...
	MarshalOpts *NestedAggregateElfDataStoreMarshalOpts `json:"-"`
}

type NestedAggregateElfDataStoreMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateElfDataStore) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateElfDataStore) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateElfDataStore) UnmarshalBinary(b []byte) error {
	var res NestedAggregateElfDataStore
