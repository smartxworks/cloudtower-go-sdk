...
type NestedAggregateVMSnapshot struct {
	...
	MarshalOpts *NestedAggregateVMSnapshotMarshalOpts `json:"-"`
}

type NestedAggregateVMSnapshotMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateVMSnapshot) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateVMSnapshot) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateVMSnapshot) UnmarshalBinary(b []byte) error {
	var res NestedAggregateVMSnapshot
