...
type NestedNvmfNamespaceSnapshot struct {
	...
	MarshalOpts *NestedNvmfNamespaceSnapshotMarshalOpts `json:"-"`
}

type NestedNvmfNamespaceSnapshotMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedNvmfNamespaceSnapshot) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedNvmfNamespaceSnapshot) validateID(formats strfmt.Registry) error {
...
func (m *NestedNvmfNamespaceSnapshot) validateName(formats strfmt.Registry) error {
...
func (m *NestedNvmfNamespaceSnapshot) UnmarshalBinary(b []byte) error {
	var res NestedNvmfNamespaceSnapshot
