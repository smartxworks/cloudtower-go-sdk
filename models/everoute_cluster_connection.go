...
type EverouteClusterConnection struct {
	...
	MarshalOpts *EverouteClusterConnectionMarshalOpts `json:"-"`
}

type EverouteClusterConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m EverouteClusterConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *EverouteClusterConnection) validateAggregate(formats strfmt.Registry) error {
...
func (m *EverouteClusterConnection) contextValidateAggregate(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EverouteClusterConnection) UnmarshalBinary(b []byte) error {
	var res EverouteClusterConnection
