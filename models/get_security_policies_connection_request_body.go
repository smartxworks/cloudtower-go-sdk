...
type GetSecurityPoliciesConnectionRequestBody struct {
	...
	MarshalOpts *GetSecurityPoliciesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetSecurityPoliciesConnectionRequestBodyMarshalOpts struct {
...
func (m GetSecurityPoliciesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
