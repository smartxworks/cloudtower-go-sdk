...
type WithTaskDeleteSnapshotPlan struct {
	...
	MarshalOpts *WithTaskDeleteSnapshotPlanMarshalOpts `json:"-"`
}

type WithTaskDeleteSnapshotPlanMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteSnapshotPlan) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
