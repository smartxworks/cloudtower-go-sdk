...
type WithTaskDeleteIscsiTarget struct {
	...
	MarshalOpts *WithTaskDeleteIscsiTargetMarshalOpts `json:"-"`
}

type WithTaskDeleteIscsiTargetMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteIscsiTarget) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteIscsiTarget) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteIscsiTarget) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskDeleteIscsiTarget) UnmarshalBinary(b []byte) error {
	var res WithTaskDeleteIscsiTarget
