...
type NestedAggregateSystemAuditLog struct {
	...
	MarshalOpts *NestedAggregateSystemAuditLogMarshalOpts `json:"-"`
}

type NestedAggregateSystemAuditLogMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateSystemAuditLog) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateSystemAuditLog) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateSystemAuditLog) UnmarshalBinary(b []byte) error {
	var res NestedAggregateSystemAuditLog
