...
type WithTaskDeleteSecurityGroup struct {
	...
	MarshalOpts *WithTaskDeleteSecurityGroupMarshalOpts `json:"-"`
}

type WithTaskDeleteSecurityGroupMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteSecurityGroup) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
