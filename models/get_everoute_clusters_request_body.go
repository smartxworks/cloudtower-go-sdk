...
type GetEverouteClustersRequestBody struct {
	...
	MarshalOpts *GetEverouteClustersRequestBodyMarshalOpts `json:"-"`
}

type GetEverouteClustersRequestBodyMarshalOpts struct {
...
func (m GetEverouteClustersRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
