...
type DeleteVirtualPrivateCloudSubnet struct {
	...
	MarshalOpts *DeleteVirtualPrivateCloudSubnetMarshalOpts `json:"-"`
}

type DeleteVirtualPrivateCloudSubnetMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteVirtualPrivateCloudSubnet) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
