...
type WithTaskContentLibraryVMTemplate struct {
	...
	MarshalOpts *WithTaskContentLibraryVMTemplateMarshalOpts `json:"-"`
}

type WithTaskContentLibraryVMTemplateMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskContentLibraryVMTemplate) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
