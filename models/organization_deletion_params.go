...
type OrganizationDeletionParams struct {
	...
	MarshalOpts *OrganizationDeletionParamsMarshalOpts `json:"-"`
}

type OrganizationDeletionParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m OrganizationDeletionParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *OrganizationDeletionParams) validateWhere(formats strfmt.Registry) error {
...
func (m *OrganizationDeletionParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrganizationDeletionParams) UnmarshalBinary(b []byte) error {
	var res OrganizationDeletionParams
