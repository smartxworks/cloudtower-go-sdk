...
type WithTaskGlobalSettings struct {
	...
	MarshalOpts *WithTaskGlobalSettingsMarshalOpts `json:"-"`
}

type WithTaskGlobalSettingsMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskGlobalSettings) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskGlobalSettings) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskGlobalSettings) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskGlobalSettings) UnmarshalBinary(b []byte) error {
	var res WithTaskGlobalSettings
