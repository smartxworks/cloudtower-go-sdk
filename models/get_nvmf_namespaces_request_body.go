...
type GetNvmfNamespacesRequestBody struct {
	...
	MarshalOpts *GetNvmfNamespacesRequestBodyMarshalOpts `json:"-"`
}

type GetNvmfNamespacesRequestBodyMarshalOpts struct {
...
func (m GetNvmfNamespacesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
