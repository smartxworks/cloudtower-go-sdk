...
type GetBackupTargetExecutionsRequestBody struct {
	...
	MarshalOpts *GetBackupTargetExecutionsRequestBodyMarshalOpts `json:"-"`
}

type GetBackupTargetExecutionsRequestBodyMarshalOpts struct {
...
func (m GetBackupTargetExecutionsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
