...
type GetVMFoldersRequestBody struct {
	...
	MarshalOpts *GetVMFoldersRequestBodyMarshalOpts `json:"-"`
}

type GetVMFoldersRequestBodyMarshalOpts struct {
...
func (m GetVMFoldersRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
