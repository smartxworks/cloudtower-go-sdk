...
type NestedClusterTopo struct {
	...
	MarshalOpts *NestedClusterTopoMarshalOpts `json:"-"`
}

type NestedClusterTopoMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedClusterTopo) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedClusterTopo) validateID(formats strfmt.Registry) error {
...
func (m *NestedClusterTopo) validateName(formats strfmt.Registry) error {
