...
type GetUsersConnectionRequestBody struct {
	...
	MarshalOpts *GetUsersConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetUsersConnectionRequestBodyMarshalOpts struct {
...
func (m GetUsersConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
