...
type WithTaskDatacenter struct {
	...
	MarshalOpts *WithTaskDatacenterMarshalOpts `json:"-"`
}

type WithTaskDatacenterMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDatacenter) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDatacenter) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDatacenter) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
