...
type GetVMFoldersConnectionRequestBody struct {
	...
	MarshalOpts *GetVMFoldersConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetVMFoldersConnectionRequestBodyMarshalOpts struct {
...
func (m GetVMFoldersConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
