...
type WithTaskDeleteVMTemplate struct {
	...
	MarshalOpts *WithTaskDeleteVMTemplateMarshalOpts `json:"-"`
}

type WithTaskDeleteVMTemplateMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteVMTemplate) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteVMTemplate) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteVMTemplate) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskDeleteVMTemplate) UnmarshalBinary(b []byte) error {
	var res WithTaskDeleteVMTemplate
