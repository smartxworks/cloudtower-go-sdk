...
type WithTaskDeleteNvmfNamespace struct {
	...
	MarshalOpts *WithTaskDeleteNvmfNamespaceMarshalOpts `json:"-"`
}

type WithTaskDeleteNvmfNamespaceMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteNvmfNamespace) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteNvmfNamespace) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteNvmfNamespace) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskDeleteNvmfNamespace) UnmarshalBinary(b []byte) error {
	var res WithTaskDeleteNvmfNamespace
