...
type NfsExportDeletionParams struct {
	...
	MarshalOpts *NfsExportDeletionParamsMarshalOpts `json:"-"`
}

type NfsExportDeletionParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m NfsExportDeletionParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NfsExportDeletionParams) validateWhere(formats strfmt.Registry) error {
...
func (m *NfsExportDeletionParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NfsExportDeletionParams) UnmarshalBinary(b []byte) error {
	var res NfsExportDeletionParams
