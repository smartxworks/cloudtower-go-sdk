...
type NestedAggregateReportTemplate struct {
	...
	MarshalOpts *NestedAggregateReportTemplateMarshalOpts `json:"-"`
}

type NestedAggregateReportTemplateMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateReportTemplate) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateReportTemplate) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateReportTemplate) UnmarshalBinary(b []byte) error {
	var res NestedAggregateReportTemplate
