...
func (m *GetSystemAuditLogsRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetSystemAuditLogsRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetSystemAuditLogsRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetSystemAuditLogsRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetSystemAuditLogsRequestBody) UnmarshalBinary(b []byte) error {
	var res GetSystemAuditLogsRequestBody
