...
type GetSystemAuditLogsRequestBody struct {
	...
	MarshalOpts *GetSystemAuditLogsRequestBodyMarshalOpts `json:"-"`
}

type GetSystemAuditLogsRequestBodyMarshalOpts struct {
...
func (m GetSystemAuditLogsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
