...
type WithTaskDeleteClusterRecycleBin struct {
	...
	MarshalOpts *WithTaskDeleteClusterRecycleBinMarshalOpts `json:"-"`
}

type WithTaskDeleteClusterRecycleBinMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteClusterRecycleBin) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskDeleteClusterRecycleBin) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *WithTaskDeleteClusterRecycleBin) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskDeleteClusterRecycleBin) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskDeleteClusterRecycleBin) UnmarshalBinary(b []byte) error {
	var res WithTaskDeleteClusterRecycleBin
