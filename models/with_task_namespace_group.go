...
type WithTaskNamespaceGroup struct {
	...
	MarshalOpts *WithTaskNamespaceGroupMarshalOpts `json:"-"`
}

type WithTaskNamespaceGroupMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskNamespaceGroup) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskNamespaceGroup) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskNamespaceGroup) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskNamespaceGroup) UnmarshalBinary(b []byte) error {
	var res WithTaskNamespaceGroup
