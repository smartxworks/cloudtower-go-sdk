...
type GetLogCollectionsConnectionRequestBody struct {
	...
	MarshalOpts *GetLogCollectionsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetLogCollectionsConnectionRequestBodyMarshalOpts struct {
...
func (m GetLogCollectionsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
