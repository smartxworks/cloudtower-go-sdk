...
type GetBackupPlansConnectionRequestBody struct {
	...
	MarshalOpts *GetBackupPlansConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetBackupPlansConnectionRequestBodyMarshalOpts struct {
...
func (m GetBackupPlansConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetBackupPlansConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetBackupPlansConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
// ContextValidate validate this get backup plans connection request body based on the context it is used
...
func (m *GetBackupPlansConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetBackupPlansConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
