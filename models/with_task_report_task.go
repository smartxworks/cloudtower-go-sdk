...
type WithTaskReportTask struct {
	...
	MarshalOpts *WithTaskReportTaskMarshalOpts `json:"-"`
}

type WithTaskReportTaskMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskReportTask) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskReportTask) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskReportTask) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
