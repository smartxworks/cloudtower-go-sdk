...
type GetHostsConnectionRequestBody struct {
	...
	MarshalOpts *GetHostsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetHostsConnectionRequestBodyMarshalOpts struct {
...
func (m GetHostsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
