...
type GetConsistencyGroupsRequestBody struct {
	...
	MarshalOpts *GetConsistencyGroupsRequestBodyMarshalOpts `json:"-"`
}

type GetConsistencyGroupsRequestBodyMarshalOpts struct {
...
func (m GetConsistencyGroupsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
