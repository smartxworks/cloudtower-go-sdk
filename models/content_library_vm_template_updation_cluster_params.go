...
type ContentLibraryVMTemplateUpdationClusterParams struct {
	...
	MarshalOpts *ContentLibraryVMTemplateUpdationClusterParamsMarshalOpts `json:"-"`
}

type ContentLibraryVMTemplateUpdationClusterParamsMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	Where_Explicit_Null_When_Empty bool
}

func (m ContentLibraryVMTemplateUpdationClusterParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
