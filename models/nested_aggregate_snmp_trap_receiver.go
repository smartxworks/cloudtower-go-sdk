...
type NestedAggregateSnmpTrapReceiver struct {
	...
	MarshalOpts *NestedAggregateSnmpTrapReceiverMarshalOpts `json:"-"`
}

type NestedAggregateSnmpTrapReceiverMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateSnmpTrapReceiver) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateSnmpTrapReceiver) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NestedAggregateSnmpTrapReceiver) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateSnmpTrapReceiver) UnmarshalBinary(b []byte) error {
	var res NestedAggregateSnmpTrapReceiver
