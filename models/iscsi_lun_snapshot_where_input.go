...
type IscsiLunSnapshotWhereInput struct {
	...
	MarshalOpts *IscsiLunSnapshotWhereInputMarshalOpts `json:"-"`
}

type IscsiLunSnapshotWhereInputMarshalOpts struct {
...
func (m IscsiLunSnapshotWhereInput) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
