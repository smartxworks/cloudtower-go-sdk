...
type DeleteElfImage struct {
	...
	MarshalOpts *DeleteElfImageMarshalOpts `json:"-"`
}

type DeleteElfImageMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteElfImage) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *DeleteElfImage) validateID(formats strfmt.Registry) error {
