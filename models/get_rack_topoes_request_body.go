...
type GetRackTopoesRequestBody struct {
	...
	MarshalOpts *GetRackTopoesRequestBodyMarshalOpts `json:"-"`
}

type GetRackTopoesRequestBodyMarshalOpts struct {
...
func (m GetRackTopoesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetRackTopoesRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetRackTopoesRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetRackTopoesRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetRackTopoesRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetRackTopoesRequestBody) UnmarshalBinary(b []byte) error {
	var res GetRackTopoesRequestBody
