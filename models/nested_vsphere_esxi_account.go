...
type NestedVsphereEsxiAccount struct {
	...
	MarshalOpts *NestedVsphereEsxiAccountMarshalOpts `json:"-"`
}

type NestedVsphereEsxiAccountMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m NestedVsphereEsxiAccount) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
