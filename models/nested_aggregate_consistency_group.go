...
type NestedAggregateConsistencyGroup struct {
	...
	MarshalOpts *NestedAggregateConsistencyGroupMarshalOpts `json:"-"`
}

type NestedAggregateConsistencyGroupMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateConsistencyGroup) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateConsistencyGroup) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NestedAggregateConsistencyGroup) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateConsistencyGroup) UnmarshalBinary(b []byte) error {
	var res NestedAggregateConsistencyGroup
