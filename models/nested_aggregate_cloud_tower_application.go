...
type NestedAggregateCloudTowerApplication struct {
	...
	MarshalOpts *NestedAggregateCloudTowerApplicationMarshalOpts `json:"-"`
}

type NestedAggregateCloudTowerApplicationMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateCloudTowerApplication) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateCloudTowerApplication) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NestedAggregateCloudTowerApplication) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateCloudTowerApplication) UnmarshalBinary(b []byte) error {
	var res NestedAggregateCloudTowerApplication
