...
type GetClusterUpgradeHistoriesRequestBody struct {
	...
	MarshalOpts *GetClusterUpgradeHistoriesRequestBodyMarshalOpts `json:"-"`
}

type GetClusterUpgradeHistoriesRequestBodyMarshalOpts struct {
...
func (m GetClusterUpgradeHistoriesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
