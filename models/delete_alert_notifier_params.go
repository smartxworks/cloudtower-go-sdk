...
type DeleteAlertNotifierParams struct {
	...
	MarshalOpts *DeleteAlertNotifierParamsMarshalOpts `json:"-"`
}

type DeleteAlertNotifierParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m DeleteAlertNotifierParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *DeleteAlertNotifierParams) validateWhere(formats strfmt.Registry) error {
...
func (m *DeleteAlertNotifierParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeleteAlertNotifierParams) UnmarshalBinary(b []byte) error {
	var res DeleteAlertNotifierParams
