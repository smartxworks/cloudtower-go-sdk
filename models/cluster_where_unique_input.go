...
type ClusterWhereUniqueInput struct {
	...
	MarshalOpts *ClusterWhereUniqueInputMarshalOpts `json:"-"`
}

type ClusterWhereUniqueInputMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	LocalID_Explicit_Null_When_Empty bool
}

func (m ClusterWhereUniqueInput) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
