...
type NvmfNamespaceSnapshotDeletionParams struct {
	...
	MarshalOpts *NvmfNamespaceSnapshotDeletionParamsMarshalOpts `json:"-"`
}

type NvmfNamespaceSnapshotDeletionParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m NvmfNamespaceSnapshotDeletionParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NvmfNamespaceSnapshotDeletionParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NvmfNamespaceSnapshotDeletionParams) validateWhere(formats strfmt.Registry) error {
...
func (m *NvmfNamespaceSnapshotDeletionParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NvmfNamespaceSnapshotDeletionParams) UnmarshalBinary(b []byte) error {
	var res NvmfNamespaceSnapshotDeletionParams
