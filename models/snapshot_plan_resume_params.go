...
type SnapshotPlanResumeParams struct {
	...
	MarshalOpts *SnapshotPlanResumeParamsMarshalOpts `json:"-"`
}

type SnapshotPlanResumeParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m SnapshotPlanResumeParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *SnapshotPlanResumeParams) validateWhere(formats strfmt.Registry) error {
...
func (m *SnapshotPlanResumeParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SnapshotPlanResumeParams) UnmarshalBinary(b []byte) error {
	var res SnapshotPlanResumeParams
