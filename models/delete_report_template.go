...
type DeleteReportTemplate struct {
	...
	MarshalOpts *DeleteReportTemplateMarshalOpts `json:"-"`
}

type DeleteReportTemplateMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteReportTemplate) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *DeleteReportTemplate) validateID(formats strfmt.Registry) error {
