...
type ContentLibraryImageDeletionParams struct {
	...
	MarshalOpts *ContentLibraryImageDeletionParamsMarshalOpts `json:"-"`
}

type ContentLibraryImageDeletionParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m ContentLibraryImageDeletionParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
