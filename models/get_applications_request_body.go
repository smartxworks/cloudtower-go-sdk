...
type GetApplicationsRequestBody struct {
	...
	MarshalOpts *GetApplicationsRequestBodyMarshalOpts `json:"-"`
}

type GetApplicationsRequestBodyMarshalOpts struct {
...
func (m GetApplicationsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
