...
type GetVcenterAccountsRequestBody struct {
	...
	MarshalOpts *GetVcenterAccountsRequestBodyMarshalOpts `json:"-"`
}

type GetVcenterAccountsRequestBodyMarshalOpts struct {
...
func (m GetVcenterAccountsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
