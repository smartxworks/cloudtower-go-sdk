...
type EverouteLicenseConnection struct {
	...
	MarshalOpts *EverouteLicenseConnectionMarshalOpts `json:"-"`
}

type EverouteLicenseConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m EverouteLicenseConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *EverouteLicenseConnection) validateAggregate(formats strfmt.Registry) error {
...
func (m *EverouteLicenseConnection) contextValidateAggregate(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EverouteLicenseConnection) UnmarshalBinary(b []byte) error {
	var res EverouteLicenseConnection
