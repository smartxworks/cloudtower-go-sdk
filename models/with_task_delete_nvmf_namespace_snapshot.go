...
type WithTaskDeleteNvmfNamespaceSnapshot struct {
	...
	MarshalOpts *WithTaskDeleteNvmfNamespaceSnapshotMarshalOpts `json:"-"`
}

type WithTaskDeleteNvmfNamespaceSnapshotMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteNvmfNamespaceSnapshot) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
