...
type GetSnmpTrapReceiversRequestBody struct {
	...
	MarshalOpts *GetSnmpTrapReceiversRequestBodyMarshalOpts `json:"-"`
}

type GetSnmpTrapReceiversRequestBodyMarshalOpts struct {
...
func (m GetSnmpTrapReceiversRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
