...
type DeleteBrickTopo struct {
	...
	MarshalOpts *DeleteBrickTopoMarshalOpts `json:"-"`
}

type DeleteBrickTopoMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteBrickTopo) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *DeleteBrickTopo) validateID(formats strfmt.Registry) error {
