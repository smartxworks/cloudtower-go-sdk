...
type NestedAggregateAlertRule struct {
	...
	MarshalOpts *NestedAggregateAlertRuleMarshalOpts `json:"-"`
}

type NestedAggregateAlertRuleMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateAlertRule) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateAlertRule) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateAlertRule) UnmarshalBinary(b []byte) error {
	var res NestedAggregateAlertRule
