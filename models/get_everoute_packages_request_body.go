...
type GetEveroutePackagesRequestBody struct {
	...
	MarshalOpts *GetEveroutePackagesRequestBodyMarshalOpts `json:"-"`
}

type GetEveroutePackagesRequestBodyMarshalOpts struct {
...
func (m GetEveroutePackagesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetEveroutePackagesRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetEveroutePackagesRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetEveroutePackagesRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetEveroutePackagesRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
