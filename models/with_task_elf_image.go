...
type WithTaskElfImage struct {
	...
	MarshalOpts *WithTaskElfImageMarshalOpts `json:"-"`
}

type WithTaskElfImageMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskElfImage) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskElfImage) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskElfImage) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
