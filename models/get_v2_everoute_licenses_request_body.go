...
// GetV2EverouteLicensesRequestBody get v2 everoute licenses request body
//
// swagger:model GetV2EverouteLicensesRequestBody
type GetV2EverouteLicensesRequestBody struct {
	...
	MarshalOpts *GetV2EverouteLicensesRequestBodyMarshalOpts `json:"-"`
}

type GetV2EverouteLicensesRequestBodyMarshalOpts struct {
...
func (m GetV2EverouteLicensesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
// Validate validates this get v2 everoute licenses request body
func (m *GetV2EverouteLicensesRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetV2EverouteLicensesRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetV2EverouteLicensesRequestBody) validateWhere(formats strfmt.Registry) error {
...
// ContextValidate validate this get v2 everoute licenses request body based on the context it is used
func (m *GetV2EverouteLicensesRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetV2EverouteLicensesRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetV2EverouteLicensesRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetV2EverouteLicensesRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetV2EverouteLicensesRequestBody) UnmarshalBinary(b []byte) error {
	var res GetV2EverouteLicensesRequestBody
