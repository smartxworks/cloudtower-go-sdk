...
type WithTaskSecurityGroup struct {
	...
	MarshalOpts *WithTaskSecurityGroupMarshalOpts `json:"-"`
}

type WithTaskSecurityGroupMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskSecurityGroup) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskSecurityGroup) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskSecurityGroup) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
