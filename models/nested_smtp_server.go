...
type NestedSMTPServer struct {
	...
	MarshalOpts *NestedSMTPServerMarshalOpts `json:"-"`
}

type NestedSMTPServerMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedSMTPServer) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedSMTPServer) validateID(formats strfmt.Registry) error {
...
func (m *NestedSMTPServer) validateName(formats strfmt.Registry) error {
