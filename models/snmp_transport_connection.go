...
type SnmpTransportConnection struct {
	...
	MarshalOpts *SnmpTransportConnectionMarshalOpts `json:"-"`
}

type SnmpTransportConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m SnmpTransportConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
