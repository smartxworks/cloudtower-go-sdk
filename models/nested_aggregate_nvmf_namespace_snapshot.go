...
type NestedAggregateNvmfNamespaceSnapshot struct {
	...
	MarshalOpts *NestedAggregateNvmfNamespaceSnapshotMarshalOpts `json:"-"`
}

type NestedAggregateNvmfNamespaceSnapshotMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateNvmfNamespaceSnapshot) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateNvmfNamespaceSnapshot) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NestedAggregateNvmfNamespaceSnapshot) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateNvmfNamespaceSnapshot) UnmarshalBinary(b []byte) error {
	var res NestedAggregateNvmfNamespaceSnapshot
