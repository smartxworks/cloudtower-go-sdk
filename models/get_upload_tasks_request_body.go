...
type GetUploadTasksRequestBody struct {
	...
	MarshalOpts *GetUploadTasksRequestBodyMarshalOpts `json:"-"`
}

type GetUploadTasksRequestBodyMarshalOpts struct {
...
func (m GetUploadTasksRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
