...
type GetBackupTargetExecutionsConnectionRequestBody struct {
	...
	MarshalOpts *GetBackupTargetExecutionsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetBackupTargetExecutionsConnectionRequestBodyMarshalOpts struct {
...
func (m GetBackupTargetExecutionsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
