...
type DeleteConsistencyGroup struct {
	...
	MarshalOpts *DeleteConsistencyGroupMarshalOpts `json:"-"`
}

type DeleteConsistencyGroupMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteConsistencyGroup) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *DeleteConsistencyGroup) validateID(formats strfmt.Registry) error {
...
func (m *DeleteConsistencyGroup) UnmarshalBinary(b []byte) error {
	var res DeleteConsistencyGroup
