...
type NestedAggregateElfImage struct {
	...
	MarshalOpts *NestedAggregateElfImageMarshalOpts `json:"-"`
}

type NestedAggregateElfImageMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateElfImage) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateElfImage) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateElfImage) UnmarshalBinary(b []byte) error {
	var res NestedAggregateElfImage
