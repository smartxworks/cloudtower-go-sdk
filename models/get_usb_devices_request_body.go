...
type GetUsbDevicesRequestBody struct {
	...
	MarshalOpts *GetUsbDevicesRequestBodyMarshalOpts `json:"-"`
}

type GetUsbDevicesRequestBodyMarshalOpts struct {
...
func (m GetUsbDevicesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
