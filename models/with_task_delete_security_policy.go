...
type WithTaskDeleteSecurityPolicy struct {
	...
	MarshalOpts *WithTaskDeleteSecurityPolicyMarshalOpts `json:"-"`
}

type WithTaskDeleteSecurityPolicyMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteSecurityPolicy) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
