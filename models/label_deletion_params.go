...
type LabelDeletionParams struct {
	...
	MarshalOpts *LabelDeletionParamsMarshalOpts `json:"-"`
}

type LabelDeletionParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m LabelDeletionParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *LabelDeletionParams) validateWhere(formats strfmt.Registry) error {
...
func (m *LabelDeletionParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
