...
type ReportTemplateConnection struct {
	...
	MarshalOpts *ReportTemplateConnectionMarshalOpts `json:"-"`
}

type ReportTemplateConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m ReportTemplateConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
