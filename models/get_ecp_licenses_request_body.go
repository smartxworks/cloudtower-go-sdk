...
// GetEcpLicensesRequestBody get ecp licenses request body
//
// swagger:model GetEcpLicensesRequestBody
type GetEcpLicensesRequestBody struct {
	...
	MarshalOpts *GetEcpLicensesRequestBodyMarshalOpts `json:"-"`
}

type GetEcpLicensesRequestBodyMarshalOpts struct {
...
func (m GetEcpLicensesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
// Validate validates this get ecp licenses request body
func (m *GetEcpLicensesRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetEcpLicensesRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetEcpLicensesRequestBody) validateWhere(formats strfmt.Registry) error {
...
// ContextValidate validate this get ecp licenses request body based on the context it is used
func (m *GetEcpLicensesRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetEcpLicensesRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetEcpLicensesRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetEcpLicensesRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetEcpLicensesRequestBody) UnmarshalBinary(b []byte) error {
	var res GetEcpLicensesRequestBody
