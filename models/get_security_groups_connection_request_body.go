...
type GetSecurityGroupsConnectionRequestBody struct {
	...
	MarshalOpts *GetSecurityGroupsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetSecurityGroupsConnectionRequestBodyMarshalOpts struct {
...
func (m GetSecurityGroupsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetSecurityGroupsConnectionRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetSecurityGroupsConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetSecurityGroupsConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetSecurityGroupsConnectionRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetSecurityGroupsConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetSecurityGroupsConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetSecurityGroupsConnectionRequestBody) UnmarshalBinary(b []byte) error {
	var res GetSecurityGroupsConnectionRequestBody
