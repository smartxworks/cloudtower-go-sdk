...
type WithTaskConsistencyGroup struct {
	...
	MarshalOpts *WithTaskConsistencyGroupMarshalOpts `json:"-"`
}

type WithTaskConsistencyGroupMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskConsistencyGroup) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskConsistencyGroup) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskConsistencyGroup) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskConsistencyGroup) UnmarshalBinary(b []byte) error {
	var res WithTaskConsistencyGroup
