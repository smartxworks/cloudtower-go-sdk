...
type IscsiLunSnapshot struct {
	...
	MarshalOpts *IscsiLunSnapshotMarshalOpts `json:"-"`
}
...
func (m IscsiLunSnapshot) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *IscsiLunSnapshot) validateResiliencyType(formats strfmt.Registry) error {
...
func (m *IscsiLunSnapshot) contextValidateResiliencyType(ctx context.Context, formats strfmt.Registry) error {
