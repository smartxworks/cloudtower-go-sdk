...
type WithTaskGlobalAlertRule struct {
	...
	MarshalOpts *WithTaskGlobalAlertRuleMarshalOpts `json:"-"`
}

type WithTaskGlobalAlertRuleMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskGlobalAlertRule) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskGlobalAlertRule) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskGlobalAlertRule) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskGlobalAlertRule) UnmarshalBinary(b []byte) error {
	var res WithTaskGlobalAlertRule
