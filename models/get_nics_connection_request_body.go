...
type GetNicsConnectionRequestBody struct {
	...
	MarshalOpts *GetNicsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetNicsConnectionRequestBodyMarshalOpts struct {
...
func (m GetNicsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
