...
type GetSecurityGroupsRequestBody struct {
	...
	MarshalOpts *GetSecurityGroupsRequestBodyMarshalOpts `json:"-"`
}

type GetSecurityGroupsRequestBodyMarshalOpts struct {
...
func (m GetSecurityGroupsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetSecurityGroupsRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetSecurityGroupsRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetSecurityGroupsRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetSecurityGroupsRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetSecurityGroupsRequestBody) UnmarshalBinary(b []byte) error {
	var res GetSecurityGroupsRequestBody
