...
type GetNfsInodesConnectionRequestBody struct {
	...
	MarshalOpts *GetNfsInodesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetNfsInodesConnectionRequestBodyMarshalOpts struct {
...
func (m GetNfsInodesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
