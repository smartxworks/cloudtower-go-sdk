...
type SystemAuditLogConnection struct {
	...
	MarshalOpts *SystemAuditLogConnectionMarshalOpts `json:"-"`
}

type SystemAuditLogConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m SystemAuditLogConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
