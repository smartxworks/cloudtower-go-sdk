...
type GetNodeTopoesConnectionRequestBody struct {
	...
	MarshalOpts *GetNodeTopoesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetNodeTopoesConnectionRequestBodyMarshalOpts struct {
...
func (m GetNodeTopoesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
