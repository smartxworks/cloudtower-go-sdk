...
type GetSecurityPoliciesRequestBody struct {
	...
	MarshalOpts *GetSecurityPoliciesRequestBodyMarshalOpts `json:"-"`
}

type GetSecurityPoliciesRequestBodyMarshalOpts struct {
...
func (m GetSecurityPoliciesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
