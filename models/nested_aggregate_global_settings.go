...
type NestedAggregateGlobalSettings struct {
	...
	MarshalOpts *NestedAggregateGlobalSettingsMarshalOpts `json:"-"`
}

type NestedAggregateGlobalSettingsMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateGlobalSettings) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateGlobalSettings) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateGlobalSettings) UnmarshalBinary(b []byte) error {
	var res NestedAggregateGlobalSettings
