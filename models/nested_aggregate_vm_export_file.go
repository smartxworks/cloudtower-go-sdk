...
type NestedAggregateVMExportFile struct {
	...
	MarshalOpts *NestedAggregateVMExportFileMarshalOpts `json:"-"`
}

type NestedAggregateVMExportFileMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateVMExportFile) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateVMExportFile) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateVMExportFile) UnmarshalBinary(b []byte) error {
	var res NestedAggregateVMExportFile
