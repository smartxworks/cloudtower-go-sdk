...
type GetVmsConnectionRequestBody struct {
	...
	MarshalOpts *GetVmsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetVmsConnectionRequestBodyMarshalOpts struct {
...
func (m GetVmsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
