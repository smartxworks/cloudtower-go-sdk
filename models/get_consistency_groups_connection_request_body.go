...
type GetConsistencyGroupsConnectionRequestBody struct {
	...
	MarshalOpts *GetConsistencyGroupsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetConsistencyGroupsConnectionRequestBodyMarshalOpts struct {
...
func (m GetConsistencyGroupsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
