...
type DeleteVMFolder struct {
	...
	MarshalOpts *DeleteVMFolderMarshalOpts `json:"-"`
}

type DeleteVMFolderMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteVMFolder) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *DeleteVMFolder) validateID(formats strfmt.Registry) error {
