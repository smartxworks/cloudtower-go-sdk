...
type GetVMExportFilesRequestBody struct {
	...
	MarshalOpts *GetVMExportFilesRequestBodyMarshalOpts `json:"-"`
}

type GetVMExportFilesRequestBodyMarshalOpts struct {
...
func (m GetVMExportFilesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetVMExportFilesRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetVMExportFilesRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetVMExportFilesRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetVMExportFilesRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetVMExportFilesRequestBody) UnmarshalBinary(b []byte) error {
	var res GetVMExportFilesRequestBody
