...
type GetMetaLeaderRequestBody struct {
	...
	MarshalOpts *GetMetaLeaderRequestBodyMarshalOpts `json:"-"`
}

type GetMetaLeaderRequestBodyMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m GetMetaLeaderRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetMetaLeaderRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetMetaLeaderRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetMetaLeaderRequestBody) UnmarshalBinary(b []byte) error {
	var res GetMetaLeaderRequestBody
