...
type WithTaskTask struct {
	...
	MarshalOpts *WithTaskTaskMarshalOpts `json:"-"`
}

type WithTaskTaskMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskTask) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskTask) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskTask) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
