...
type GetApplicationsConnectionRequestBody struct {
	...
	MarshalOpts *GetApplicationsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetApplicationsConnectionRequestBodyMarshalOpts struct {
...
func (m GetApplicationsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
