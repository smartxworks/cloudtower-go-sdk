...
type NestedAggregateTask struct {
	...
	MarshalOpts *NestedAggregateTaskMarshalOpts `json:"-"`
}

type NestedAggregateTaskMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateTask) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateTask) validateCount(formats strfmt.Registry) error {
