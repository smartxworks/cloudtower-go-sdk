...
type GetVMVolumeSnapshotsRequestBody struct {
	...
	MarshalOpts *GetVMVolumeSnapshotsRequestBodyMarshalOpts `json:"-"`
}

type GetVMVolumeSnapshotsRequestBodyMarshalOpts struct {
...
func (m GetVMVolumeSnapshotsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
