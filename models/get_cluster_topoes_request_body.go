...
type GetClusterTopoesRequestBody struct {
	...
	MarshalOpts *GetClusterTopoesRequestBodyMarshalOpts `json:"-"`
}

type GetClusterTopoesRequestBodyMarshalOpts struct {
...
func (m GetClusterTopoesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
