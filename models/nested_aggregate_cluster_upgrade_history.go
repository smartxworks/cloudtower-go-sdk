...
type NestedAggregateClusterUpgradeHistory struct {
	...
	MarshalOpts *NestedAggregateClusterUpgradeHistoryMarshalOpts `json:"-"`
}

type NestedAggregateClusterUpgradeHistoryMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateClusterUpgradeHistory) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateClusterUpgradeHistory) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NestedAggregateClusterUpgradeHistory) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateClusterUpgradeHistory) UnmarshalBinary(b []byte) error {
	var res NestedAggregateClusterUpgradeHistory
