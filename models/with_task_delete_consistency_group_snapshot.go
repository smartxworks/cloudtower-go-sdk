...
type WithTaskDeleteConsistencyGroupSnapshot struct {
	...
	MarshalOpts *WithTaskDeleteConsistencyGroupSnapshotMarshalOpts `json:"-"`
}

type WithTaskDeleteConsistencyGroupSnapshotMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteConsistencyGroupSnapshot) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
