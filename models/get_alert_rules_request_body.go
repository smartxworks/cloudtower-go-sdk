...
type GetAlertRulesRequestBody struct {
	...
	MarshalOpts *GetAlertRulesRequestBodyMarshalOpts `json:"-"`
}

type GetAlertRulesRequestBodyMarshalOpts struct {
...
func (m GetAlertRulesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
