...
type NvmfSubsystemConnection struct {
	...
	MarshalOpts *NvmfSubsystemConnectionMarshalOpts `json:"-"`
}

type NvmfSubsystemConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m NvmfSubsystemConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
