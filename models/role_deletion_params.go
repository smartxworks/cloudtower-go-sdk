...
type RoleDeletionParams struct {
	...
	MarshalOpts *RoleDeletionParamsMarshalOpts `json:"-"`
}

type RoleDeletionParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m RoleDeletionParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *RoleDeletionParams) validateWhere(formats strfmt.Registry) error {
...
func (m *RoleDeletionParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
