...
type GetGlobalSettingsesConnectionRequestBody struct {
	...
	MarshalOpts *GetGlobalSettingsesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetGlobalSettingsesConnectionRequestBodyMarshalOpts struct {
...
func (m GetGlobalSettingsesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
