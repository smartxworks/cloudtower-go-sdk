...
type DeleteEntityFilter struct {
	...
	MarshalOpts *DeleteEntityFilterMarshalOpts `json:"-"`
}

type DeleteEntityFilterMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool
}

func (m DeleteEntityFilter) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *DeleteEntityFilter) validateID(formats strfmt.Registry) error {
