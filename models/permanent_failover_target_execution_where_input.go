...
type PermanentFailoverTargetExecutionWhereInput struct {
	...
	// keep test vm
	KeepTestVM *bool `json:"keep_test_vm,omitempty"`

	// keep test vm not
	KeepTestVMNot *bool `json:"keep_test_vm_not,omitempty"`
...
type PermanentFailoverTargetExecutionWhereInputMarshalOpts struct {
	...
	KeepTestVM_Explicit_Null_When_Empty bool

	KeepTestVMNot_Explicit_Null_When_Empty bool
...
func (m PermanentFailoverTargetExecutionWhereInput) MarshalJSON() ([]byte, error) {
	...
	// handle nullable field keep_test_vm
	if m.KeepTestVM != nil {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"keep_test_vm\":")
		bytes, err := swag.WriteJSON(m.KeepTestVM)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
		first = false
	} else if m.MarshalOpts != nil && m.MarshalOpts.KeepTestVM_Explicit_Null_When_Empty {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"keep_test_vm\":null")
		first = false
	}

	// handle nullable field keep_test_vm_not
	if m.KeepTestVMNot != nil {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"keep_test_vm_not\":")
		bytes, err := swag.WriteJSON(m.KeepTestVMNot)
		if err != nil {
			return nil, err
		}
		b.Write(bytes)
		first = false
	} else if m.MarshalOpts != nil && m.MarshalOpts.KeepTestVMNot_Explicit_Null_When_Empty {
		if !first {
			b.WriteString(",")
		}
		b.WriteString("\"keep_test_vm_not\":null")
		first = false
	}
