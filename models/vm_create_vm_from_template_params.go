...
type VMCreateVMFromTemplateParams struct {
	...
	MarshalOpts *VMCreateVMFromTemplateParamsMarshalOpts `json:"-"`
}

type VMCreateVMFromTemplateParamsMarshalOpts struct {
...
func (m VMCreateVMFromTemplateParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *VMCreateVMFromTemplateParams) validateGpuDevices(formats strfmt.Registry) error {
...
func (m *VMCreateVMFromTemplateParams) validateHaPriority(formats strfmt.Registry) error {
...
func (m *VMCreateVMFromTemplateParams) validateVMPlacementGroup(formats strfmt.Registry) error {
...
func (m *VMCreateVMFromTemplateParams) contextValidateGpuDevices(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VMCreateVMFromTemplateParams) contextValidateHaPriority(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VMCreateVMFromTemplateParams) contextValidatePciNics(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VMCreateVMFromTemplateParams) contextValidateVMPlacementGroup(ctx context.Context, formats strfmt.Registry) error {
