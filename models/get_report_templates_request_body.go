...
type GetReportTemplatesRequestBody struct {
	...
	MarshalOpts *GetReportTemplatesRequestBodyMarshalOpts `json:"-"`
}

type GetReportTemplatesRequestBodyMarshalOpts struct {
...
func (m GetReportTemplatesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
