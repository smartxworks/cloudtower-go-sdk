...
type WithTaskDeleteOrganization struct {
	...
	MarshalOpts *WithTaskDeleteOrganizationMarshalOpts `json:"-"`
}

type WithTaskDeleteOrganizationMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteOrganization) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
