...
type WithTaskAlert struct {
	...
	MarshalOpts *WithTaskAlertMarshalOpts `json:"-"`
}

type WithTaskAlertMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskAlert) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskAlert) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskAlert) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
