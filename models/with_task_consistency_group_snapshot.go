...
type WithTaskConsistencyGroupSnapshot struct {
	...
	MarshalOpts *WithTaskConsistencyGroupSnapshotMarshalOpts `json:"-"`
}

type WithTaskConsistencyGroupSnapshotMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskConsistencyGroupSnapshot) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *WithTaskConsistencyGroupSnapshot) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *WithTaskConsistencyGroupSnapshot) validateData(formats strfmt.Registry) error {
...
func (m *WithTaskConsistencyGroupSnapshot) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WithTaskConsistencyGroupSnapshot) UnmarshalBinary(b []byte) error {
	var res WithTaskConsistencyGroupSnapshot
