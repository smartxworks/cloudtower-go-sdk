...
type NestedAggregateIscsiLun struct {
	...
	MarshalOpts *NestedAggregateIscsiLunMarshalOpts `json:"-"`
}

type NestedAggregateIscsiLunMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateIscsiLun) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateIscsiLun) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateIscsiLun) UnmarshalBinary(b []byte) error {
	var res NestedAggregateIscsiLun
