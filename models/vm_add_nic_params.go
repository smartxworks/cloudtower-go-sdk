...
type VMAddNicParams struct {
	...
	MarshalOpts *VMAddNicParamsMarshalOpts `json:"-"`
}

type VMAddNicParamsMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	Where_Explicit_Null_When_Empty bool
}

func (m VMAddNicParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
type VMAddNicParamsData struct {
	...
	MarshalOpts *VMAddNicParamsDataMarshalOpts `json:"-"`
}

type VMAddNicParamsDataMarshalOpts struct {
	VMNics_Explicit_Null_When_Empty bool
}

func (m VMAddNicParamsData) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
