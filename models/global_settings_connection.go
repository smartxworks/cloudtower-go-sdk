...
type GlobalSettingsConnection struct {
	...
	MarshalOpts *GlobalSettingsConnectionMarshalOpts `json:"-"`
}

type GlobalSettingsConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m GlobalSettingsConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
