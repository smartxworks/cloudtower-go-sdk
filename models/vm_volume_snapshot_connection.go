...
type VMVolumeSnapshotConnection struct {
	...
	MarshalOpts *VMVolumeSnapshotConnectionMarshalOpts `json:"-"`
}

type VMVolumeSnapshotConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m VMVolumeSnapshotConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *VMVolumeSnapshotConnection) validateAggregate(formats strfmt.Registry) error {
...
func (m *VMVolumeSnapshotConnection) contextValidateAggregate(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VMVolumeSnapshotConnection) UnmarshalBinary(b []byte) error {
	var res VMVolumeSnapshotConnection
