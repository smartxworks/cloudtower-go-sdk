...
type GetSnmpTransportsRequestBody struct {
	...
	MarshalOpts *GetSnmpTransportsRequestBodyMarshalOpts `json:"-"`
}

type GetSnmpTransportsRequestBodyMarshalOpts struct {
...
func (m GetSnmpTransportsRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetSnmpTransportsRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetSnmpTransportsRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetSnmpTransportsRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetSnmpTransportsRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetSnmpTransportsRequestBody) UnmarshalBinary(b []byte) error {
	var res GetSnmpTransportsRequestBody
