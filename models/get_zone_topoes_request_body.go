...
type GetZoneTopoesRequestBody struct {
	...
	MarshalOpts *GetZoneTopoesRequestBodyMarshalOpts `json:"-"`
}

type GetZoneTopoesRequestBodyMarshalOpts struct {
...
func (m GetZoneTopoesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetZoneTopoesRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetZoneTopoesRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetZoneTopoesRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetZoneTopoesRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
