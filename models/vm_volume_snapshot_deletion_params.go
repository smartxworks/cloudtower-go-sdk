...
type VMVolumeSnapshotDeletionParams struct {
	...
	MarshalOpts *VMVolumeSnapshotDeletionParamsMarshalOpts `json:"-"`
}

type VMVolumeSnapshotDeletionParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m VMVolumeSnapshotDeletionParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *VMVolumeSnapshotDeletionParams) validateWhere(formats strfmt.Registry) error {
...
func (m *VMVolumeSnapshotDeletionParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VMVolumeSnapshotDeletionParams) UnmarshalBinary(b []byte) error {
	var res VMVolumeSnapshotDeletionParams
