...
type NestedAggregateVMFolder struct {
	...
	MarshalOpts *NestedAggregateVMFolderMarshalOpts `json:"-"`
}

type NestedAggregateVMFolderMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateVMFolder) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
