...
type GetVMSnapshotsConnectionRequestBody struct {
	...
	MarshalOpts *GetVMSnapshotsConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetVMSnapshotsConnectionRequestBodyMarshalOpts struct {
...
func (m GetVMSnapshotsConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
