...
func (m *GetVMSnapshotsConnectionRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetVMSnapshotsConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetVMSnapshotsConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetVMSnapshotsConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetVMSnapshotsConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetVMSnapshotsConnectionRequestBody) UnmarshalBinary(b []byte) error {
	var res GetVMSnapshotsConnectionRequestBody
