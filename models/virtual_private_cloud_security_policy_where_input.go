...
type VirtualPrivateCloudSecurityPolicyWhereInput struct {
	...
	MarshalOpts *VirtualPrivateCloudSecurityPolicyWhereInputMarshalOpts `json:"-"`
}

type VirtualPrivateCloudSecurityPolicyWhereInputMarshalOpts struct {
...
func (m VirtualPrivateCloudSecurityPolicyWhereInput) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
