...
type ConsistencyGroupSnapshotWhereInput struct {
	...
	MarshalOpts *ConsistencyGroupSnapshotWhereInputMarshalOpts `json:"-"`
}

type ConsistencyGroupSnapshotWhereInputMarshalOpts struct {
...
func (m ConsistencyGroupSnapshotWhereInput) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
