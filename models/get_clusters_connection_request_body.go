...
type GetClustersConnectionRequestBody struct {
	...
	MarshalOpts *GetClustersConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetClustersConnectionRequestBodyMarshalOpts struct {
...
func (m GetClustersConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetClustersConnectionRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetClustersConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetClustersConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetClustersConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetClustersConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetClustersConnectionRequestBody) UnmarshalBinary(b []byte) error {
	var res GetClustersConnectionRequestBody
