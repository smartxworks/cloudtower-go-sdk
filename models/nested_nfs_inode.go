...
type NestedNfsInode struct {
	...
	MarshalOpts *NestedNfsInodeMarshalOpts `json:"-"`
}

type NestedNfsInodeMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedNfsInode) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedNfsInode) validateID(formats strfmt.Registry) error {
...
func (m *NestedNfsInode) validateName(formats strfmt.Registry) error {
