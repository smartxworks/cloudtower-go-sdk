...
type DatacenterDeletionParams struct {
	...
	MarshalOpts *DatacenterDeletionParamsMarshalOpts `json:"-"`
}

type DatacenterDeletionParamsMarshalOpts struct {
	Where_Explicit_Null_When_Empty bool
}

func (m DatacenterDeletionParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *DatacenterDeletionParams) validateWhere(formats strfmt.Registry) error {
...
func (m *DatacenterDeletionParams) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
