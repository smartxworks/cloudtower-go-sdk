...
type GetRackTopoesConnectionRequestBody struct {
	...
	MarshalOpts *GetRackTopoesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetRackTopoesConnectionRequestBodyMarshalOpts struct {
...
func (m GetRackTopoesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
