...
type VMCreateVMFromContentLibraryTemplateParams struct {
	...
	MarshalOpts *VMCreateVMFromContentLibraryTemplateParamsMarshalOpts `json:"-"`
}

type VMCreateVMFromContentLibraryTemplateParamsMarshalOpts struct {
...
func (m VMCreateVMFromContentLibraryTemplateParams) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *VMCreateVMFromContentLibraryTemplateParams) validateHaPriority(formats strfmt.Registry) error {
...
func (m *VMCreateVMFromContentLibraryTemplateParams) contextValidateHaPriority(ctx context.Context, formats strfmt.Registry) error {
