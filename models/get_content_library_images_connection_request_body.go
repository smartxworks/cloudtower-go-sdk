...
type GetContentLibraryImagesConnectionRequestBody struct {
	...
	MarshalOpts *GetContentLibraryImagesConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetContentLibraryImagesConnectionRequestBodyMarshalOpts struct {
...
func (m GetContentLibraryImagesConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
