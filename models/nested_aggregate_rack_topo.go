...
type NestedAggregateRackTopo struct {
	...
	MarshalOpts *NestedAggregateRackTopoMarshalOpts `json:"-"`
}

type NestedAggregateRackTopoMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateRackTopo) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateRackTopo) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateRackTopo) UnmarshalBinary(b []byte) error {
	var res NestedAggregateRackTopo
