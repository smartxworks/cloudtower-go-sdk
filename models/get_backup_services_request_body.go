...
type GetBackupServicesRequestBody struct {
	...
	MarshalOpts *GetBackupServicesRequestBodyMarshalOpts `json:"-"`
}

type GetBackupServicesRequestBodyMarshalOpts struct {
...
func (m GetBackupServicesRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
