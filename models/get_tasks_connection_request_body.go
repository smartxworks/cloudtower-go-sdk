...
type GetTasksConnectionRequestBody struct {
	...
	MarshalOpts *GetTasksConnectionRequestBodyMarshalOpts `json:"-"`
}

type GetTasksConnectionRequestBodyMarshalOpts struct {
...
func (m GetTasksConnectionRequestBody) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *GetTasksConnectionRequestBody) validateOrderBy(formats strfmt.Registry) error {
...
func (m *GetTasksConnectionRequestBody) validateWhere(formats strfmt.Registry) error {
...
func (m *GetTasksConnectionRequestBody) contextValidateOrderBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetTasksConnectionRequestBody) contextValidateWhere(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetTasksConnectionRequestBody) UnmarshalBinary(b []byte) error {
	var res GetTasksConnectionRequestBody
