...
type ConsistencyGroupConnection struct {
	...
	MarshalOpts *ConsistencyGroupConnectionMarshalOpts `json:"-"`
}

type ConsistencyGroupConnectionMarshalOpts struct {
	Aggregate_Explicit_Null_When_Empty bool
}

func (m ConsistencyGroupConnection) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
