...
type NestedAggregateElfStoragePolicy struct {
	...
	MarshalOpts *NestedAggregateElfStoragePolicyMarshalOpts `json:"-"`
}

type NestedAggregateElfStoragePolicyMarshalOpts struct {
	Count_Explicit_Null_When_Empty bool
}

func (m NestedAggregateElfStoragePolicy) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
...
func (m *NestedAggregateElfStoragePolicy) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NestedAggregateElfStoragePolicy) validateCount(formats strfmt.Registry) error {
...
func (m *NestedAggregateElfStoragePolicy) UnmarshalBinary(b []byte) error {
	var res NestedAggregateElfStoragePolicy
