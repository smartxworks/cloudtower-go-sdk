...
type NestedVirtualPrivateCloudSecurityPolicy struct {
	...
	MarshalOpts *NestedVirtualPrivateCloudSecurityPolicyMarshalOpts `json:"-"`
}

type NestedVirtualPrivateCloudSecurityPolicyMarshalOpts struct {
	ID_Explicit_Null_When_Empty bool

	Name_Explicit_Null_When_Empty bool
}

func (m NestedVirtualPrivateCloudSecurityPolicy) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
