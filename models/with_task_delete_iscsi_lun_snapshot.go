...
type WithTaskDeleteIscsiLunSnapshot struct {
	...
	MarshalOpts *WithTaskDeleteIscsiLunSnapshotMarshalOpts `json:"-"`
}

type WithTaskDeleteIscsiLunSnapshotMarshalOpts struct {
	Data_Explicit_Null_When_Empty bool

	TaskID_Explicit_Null_When_Empty bool
}

func (m WithTaskDeleteIscsiLunSnapshot) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	b.WriteString("{")
